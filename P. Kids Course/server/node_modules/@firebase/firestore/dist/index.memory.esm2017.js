...
class Gn {
    ...
    Rr(t, e) {
        ...
        return this.persistence.runTransaction("Release target", s, t => e ? Dn.resolve() : this.persistence.hr.removeTarget(t, n)).then(() => {
...
function lr(t) {
    ...
    }(t, (t, e) => new Wi(t, e, new Oi)), t.registerVersion("@firebase/firestore", "1.16.0");
}
