...
}(V), k = /^[_a-zA-Z][_a-zA-Z0-9]*$/, R = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.prototype.V = function(t, e, r) {
    ...
    if (null === e.G) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return function(t) {
                ...
                return t.field.$() + t.op.toString() + Vt(t.value);
            }(t);
        })).join(","), n += "|ob:", n += e.orderBy.map((function(t) {
            return (e = t).field.$() + e.dir;
            var e;
        })).join(","), O(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += un(e.startAt)), e.endAt && (n += "|ub:", n += un(e.endAt)), e.G = n;
    }
    return e.G;
}
...
function j(t, e) {
    ...
    !(i instanceof Ke && o instanceof Ke && i.op === o.op && i.field.isEqual(o.field) && Tt(i.value, o.value))) return !1;
    var i, o;
...
var B, z, Q = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = P.min()), void 0 === o && (o = P.min()), void 0 === s && (s = G.Y), 
 ...
 */ function Z(t) {
    ...
    return f("GRPC error has no .code"), T.UNKNOWN;
    switch (t) {
      case B.OK:
        return T.OK;
...
var $ = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Ct = function(t) {
        ...
        return new K(this.data.at());
    }, t.prototype.ut = function(t) {
        return new K(this.data.ut(t));
    }, 
 ...
 */ var ct = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.$t = it(), this.Nt = new X(this.P)
        /**
    ...
    return t.Ut = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.qt === t.qt && this.Mt.isEqual(t.Mt) && Ze(this.query, t.query) && this.docs.isEqual(t.docs) && this.Lt.isEqual(t.Lt))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, dt.zt(e, n)), new t(P.min(), r, ht(), et(), ut());
    }, t;
}(), dt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.Pe = function(t) {
        for (var e = 0, n = t.Zt; e < n.length; e++) {
            var r = n[e];
            t.te instanceof ze ? this.Ve(r, t.te) : t.te instanceof Qe && this.ye(r, t.key, t.te);
        }
    ...
    t.prototype.$e = function(t) {
        ...
        this.me.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Ht && F(o.target)) {
                    ...
                    null !== e.Ie.get(s) || e.Ne(i, s) || e.ye(i, s, new Qe(s, t));
                }
        ...
        var i = new pt(t, n, this.Re, this.Ie, r);
        return this.Ie = et(), this.Ae = _t(), this.Re = new $(m), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.me.get(t);
        return e || (e = new mt, this.me.set(t, e)), e;
    }, t.prototype.ke = function(t) {
        var e = this.Ae.get(t);
        return e || (e = new $(m), this.Ae = this.Ae.nt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Se = function(t) {
        var e = this;
        this.me.set(t, new mt), this.Ee.xe(t).forEach((function(n) {
...
function Lt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = m(kt(t.latitude), kt(e.latitude));
            return 0 !== n ? n : m(kt(t.longitude), kt(e.longitude));
...
function Pt(t, e) {
    ...
    var n = Ut(t), r = Ut(e), i = m(n.seconds, r.seconds);
...
function Vt(t) {
    return function t(e) {
        ...
        S.B(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function ie(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Kt(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Kt(t, r.g()), n.structuredQuery.from = [ {
        collectionId: r.S()
    } ]);
    var i = function(t) {
        if (0 !== t.length) {
 ...
 */ function ce(t, e, n) {
    return t instanceof pe ? function(t, e) {
        ...
        return Ot(n) && Ot(t.qe) ? Bt(r) : zt(t.serializer, r);
    }(t, e);
}
 ...
 */ function le(t, e) {
    return t instanceof me ? Ot(n = e) || function(t) {
 ...
 */ function De(t, e, n) {
    return t instanceof ke ? function(t, e, n) {
    ...
    }(t, 0, n) : t instanceof Re ? function(t, e, n) {
        if (!Ae(t.Ue, e)) 
        ...
        if (d(null != n.transformResults), !Ae(t.Ue, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */ function Le(t, e, n, r) {
    return t instanceof ke ? function(t, e) {
        ...
        return Ae(t.Ue, e) ? new Qe(t.key, P.min()) : e;
    }(t, e);
}
 ...
 */ function Pe(t, e) {
    return t instanceof Oe ? function(t, e) {
        for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
            ...
            null != u && (n = null == n ? (new Fe).set(o.field, u) : n.set(o.field, u));
        }
        return n ? n.Ke() : null;
    }(t, e) : null;
}
...
function Ve(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Ue.isEqual(e.Ue) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Me.isEqual(e.Me) : 2 /* Transform */ !== t.type || w(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
 ...
 */ function Ue(t) {
    return t instanceof ze ? t.version : P.min();
}
 ...
 */ var ke = /** @class */ function(t) {
    ...
    function n(e, n, r, i) {
        var o = this;
        return (o = t.call(this) || this).key = e, o.data = n, o.Me = r, o.Ue = i, o.type = 1 /* Patch */ , 
        o;
    }
    return e.__extends(n, t), n;
}(Te);
...
function Ce(t, e, n) {
    for (var r = new Fe(e), i = 0; i < t.fieldTransforms.length; i++) {
...
var Be = function(t, e) {
    ...
    return t.on = function(e) {
        ...
        get: function() {
            if (null === this.nn) {
                ...
                t.L() || this.nn.push(new cn(t)), this.nn.push(new cn(R.M(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.Tn = function() {
        ...
        return !O(this.limit) && "F" /* First */ === this.en;
    }, t.prototype.mn = function() {
        return !O(this.limit) && "L" /* Last */ === this.en;
    }, t.prototype.an = function() {
        return this.tn.length > 0 ? this.tn[0].field : null;
    }, t.prototype.hn = function() {
        for (var t = 0, e = this.filters; t < e.length; t++) {
            var n = e[t];
            if (n instanceof Ke && n.In()) return n.field;
        }
        return null;
    }, 
    ...
    t.prototype.An = function(t) {
        for (var e = 0, n = this.filters; e < n.length; e++) {
            var r = n[e];
            if (r instanceof Ke && t.indexOf(r.op) >= 0) return r.op;
        }
        return null;
    ...
    t.prototype.Pn = function() {
        if (!this.sn) if ("F" /* First */ === this.en) this.sn = x(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            ...
            var t = [], e = 0, n = this.orderBy; e < n.length; e++) {
                ...
                t.push(new cn(r.field, i));
            }
            // We need to swap the cursors to match the now-flipped query ordering.
                        var o = this.endAt ? new sn(this.endAt.position, !this.endAt.before) : null, s = this.startAt ? new sn(this.startAt.position, !this.startAt.before) : null;
...
function Ye(t) {
    return "Query(target=" + function(t) {
        ...
        t.filters.length > 0 && (e += ", filters: [" + t.filters.map((function(t) {
            return (e = t).field.$() + " " + e.op + " " + Vt(e.value);
            /** Returns a debug description for `filter`. */            var e;
            /** Filter that matches on key fields (i.e. '__name__'). */        })).join(", ") + "]"), 
        O(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.$() + " (" + e.dir + ")";
            var e;
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + un(t.startAt)), t.endAt && (e += ", endAt: " + un(t.endAt)), 
        "Target(" + e + ")";
    }(t.Pn()) + "; limitType=" + t.en + ")";
}

/** Returns whether `doc` matches the constraints of `query`. */ function Je(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.U(t.collectionGroup) && t.path.C(n) : S.W(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
        ...
        return !(t.startAt && !an(t.startAt, t.orderBy, e)) && (!t.endAt || !an(t.endAt, t.orderBy, e));
    }(t, e);
}
...
var Ke = /** @class */ function(t) {
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        if (t.L()) return "in" /* IN */ === e ? new en(t, r) : new tn(t, e, r);
        if (Ct(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new nn(t, r) : "in" /* IN */ === e ? new rn(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new on(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && At(this.value) === At(e) && this.yn(Lt(e, this.value));
...
}(Ke), nn = /** @class */ function(t) {
    function n(e, n) {
        return t.call(this, e, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return e.__extends(n, t), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return Mt(e) && Dt(e.arrayValue, this.value);
    }, n;
}(Ke), rn = /** @class */ function(t) {
    function n(e, n) {
...
/** Filter that matches on key fields within an array. */ function un(t) {
 ...
 */ function an(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.L() ? S.P(S.B(s.referenceValue), n.key) : Lt(s, n.field(o.field)), 
 ...
 */ var cn = function(t, e /* ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

function fn(t, e, n) {
    var r = t.field.L() ? S.P(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? Lt(r, i) : p();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var pn = /** @class */ function() {
    ...
    t.prototype.bn = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Le(i, e, e, this.pn));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = Le(a, e, o, this.pn));
        }
        return e;
    }, 
    /**
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.kn && p(), this.kn = !0, this.Nn ? this.error ? this.xn(n, this.error) : this.On(e, this.result) : new t((function(t, i) {
            r.Fn = function(n) {
                r.On(e, n).next(t, i);
            }, r.$n = function(e) {
                r.xn(n, e).next(t, i);
    ...
    t.prototype.Xn = function(t, e) {
        ...
        return this.Qn.Jn(t, e).next((function(r) {
            var i = n.Hn(t, e, r), o = et();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new Qe(t, P.min())), o = o.nt(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.jn(t, new S(e)).next((function(t) {
            var e = it();
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.os(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], h = a.key, c = r.get(h), f = Le(a, c, c, o.pn);
                    r = f instanceof ze ? r.nt(h, f) : r.remove(h);
                }
            }));
        })).next((function() {
        ...
        return this.Un.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof ze && (h = h.nt(t, e));
            })), h;
        }));
    }, t;
}(), gn = /** @class */ function() {
...
/** The result of applying a mutation batch to the backend. */ mn.ds = -1;
...
var wn = function() {
    ...
    t.prototype.ys = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && c("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.As + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    return t.prototype.Cs = function(t, e) {
        return this.Ss.add(e), yn.resolve();
    }, t.prototype.ss = function(t, e) {
        return yn.resolve(this.Ss.getEntries(e));
    }, t;
}(), En = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.S(), n = t.g(), r = this.index[e] || new $(U.P), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.S(), n = t.g(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new $(U.P)).F();
    }, t;
}(), In = /** @class */ function() {
    function t(t) {
        this.Ds = t;
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Nn(t) {
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function An() {
 ...
 */ var Tn = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Ns = t, this.Ts = e, this.ks = n, this.op = r, this.xs = i, this.Os = new wn, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.Ms && (this.clearTimeout(), this.Os.reject(new D(T.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Hs = new _n(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.ni = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Zs(), this.Ws ? [ 3 /*break*/ , 2 ] : (this.Ws = !0, (n = An()) && n.removeEventListener("visibilitychange", this.Ys), 
                    [ 4 /*yield*/ , this.ei(t) ]);
    ...
    t.prototype.ii = function() {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Qs[0]() ];

                  case 2:
                    return e.sent(), this.Qs.shift(), this.Hs.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!Nn(t = e.sent())) throw t;
        ...
        var e = this, n = this.Us.then((function() {
            return e.Ks = !0, t().catch((function(t) {
                ...
                throw e.Gs = t, e.Ks = !1, f("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.gs = function(t, e, n) {
        ...
        var i = Tn.Ls(this, t, e, n, (function(t) {
            return r.ri(t);
        }));
 ...
 */
function Ln(t, e) {
    if (f("AsyncQueue", e + ": " + t), Nn(t)) return new D(T.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Pn.Ei = -1, Pn.mi = 1048576, Pn.Ii = 41943040, Pn.wi = 10, Pn.Ti = 1e3, Pn.Ai = new Pn(Pn.Ii, Pn.wi, Pn.Ti), 
Pn.Ri = new Pn(Pn.Ei, 0, 0);
...
var Vn = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.pi = P.min(), this.Qn = t.gi(n), this.vi = t.bi(), this.Si = t.Ci(), this.Di = new vn(this.vi, this.Qn, this.persistence.Fi()), 
        this.Pi.$i(this.Di);
    }
    return t.prototype.start = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n = this.Qn, r = this.Di, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(e) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.Qn.ki(e).next((function(s) {
                            return i = s, n = o.persistence.gi(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new vn(o.vi, n, o.persistence.Fi()), n.ki(e);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = e.sent(), [ 2 /*return*/ , (this.Qn = n, this.Di = r, this.Pi.$i(this.Di), 
                    i) ];
                }
            }));
        }));
    }, t.prototype.Mi = function(t) {
        var e, n = this, r = L.now(), i = t.reduce((function(t, e) {
            return t.add(e.key);
        }), ut());
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.Di.Yn(o, i).next((function(i) {
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    var h = a[u], c = Pe(h, e.get(h.key));
                    null != c && 
                    // NOTE: The base state should only be applied if there's some
                    // existing document to override, so use a Precondition of
                    // exists=true
                    s.push(new Re(h.key, c, Ge(c.proto.mapValue), Ne.exists(!0)));
                }
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Qn.zi(n, t).next((function(t) {
                return d(null !== t), r = t.keys(), e.Qn.Hi(n, t);
            })).next((function() {
                return e.Qn.Gi(n);
            })).next((function() {
                return e.Di.Yn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.jt.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof Qe && h.version.isEqual(P.min()) ? (
                    // NoDocuments with SnapshotVersion.min() are used in manufactured
                    // events. We remove these documents from cache since we lost
                    // access.
                    s.ir(i, r), a = a.nt(i, h)) : null == f || h.version.o(f.version) > 0 || 0 === h.version.o(f.version) && f.hasPendingWrites ? (s.rr(h, r), 
                ...
                var f = n.Si.Xi(o).next((function(t) {
                    return n.Si.ar(o, o.er, r);
                }));
                u.push(f);
            }
            return yn.qn(u).next((function() {
                return s.apply(o);
            })).next((function() {
                return n.Di.Xn(o, a);
            }));
    ...
    t.nr = function(t, e, n) {
        ...
        return d(e.resumeToken.H() > 0), 0 === t.resumeToken.H() || (e.J.I() - t.J.I() >= this.ur || n.Yt.size + n.Xt.size + n.Jt.size > 0);
                  ...
                  case 0:
                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return yn.forEach(t, (function(t) {
                            return yn.forEach(t.hs, (function(n) {
                                return f.persistence.hr.lr(e, t.targetId, n);
                            })).next((function() {
                                return yn.forEach(t.as, (function(n) {
                                    return f.persistence.hr._r(e, t.targetId, n);
                                }));
                            }));
                        }));
                    })) ];
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Si.mr(n, t).next((function(i) {
                ...
                r = i, yn.resolve(r)) : e.Si.Ir(n).next((function(i) {
                    return r = new Q(t, i, 0 /* Listen */ , n.er), e.Si.Ar(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
        ...
        var n = this.yi.get(e);
        return void 0 !== n ? yn.resolve(this.Vi.get(n)) : this.Si.mr(t, e);
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? yn.resolve() : n.persistence.hr.removeTarget(t, r);
        })).then((function() {
            n.Vi = n.Vi.remove(t), n.yi.delete(r.target);
        }));
    }, t.prototype.Pr = function(t, e) {
        var n = this, r = P.min(), i = ut();
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.mr(o, t.Pn()).next((function(t) {
                ...
                return n.Pi.Zn(o, t, e ? r : P.min(), e ? i : ut());
            })).next((function(t) {
                return {
                    documents: t,
                    yr: i
        ...
        return o.forEach((function(r) {
            s = s.next((function() {
                ...
                d(null !== s), (!o || o.version.o(s) < 0) && ((o = i.gn(r, o, e)) && 
...
var kn = /** @class */ function() {
    ...
    t.prototype.Nr = function(t) {
        var e = this, n = new S(new U([])), r = new Rn(n, t), i = new Rn(n, t + 1), o = [];
        ...
        var e = new S(new U([])), n = new Rn(e, t), r = new Rn(e, t + 1), i = ut();
        return this.Sr.bt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Or = function(t) {
        var e = new Rn(t, 0), n = this.vr.Ct(e);
    ...
    return t.br = function(t, e) {
        return S.P(t.key, e.key) || m(t.Lr, e.Lr);
    }, 
    /** Compare by ID then by key */ t.Cr = function(t, e) {
        return m(t.Lr, e.Lr) || S.P(t.key, e.key);
    }, t;
}();
 ...
 */
function Sn(t, e) {
    if (0 !== e.length) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + $n(e.length, "argument") + ".");
}
 ...
 */ function On(t, e, n) {
    if (e.length !== n) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() requires " + $n(n, "argument") + ", but was called with " + $n(e.length, "argument") + ".");
}
 ...
 */ function Mn(t, e, n) {
    if (e.length < n) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() requires at least " + $n(n, "argument") + ", but was called with " + $n(e.length, "argument") + ".");
}
 ...
 */ function Cn(t, e, n, r) {
    if (e.length < n || e.length > r) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + $n(e.length, "argument") + ".");
}
...
function Gn(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = Wn(r);
        throw new D(T.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function Bn(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new D(T.INVALID_ARGUMENT, "Invalid value " + Wn(r) + " provided to function " + t + "() for its " + Jn(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function zn(t, e, n, r) {
    if (!("object" === e ? Qn(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Wn(r);
...
/** Returns a string describing the type / value of the provided input. */ function Wn(t) {
...
function Hn(t, e, n) {
    if (void 0 === n) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + Jn(e) + " argument, but it was undefined.");
}
 ...
 */ function Xn(t, e, n, r) {
    var i = Wn(r);
    return new D(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + Jn(n) + " argument to be a " + e + ", but it was: " + i);
}

function Yn(t, e, n) {
    if (n <= 0) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + Jn(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function Jn(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function Kn() {
 ...
 */ var er = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        On("Blob.fromBase64String", arguments, 1), xn("Blob.fromBase64String", "string", 1, e), 
        tr();
        try {
        ...
        if (On("Blob.fromUint8Array", arguments, 1), Kn(), !(e instanceof Uint8Array)) throw Xn("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(G.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return On("Blob.toBase64", arguments, 0), tr(), this.Mr.toBase64();
    }, t.prototype.toUint8Array = function() {
        return On("Blob.toUint8Array", arguments, 0), Kn(), this.Mr.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new D(T.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + $n(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (xn("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new D(T.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.qr = new R(t);
}, rr = /** @class */ function(t) {
    /**
    ...
    return e.__extends(n, t), n.documentId = function() {
        ...
        if (!(t instanceof n)) throw Xn("isEqual", "FieldPath", 1, t);
        return this.qr.isEqual(t.qr);
    }, n;
}(nr), ir = new RegExp("[~\\*/\\[\\]]"), or = function() {
    /** A pointer to the implementing class. */
    this.Br = this;
}, sr = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Ur = e, n;
    }
    return e.__extends(n, t), n.prototype.Qr = function(t) {
...
var ar = /** @class */ function(t) {
...
}(or), hr = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).Ur = e, r.zr = n, r;
    }
    return e.__extends(n, t), n.prototype.Qr = function(t) {
        var e = ur(this, t, 
...
}(or), fr = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).Ur = e, r.Hr = n, r;
    }
    return e.__extends(n, t), n.prototype.Qr = function(t) {
        var e = new me(t.serializer, Qt(t.serializer, this.Hr));
        return new Ee(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(or), lr = /** @class */ function(t) {
    function n() {
        return t.call(this) || this;
    }
    return e.__extends(n, t), n.delete = function() {
        return Sn("FieldValue.delete", arguments), new pr(new sr("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Sn("FieldValue.serverTimestamp", arguments), new pr(new ar("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Mn("FieldValue.arrayUnion", arguments, 1), new pr(new hr("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Mn("FieldValue.arrayRemove", arguments, 1), new pr(new cr("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return xn("FieldValue.increment", "number", 1, t), On("FieldValue.increment", arguments, 1), 
        new pr(new fr("FieldValue.increment", t));
    }, n;
}(or), pr = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Br = e, n.Ur = e.Ur, n;
    }
    return e.__extends(n, t), n.prototype.Qr = function(t) {
        return this.Br.Qr(t);
    }, n.prototype.isEqual = function(t) {
...
}(lr), dr = /** @class */ function() {
    function t(t, e) {
        if (On("GeoPoint", arguments, 2), xn("GeoPoint", "number", 1, t), xn("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.T = function(t) {
        return m(this.Yr, t.Yr) || m(this.Xr, t.Xr);
    }, t;
}();
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var vr = /^__.*__$/, gr = function(t, e, n) {
    ...
    return t.prototype.eo = function(t, e) {
        var n = [];
        return null !== this.Me ? n.push(new Re(t, this.data, this.Me, e)) : n.push(new ke(t, this.data, e)), 
        this.fieldTransforms.length > 0 && n.push(new Oe(t, this.fieldTransforms)), n;
    }, t;
}(), wr = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.Me = e, this.fieldTransforms = n;
    ...
    return t.prototype.eo = function(t, e) {
        var n = [ new Re(t, this.data, this.Me, e) ];
        return this.fieldTransforms.length > 0 && n.push(new Oe(t, this.fieldTransforms)), 
        n;
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var br = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.so = function(e) {
        ...
        return Rr(t, this.settings.methodName, this.settings.ao || !1, this.path, this.settings.Gr);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (_r(this.Wr) && vr.test(t)) throw this.jr('Document fields cannot begin and end with "__"');
    }, t;
}(), Er = /** @class */ function() {
    function t(t, e, n) {
        this.s = t, this.ignoreUndefinedProperties = e, this.serializer = n || yr(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.uo = function(t, e, n, r) {
        return void 0 === r && (r = !1), new br({
            Wr: t,
            methodName: e,
            Gr: n,
            path: R.k(),
...
/** Parse document data from a set() call. */ function Ir(t, e, n, r, i, o) {
    ...
    return new mr(new je(h), u, a);
}

/** Parse update data from an update() call. */ function Nr(t, e, n, r) {
    var i = t.uo(1 /* Update */ , e, n);
    Vr("Data must be an object, but it was:", i, r);
    var o = [], s = new Fe;
    I(r, (function(t, r) {
        var u = kr(e, t, n), a = i.oo(u);
        if (r instanceof or && r.Br instanceof sr) 
    ...
    var u = new be(o);
    return new wr(s.Ke(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Ar(t, e, n, r, i, o) {
    var s = t.uo(1 /* Update */ , e, n), u = [ Ur(e, r, n) ], a = [ i ];
    ...
    for (var h = 0; h < o.length; h += 2) u.push(Ur(e, o[h])), a.push(o[h + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var c = [], f = new Fe, l = u.length - 1; l >= 0; --l) if (!Sr(c, u[l])) {
        var p = u[l], d = a[l], y = s.oo(p);
        if (d instanceof or && d.Br instanceof sr) 
        // Add it to the field mask, but don't add anything to updateData.
        c.push(p); else {
            var v = Dr(d, y);
    ...
    var g = new be(c);
    return new wr(f.Ke(), g, s.fieldTransforms);
}
 ...
 */ function Tr(t, e, n, r) {
    return void 0 === r && (r = !1), Dr(n, t.uo(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Dr(t, e) {
    if (Pr(t)) return Vr("Unsupported field value:", e, t), Lr(t, e);
    if (t instanceof or) 
    ...
    return function(t, e) {
        ...
        if (!_r(e.Wr)) throw e.jr(t.Ur + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof L) {
            ...
            var r = new L(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
        ...
        if (t instanceof gr) {
            ...
            return {
                referenceValue: Yt(t.Jr || e.s, t.Zr.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.jr("Unsupported field value: " + Wn(t));
    }(t, e);
}
...
function Pr(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof L || t instanceof dr || t instanceof er || t instanceof gr || t instanceof or);
}
 ...
 */ function Ur(t, e, n) {
    if (e instanceof nr) return e.qr;
    if ("string" == typeof e) return kr(t, e);
    throw Rr("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function kr(t, n, r) {
    try {
        return function(t) {
            if (t.search(ir) >= 0) throw new D(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (rr.bind.apply(rr, e.__spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new D(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(n).qr;
    } catch (n) {
        throw Rr((i = n) instanceof Error ? i.message : i.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
    /**
...
Or._o = new Or("google-credentials-uid"), Or.fo = new Or("first-party-uid");
...
var Mr = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = Or.UNAUTHENTICATED, this.Ao = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.Ro !== e ? (c("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (d("string" == typeof n.accessToken), new Mr(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.Po = function() {
        ...
        return d(null === t || "string" == typeof t), new Or(t);
    }, t;
}(), qr = /** @class */ function() {
    function t(t, e) {
        this.Vo = t, this.yo = e, this.type = "FirstParty", this.user = Or.fo;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new qr(this.Vo, this.yo));
    }, t.prototype.Eo = function(t) {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Co = 0, this.Do = null, this.stream = null, this.Hs = new _n(t, e)
        /**
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Bo(n) ];
    ...
    t.prototype.Uo = function(t) {
        ...
        return function(n) {
            e.ws.Bs((function() {
                return e.Co === t ? n() : (c("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return e.__extends(n, t), n.prototype.jo = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Le ? (d(void 0 === e || "string" == typeof e), G.fromBase64String(e || "")) : (d(void 0 === e || e instanceof Uint8Array), 
                    G.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? T.UNKNOWN : Z(t.code);
                ...
                var h = $t(t, a.document.name), c = Xt(a.document.updateTime), f = new je({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = new ze(h, c, f, {}), y = a.targetIds || [], v = a.removedTargetIds || [];
                n = new yt(y, v, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var g = e.documentDelete;
                g.document;
                var m = $t(t, g.document), w = g.readTime ? Xt(g.readTime) : P.min(), _ = new Qe(m, w), b = g.removedTargetIds || [];
                n = new yt([], b, _.key, _);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var E = e.documentRemove;
                E.document;
                var I = $t(t, E.document), N = E.removedTargetIds || [];
                n = new yt([], N, I, null);
            } else {
                ...
                var A = e.filter;
                A.targetId;
                var L = A.count || 0, V = new W(L), U = A.targetId;
                n = new vt(U, V);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? P.min() : e.readTime ? Xt(e.readTime) : P.min();
        }(t);
    ...
    return e.__extends(n, t), Object.defineProperty(n.prototype, "Jo", {
        /**
    ...
    n.prototype.start = function() {
        this.Xo = !1, this.lastStreamToken = void 0, t.prototype.start.call(this);
        ...
        d(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Xo) {
        ...
        // The first response is always the handshake response
                return d(!t.writeResults || 0 === t.writeResults.length), this.Xo = !0, 
        this.listener.eh();
    }, 
    /**
...
}(Fr), zr = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).bo = e, i.credentials = n, i.serializer = r, i.sh = !1, 
        i;
    }
    return e.__extends(n, t), n.prototype.ih = function() {
        if (this.sh) throw new D(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.rh = function(t, e) {
        ...
        return this.ih(), this.credentials.getToken().then((function(r) {
            ...
            throw t.code === T.UNAUTHENTICATED && n.credentials.To(), t;
        }));
    }, 
    ...
    return t.prototype.fh = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.dh(), this.mutations.length > 0) throw new D(T.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                        ...
                        return e.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return r = y(t), i = {
                                        database: te(r.serializer),
                                        documents: n.map((function(t) {
                                            return Jt(r.serializer, t);
                                        }))
                                    }, [ 4 /*yield*/ , r.oh("BatchGetDocuments", i) ];
                                    ...
                                    return o = e.sent(), s = new Map, o.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = $t(t, e.found.name), r = Xt(e.found.updateTime), i = new je({
                                                    mapValue: {
                                                ...
                                                var n = $t(t, e.missing), r = Xt(e.readTime);
                                                return new Qe(n, r);
                                            }(t, e) : p();
                                        }(r.serializer, t);
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof Qe || t instanceof ze ? r.wh(t) : p();
                    })), n) ];
                }
            }));
        }));
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var r = new S(U.N(e));
                        n.mutations.push(new qe(r, n.Ue(r)));
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return r.sent(), this.uh = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.Ue = function(t) {
        ...
        return !this._h.has(t) && e ? Ne.updateTime(e) : Ne.je();
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.Ah ? (f(e), this.Ah = !1) : c("OnlineStateTracker", e);
    ...
    n, r, i, o) {
        ...
        /**
             ...
             */
        this.Ch = new Set, this.Dh = o, this.Dh.Fh((function(t) {
            r.Bs((function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.$h() ? (c("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.xh = function(t, e, n) {
            var r = y(t);
            return new Gr(e, r.bo, r.credentials, r.serializer, n);
        }(this.hh, r, {
            ...
            var r = y(t);
            return new Br(e, r.bo, r.credentials, r.serializer, n);
        }(this.hh, r, {
    ...
    t.prototype.disableNetwork = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.vh.length > 0 && (c("RemoteStore", "Stopping write stream with " + this.vh.length + " pending writes"), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return c("RemoteStore", "RemoteStore shutting down."), this.Ch.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.zh() ];
    ...
    t.prototype.Zh = function(t) {
        ...
        this.Sh = new wt(this), this.xh.start(), this.kh.Rh();
    }, 
    /**
    ...
    t.prototype.jh = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (this.kh.set("Online" /* Online */), !(t instanceof gt && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this.ea(t) ];
                  ...
                  case 6:
                    if (t instanceof yt ? this.Sh.Pe(t) : t instanceof vt ? this.Sh.Ce(t) : this.Sh.pe(t), 
                    n.isEqual(P.min())) return [ 3 /*break*/ , 13 ];
                    e.label = 7;

                  case 7:
                    return e.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.gh.Xi() ];

                  case 8:
                    return i = e.sent(), n.o(i) >= 0 ? [ 4 /*yield*/ , this.sa(n) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return c("RemoteStore", "Failed to raise snapshot:", o = e.sent()), [ 4 /*yield*/ , this.na(o) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    // Disable network and raise offline snapshots
                    return i.sent(), this.kh.set("Offline" /* Offline */), n || (
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.bh.has(o) ? [ 4 /*yield*/ , this.ta.ra(o, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    e.sent(), this.bh.delete(o), this.Sh.removeTarget(o), e.label = 3;
    ...
    t.prototype.Kh = function() {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    t = this.vh.length > 0 ? this.vh[this.vh.length - 1].batchId : -1, e.label = 1;
                  ...
                  case 2:
                    return e.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.gh.dr(t) ];

                  case 3:
                    return null === (n = e.sent()) ? (0 === this.vh.length && this.qh.xo(), [ 3 /*break*/ , 7 ]) : (t = n.batchId, 
                    this.ha(n), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = e.sent(), [ 4 /*yield*/ , this.na(r) ];
    ...
    t.prototype.ha = function(t) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                for (t = 0, n = this.vh; t < n.length; t++) r = n[t], this.qh.Zo(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = this.vh.shift(), i = dn.from(r, t, n), [ 4 /*yield*/ , this.ia((function() {
                        return o.ta.la(i);
                    })) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return H(r = t.code) && r !== T.ABORTED ? (n = this.vh.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.qh.ko(), [ 4 /*yield*/ , this.ia((function() {
                        return i.ta.fa(n.batchId, t);
                    })) ]) : [ 3 /*break*/ , 3 ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    c("RemoteStore", "RemoteStore received new credentials"), this.Ch.add(3 /* CredentialChange */), 
                    [ 4 /*yield*/ , this.zh() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 2:
                    return (n = t) ? [ 3 /*break*/ , 4 ] : (this.Ch.add(2 /* IsSecondary */), [ 4 /*yield*/ , this.zh() ]);

                  case 3:
                    e.sent(), n = this.kh.set("Unknown" /* Unknown */), e.label = 4;
    ...
    function t() {
        this.Aa = new Zr, this.Ra = {}, this.ta = null, this.Eh = null, this.cs = null;
    }
    return t.prototype.Pa = function(t) {
        ...
        return this.Aa = new Zr, Promise.resolve();
    ...
    e) {
        ...
        this.Mt = ut(), this.ka = $e(t), this.xa = new ct(this.ka);
    }
    ...
    t.prototype.La = function(t, e) {
        var n = this, r = e ? e.Ma : new ft, i = e ? e.xa : this.xa, o = e ? e.Mt : this.Mt, s = i, u = !1, a = this.query.En() && i.size === this.query.limit ? i.last() : null, h = this.query.mn() && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.ot((function(t, e) {
            var c = i.get(t), f = e instanceof ze ? e : null;
            f && (f = Je(n.query, f) ? f : null);
    ...
    t.prototype.Ua = function(t, e, n) {
        ...
        return this.$a = u, 0 !== o.length || a ? {
            snapshot: new lt(this.query, t.xa, i, o, t.Mt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            ja: s
        } : {
            ja: s
    ...
    t.prototype.Qa = function(t) {
        ...
        // updating many documents.
                var e = this.Na;
        this.Na = ut(), this.xa.forEach((function(e) {
            t.Ka(e.key) && (t.Na = t.Na.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Na.has(e) || n.push(new Jr(e));
    ...
    t.prototype.Ha = function() {
        return lt.Ut(this.query, this.xa, this.Mt, 0 /* Local */ === this.$a);
    }, t;
}(), Kr = /** @class */ function() {
    function t(t, e, n, r) {
        this.Ns = t, this.hh = e, this.updateFunction = n, this.Os = r, this.Ya = 5, this.Hs = new _n(this.Ns, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Hs.ys((function() {
            return e.__awaiter(t, void 0, void 0, (function() {
                var t, n, r = this;
                return e.__generator(this, (function(e) {
                    return t = new Qr(this.hh), (n = this.Ja(t)) && n.then((function(e) {
                        r.Ns.Bs((function() {
        ...
        try {
            ...
            return !O(e) && e.catch && e.then ? e : (this.Os.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    r, i, o) {
        ...
        this.ru = null, this.ou = new A((function(t) {
            return Xe(t);
        }), Ze), this.hu = new Map, 
        /**
        ...
        /**
             ...
             */
        this.cu = new Map, this.lu = new kn, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this._u = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.fu = new Map, this.du = In.$s(), this.onlineState = "Unknown" /* Unknown */;
    }
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    n = i.targetId, this.su.ya(n), r = i.view.Ha(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.gh.Er(t.Pn()) ];

                  case 2:
                    return o = e.sent(), s = this.su.ya(o.targetId), n = o.targetId, [ 4 /*yield*/ , this.Eu(t, n, "current" === s) ];

                  case 3:
                    r = e.sent(), this.wu && this.nu.listen(o), e.label = 4;
    ...
    t.prototype.Eu = function(t, n, r) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return i = e.sent(), o = new $r(t, i.yr), s = o.La(i.documents), u = dt.zt(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Ua(s, 
                    /* updateLimboDocuments= */ this.wu, u), this.mu(n, a.ja), h = new ti(t, n, o), 
                    [ 2 /*return*/ , (this.ou.set(t, h), this.hu.has(n) ? this.hu.get(n).push(t) : this.hu.set(n, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.Tu("unlisten()"), n = this.ou.get(t), (r = this.hu.get(n.targetId)).length > 1 ? [ 2 /*return*/ , (this.hu.set(n.targetId, r.filter((function(e) {
                        return !Ze(e, t);
                    }))), void this.ou.delete(t)) ] : this.wu ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.su.ga(n.targetId), this.su.Ca(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.gh.Rr(n.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.su.ba(n.targetId), i.nu.Jh(n.targetId), i.Iu(n.targetId);
                    })).catch(Un) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Iu(n.targetId), [ 4 /*yield*/ , this.gh.Rr(n.targetId, 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Tu("write()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.gh.Mi(t) ];

                  case 2:
                    return r = e.sent(), this.su.Pa(r.batchId), this.Au(r.batchId, n), [ 4 /*yield*/ , this.Ru(r.Bi) ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.nu.Kh() ];

                  case 4:
                    return e.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = e.sent(), o = Ln(i, "Failed to persist write"), n.reject(o), [ 3 /*break*/ , 6 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Tu("applyRemoteEvent()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.gh.Ji(t) ];
                  ...
                  case 2:
                    ...
                    t.Qt.forEach((function(t, e) {
                        ...
                        d(t.Yt.size + t.Xt.size + t.Jt.size <= 1), t.Yt.size > 0 ? n.eu = !0 : t.Xt.size > 0 ? d(n.eu) : t.Jt.size > 0 && (d(n.eu), 
                        n.eu = !1));
                    })), [ 4 /*yield*/ , this.Ru(n, t) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.su.pa(t, "rejected", n), r = this.cu.get(t), (i = r && r.key) ? (o = (o = new X(S.P)).nt(i, new Qe(i, P.min())), 
                    s = ut().add(i), u = new pt(P.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new $(m), o, s), [ 4 /*yield*/ , this.Ji(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Tu("applySuccessfulWrite()"), n = t.batch.batchId, e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.gh.Ui(t) ];
                  ...
                  case 2:
                    ...
                    this.yu(n, /*error=*/ null), this.pu(n), this.su.Va(n, "acknowledged"), [ 4 /*yield*/ , this.Ru(r) ];
    ...
    }, t.prototype.fa = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var r;
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Tu("rejectFailedWrite()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.gh.Ki(t) ];
                  ...
                  case 2:
                    ...
                    // listen events.
                    this.yu(t, n), this.pu(t), this.su.Va(t, "rejected", n), [ 4 /*yield*/ , this.Ru(r) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.nu.$h() || c("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.gh.Yi() ];

                  case 2:
                    return -1 === (n = e.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.fu.get(n) || []).push(t), 
                    this.fu.set(n, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = e.sent(), o = Ln(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.vu = function(t) {
        ...
        n || (n = new X(m)), n = n.nt(t, e), this._u[this.currentUser.lo()] = n;
    }, 
    /**
    ...
    t.prototype.yu = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Yr ? (this.lu.lr(i.key, t), this.Cu(i)) : i instanceof Jr ? (c("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.uu.get(e) || (c("SyncEngine", "New document in limbo: " + e), this.au.push(e), 
        this.Vu());
    }, 
    /**
    ...
    t.prototype.Vu = function() {
        for (;this.au.length > 0 && this.uu.size < this.iu; ) {
            ...
            this.cu.set(e, new ei(t)), this.uu = this.uu.nt(t, e), this.nu.listen(new Q(He.on(t.path).Pn(), e, 2 /* LimboResolution */ , mn.ds));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.Fu = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = [], i = [], o = [], this.ou.forEach((function(e, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var e = n && n.Qt.get(u.targetId), o = u.view.Ua(t, 
                            /* updateLimboDocuments= */ s.wu, e);
                            if (s.mu(u.targetId, o.ja), o.snapshot) {
                                s.wu && s.su.pa(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), r.push(o.snapshot);
                                var a = gn.us(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return e.sent(), this.ru.zo(r), [ 4 /*yield*/ , this.gh.cr(i) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (c("SyncEngine", "User change. New user:", t.lo()), 
                  ...
                  case 1:
                    ...
                    this.su.Ni(t, n.Oi, n.Li), [ 4 /*yield*/ , this.Ru(n.xi) ];
        ...
        var e = this.cu.get(t);
        if (e && e.eu) return ut().add(e.key);
        var n = ut(), r = this.hu.get(t);
        if (!r) return n;
    ...
    function t(t) {
        this.ta = t, this.Nu = new A((function(t) {
            return Xe(t);
        }), Ze), this.onlineState = "Unknown" /* Unknown */ , this.ku = new Set, this.ta.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.Nu.get(n)) || (r = !0, i = new ri), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.ta.listen(n) ];

                  case 2:
                    return o.$u = e.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = e.sent(), u = Ln(s, "Initialization of query '" + Ye(t.query) + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.Nu.set(n, i), i.listeners.push(t), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return e.__generator(this, (function(e) {
                return n = t.query, r = !1, (i = this.Nu.get(n)) && (o = i.listeners.indexOf(t)) >= 0 && (i.listeners.splice(o, 1), 
                r = 0 === i.listeners.length), r ? [ 2 /*return*/ , (this.Nu.delete(n), this.ta.Jh(n)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    return t.prototype.xu = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new lt(t.query, t.docs, t.Lt, e, t.Mt, t.fromCache, t.qt, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Ga = function(t) {
        ...
        t = lt.Ut(t.query, t.docs, t.Mt, t.fromCache), this.Bu = !0, this.qu.next(t);
    }, t;
}(), si = /** @class */ function() {
    function t() {}
    return t.prototype.$i = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.Tn() || n.isEqual(P.min()) ? this.zu(t, e) : this.Ku.Yn(t, i).next((function(s) {
            var u = o.Hu(e, s);
            return (e.En() || e.mn()) && o.Ba(e.en, u, i, n) ? o.zu(t, e) : (h() <= r.LogLevel.DEBUG && c("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Ye(e)), 
            o.Ku.Zn(t, e, n).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Hu = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof ze && Je(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.Ba = function(t, e, n, r) {
        ...
        return h() <= r.LogLevel.DEBUG && c("IndexFreeQueryEngine", "Using full collection scan to execute query:", Ye(e)), 
        this.Ku.Zn(t, e, P.min());
    }, t;
}(), ui = /** @class */ function() {
    function t(t, e) {
        this.Wn = t, this.hr = e, 
    ...
    return t.prototype.Ju = function(t) {
        return yn.resolve(0 === this.Qn.length);
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Xu = this.Xu.add(new Rn(a.key, i)), this.Wn.Cs(t, a.key.path.g());
        }
        return yn.resolve(o);
        ...
        // start of the queue.
                return yn.resolve(this.Qn.length > i ? this.Qn[i] : null);
    }, t.prototype.Yi = function() {
        return yn.resolve(0 === this.Qn.length ? -1 : this.Yu - 1);
    }, t.prototype.ki = function(t) {
        return yn.resolve(this.Qn.slice());
    }, t.prototype.Gn = function(t, e) {
        var n = this, r = new Rn(e, 0), i = new Rn(e, Number.POSITIVE_INFINITY), o = [];
        ...
        return e.forEach((function(t) {
            var e = new Rn(t, 0), i = new Rn(t, Number.POSITIVE_INFINITY);
            n.Xu.bt([ e, i ], (function(t) {
                r = r.add(t.Lr);
            }));
        })), yn.resolve(this.ec(r));
        ...
        // because it precedes all other segments in an ordered traversal.
                S.W(i) || (i = i.child(""));
        var o = new Rn(new S(i), 0), s = new $(m);
        ...
        var n = this;
        d(0 === this.nc(e.batchId, "removed")), this.Qn.shift();
        var r = this.Xu;
        return yn.forEach(e.mutations, (function(i) {
            var o = new Rn(i.key, e.batchId);
        ...
        var n = new Rn(e, 0), r = this.Xu.Ct(n);
        return yn.resolve(e.isEqual(r && r.key));
    }, t.prototype.Gi = function(t) {
        return this.Qn.length, yn.resolve();
    }, 
    /**
    ...
    t.prototype.ir = function(t) {
        ...
        ; o.wt(); ) {
            ...
            c.o(n) <= 0 || h instanceof ze && Je(e, h) && (r = r.nt(h.key, h));
        }
        return yn.resolve(r);
 ...
 */
ai.ac = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).wc = e, n;
    }
    return e.__extends(n, t), n.prototype.Ua = function(t) {
        var e = this, n = [];
    ...
    t.prototype.zn = function(t, e) {
        this._c();
        var n = this.Bi.get(e);
        return void 0 !== n ? yn.resolve(n) : this.fc(t, e);
    }, 
    /**
...
var hi = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.mc = new kn, this.targetCount = 0, this.Ic = In.Fs();
    }
    return t.prototype.ge = function(t, e) {
        ...
        return yn.resolve(this.Ec);
    }, t.prototype.Ir = function(t) {
        return this.highestTargetId = this.Ic.next(), yn.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Ic = new In(e), this.highestTargetId = e), t.sequenceNumber > this.Ec && (this.Ec = t.sequenceNumber);
    }, t.prototype.Ar = function(t, e) {
        return this.Rc(e), this.targetCount += 1, yn.resolve();
    }, t.prototype.sr = function(t, e) {
        return this.Rc(e), yn.resolve();
        ...
        return this.mc.Dr(e, n), yn.resolve();
        ...
        return this.mc.Nr(e), yn.resolve();
    }, t.prototype.Vr = function(t, e) {
        var n = this.mc.xr(e);
        return yn.resolve(n);
    }, t.prototype.Or = function(t, e) {
        return yn.resolve(this.mc.Or(e));
    }, t;
}(), ci = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.gc = {}, this.vc = new mn(0), this.bc = !1, this.bc = !0, this.hr = t(this), 
        this.Si = new hi(this), this.Wn = new bn, this.Un = new ai(this.Wn, (function(t) {
            return e.hr.Sc(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.gc[t.lo()];
        return e || (e = new ui(this.Wn, this.hr), this.gc[t.lo()] = e), e;
        ...
        return yn.Bn(Object.values(this.gc).map((function(n) {
            return function() {
                return n.Or(t, e);
            };
        })));
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).er = e, n;
    }
    /**
    ...
    return t.qc = function(e) {
        ...
        return this.Lc.lr(n, e), this.Bc.delete(n), yn.resolve();
    }, t.prototype._r = function(t, e, n) {
        return this.Lc._r(n, e), this.Bc.add(n), yn.resolve();
    }, t.prototype.sc = function(t, e) {
        return this.Bc.add(e), yn.resolve();
        ...
        // Remove newly orphaned documents.
                return yn.forEach(this.Bc, (function(r) {
        ...
        var n = this;
        return yn.Bn([ function() {
            return yn.resolve(n.Lc.Or(e));
        }, function() {
    ...
    Commit: "commit"
}, yi = "gl-js/ fire/" + u, vi = /** @class */ function() {
    function t(t) {
        this.s = t.s;
     ...
     */    return t.prototype.Jc = function(t, e) {
                ...
                try {
                    switch (a.getLastErrorCode()) {
                      ...
                      case o.ErrorCode.TIMEOUT:
                        c("Connection", 'RPC "' + t + '" timed out'), u(new D(T.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case o.ErrorCode.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                u(new D(i, r.message));
                            } else u(new D(T.UNKNOWN, "Server responded with status " + a.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        c("Connection", 'RPC "' + t + '" failed'), u(new D(T.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var s = [ this.Xc, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], h = o.createWebChannelTransport(), f = {
        ...
        this.Jc(f.initMessageHeaders, n), 
        ...
        var p = s.join("");
        c("Connection", "Creating WebChannel: " + p + " " + f);
        var y = h.createWebChannel(p, f), v = !1, g = !1, m = new pi({
            Qc: function(t) {
                g ? c("Connection", "Not sending because WebChannel is closed:", t) : (v || (c("Connection", "Opening WebChannel transport."), 
                y.open(), v = !0), c("Connection", "WebChannel sending:", t), y.send(t));
            },
            Wc: function() {
                return y.close();
            }
        ...
        return w(o.WebChannel.EventType.OPEN, (function() {
            g || c("Connection", "WebChannel transport opened.");
        })), w(o.WebChannel.EventType.CLOSE, (function() {
            g || (g = !0, c("Connection", "WebChannel transport closed"), m.Hc());
            ...
            }("Connection", "WebChannel transport errored:", t), m.Hc(new D(T.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!g) {
                ...
                if (i) {
                    ...
                    g = !0, m.Hc(new D(s, u)), y.close();
                } else c("Connection", "WebChannel received:", n), m.Yc(n);
            }
        })), setTimeout((function() {
...
}(), wi = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", _i = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.sent(), this.ul = this.cl(t), this.gh = this.ll(t), this.nu = this._l(t), 
                    this.ta = this.fl(t), this.dl = this.wl(t), this.su.Eh = function(t) {
                        return n.ta.Ga(t, 1 /* SharedClientState */);
                    }, this.nu.ta = this.ta, [ 4 /*yield*/ , this.gh.start() ];

                  case 2:
                    return e.sent(), [ 4 /*yield*/ , this.su.start() ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.nu.start() ];

                  case 4:
                    return e.sent(), [ 4 /*yield*/ , this.nu.Ta(this.ta.wu) ];
        ...
        return new ii(this.ta);
    }, t.prototype.cl = function(t) {
        return null;
    }, t.prototype.ll = function(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new si, r = t.Tl, new Vn(e, n, r);
        var e, n, r;
    }, t.prototype.al = function(t) {
        if (t.ml.El) throw new D(T.FAILED_PRECONDITION, wi);
        return new ci(li.qc);
    }, t.prototype._l = function(t) {
        var e = this;
        return new Hr(this.gh, t.hh, t.Ns, (function(t) {
        ...
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        i = this.su, o = t.Tl, s = t.iu, new ni(e, n, r, i, o, s);
        var e, n, r, i, o, s;
    }, t.prototype.clearPersistence = function(t) {
        throw new D(T.FAILED_PRECONDITION, wi);
    }, t;
}(), bi = /** @class */ function() {
    function t(t, 
    /**
     ...
     */
    e) {
        this.credentials = t, this.Ns = e, this.clientId = g.t()
        /**
    ...
    return t.prototype.start = function(t, e, n) {
        ...
        return this.credentials.Eo((function(t) {
            if (!s) return s = !0, c("FirestoreClient", "Initializing. user=", t.uid), r.Al(e, n, t, o).then(i.resolve, i.reject);
            r.Ns.si((function() {
                return r.nu.wa(t);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.Al = function(t, n, r, i) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var o, s, u, a, h, c = this;
            return e.__generator(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , (h = this.Il, Promise.resolve(new vi(h))) ];

                  case 1:
                    return o = f.sent(), s = yr(this.Il.s), u = function(t, e, n) {
                        return new zr(t, e, n);
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.su = t.su, this.gh = t.gh, 
    ...
    t.prototype.ih = function() {
        if (this.Ns.Xs) throw new D(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.ih(), n = new wn, [ 4 /*yield*/ , this.Ns.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            var r, i, o;
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.gh.Tr(t) ];

                                  case 1:
                                    return (r = e.sent()) instanceof ze ? n.resolve(r) : r instanceof Qe ? n.resolve(null) : n.reject(new D(T.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return i = e.sent(), o = Ln(i, "Failed to get document '" + t + " from cache"), 
                    ...
                    return this.ih(), n = new wn, [ 4 /*yield*/ , this.Ns.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.gh.Pr(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return r = e.sent(), i = new $r(t, r.yr), o = i.La(r.documents), s = i.Ua(o, 
                                    /* updateLimboDocuments= */ !1), n.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return u = e.sent(), a = Ln(u, "Failed to execute query '" + t + " against cache"), 
...
var Ni = /** @class */ function() {
    ...
    return t.prototype.Cl = function(t) {
        ...
        return new dr(kt(t.latitude), kt(t.longitude));
        ...
        var e = Ut(t), n = new L(e.seconds, e.nanos);
...
}(), Ai = Pn.Ei, Ti = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new D(T.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else jn("settings", "non-empty string", "host", t.host), this.host = t.host, Fn("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (Zn("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        ...
        Fn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Pn.Ii; else {
            if (t.cacheSizeBytes !== Ai && t.cacheSizeBytes < Pn.mi) throw new D(T.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Pn.mi);
    ...
    function t(n, r, i) {
        var o = this;
        if (void 0 === i && (i = new _i), this.Ol = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Ll = new Dn, this.INTERNAL = {
            delete: function() {
            ...
            var s = n;
            this.Ol = s, this.Jr = t.Bl(s), this.Ul = s.name, this.Ql = new xr(r);
        } else {
            var u = n;
            if (!u.projectId) throw new D(T.INVALID_ARGUMENT, "Must provide projectId");
            this.Jr = new b(u.projectId, u.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Ul = "[DEFAULT]", this.Ql = new Cr;
        }
        this.Wl = i, this.jl = new Ti({});
    }
    return Object.defineProperty(t.prototype, "Gl", {
        get: function() {
            return this.Kl || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.Kl = new Er(this.Jr, this.jl.ignoreUndefinedProperties)), this.Kl;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        On("Firestore.settings", arguments, 1), xn("Firestore.settings", "object", 1, t);
        var e = new Ti(t);
        if (this.ql && !this.jl.isEqual(e)) throw new D(T.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.ql) throw new D(T.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var t, n = this;
            return e.__generator(this, (function(r) {
                if (void 0 !== this.ql && !this.ql.Vl) throw new D(T.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new wn, [ 2 /*return*/ , (this.Ll.Js((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n, r;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return e.trys.push([ 0, 2, , 3 ]), n = this.Xl(), [ 4 /*yield*/ , this.Wl.clearPersistence(n) ];
        ...
        if (this.Ml(), Ii(t)) return Li(this.ql, t);
        ...
        return new _(this.Jr, this.Ul, this.jl.host, this.jl.ssl, this.jl.forceLongPolling);
    }, t.prototype.Hl = function(t, e) {
        var n = this.Xl();
        return this.ql = new bi(this.Ql, this.Ll), this.ql.start(n, t, e);
    }, t.Bl = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new D(T.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return On("Firestore.collection", arguments, 1), xn("Firestore.collection", "non-empty string", 1, t), 
        this.Ml(), new ji(U.N(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return On("Firestore.doc", arguments, 1), xn("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), Ui.Zl(U.N(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (On("Firestore.collectionGroup", arguments, 1), xn("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.Ml(), new Ci(new He(U.k(), t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return On("Firestore.runTransaction", arguments, 1), xn("Firestore.runTransaction", "function", 1, t), 
        this.Ml().transaction((function(n) {
            return t(new Pi(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.Ml(), new Vi(this);
        ...
        var e;
        On("Firestore.setLogLevel", arguments, 1), Bn("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, a.setLogLevel(e);
    }, 
 ...
 */
// settings() defaults:
/** Registers the listener for onSnapshotsInSync() */ function Li(t, e) {
    var n = new Ei({
        next: function() {
            e.next && e.next();
        },
...
var Pi = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        var n = zi("Transaction.get", t, this.e_);
        return this.n_.fh([ n.Zr ]).then((function(t) {
            if (!t || 1 !== t.length) return p();
            var r = t[0];
            if (r instanceof Qe) return new Si(e.e_, n.Zr, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.to);
            if (r instanceof ze) return new Si(e.e_, n.Zr, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.to);
            throw p();
        }));
    }, t.prototype.set = function(t, e, n) {
        Cn("Transaction.set", arguments, 2, 3);
        var r = zi("Transaction.set", t, this.e_);
        n = Fi("Transaction.set", n);
        var i = Wi(r.to, e, n), o = Ir(this.e_.Gl, "Transaction.set", r.Zr, i, null !== r.to, n);
        return this.n_.set(r.Zr, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof rr ? (Mn("Transaction.update", arguments, 3), 
        r = zi("Transaction.update", t, this.e_), i = Ar(this.e_.Gl, "Transaction.update", r.Zr, e, n, o)) : (On("Transaction.update", arguments, 2), 
        r = zi("Transaction.update", t, this.e_), i = Nr(this.e_.Gl, "Transaction.update", r.Zr, e)), 
        this.n_.update(r.Zr, i), this;
    }, t.prototype.delete = function(t) {
        On("Transaction.delete", arguments, 1);
        var e = zi("Transaction.delete", t, this.e_);
    ...
    return t.prototype.set = function(t, e, n) {
        Cn("WriteBatch.set", arguments, 2, 3), this.r_();
        var r = zi("WriteBatch.set", t, this.e_);
        n = Fi("WriteBatch.set", n);
        var i = Wi(r.to, e, n), o = Ir(this.e_.Gl, "WriteBatch.set", r.Zr, i, null !== r.to, n);
        return this.s_ = this.s_.concat(o.eo(r.Zr, Ne.je())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.r_(), "string" == typeof e || e instanceof rr ? (Mn("WriteBatch.update", arguments, 3), 
        r = zi("WriteBatch.update", t, this.e_), i = Ar(this.e_.Gl, "WriteBatch.update", r.Zr, e, n, o)) : (On("WriteBatch.update", arguments, 2), 
        r = zi("WriteBatch.update", t, this.e_), i = Nr(this.e_.Gl, "WriteBatch.update", r.Zr, e)), 
        this.s_ = this.s_.concat(i.eo(r.Zr, Ne.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        On("WriteBatch.delete", arguments, 1), this.r_();
        var e = zi("WriteBatch.delete", t, this.e_);
        return this.s_ = this.s_.concat(new xe(e.Zr, Ne.je())), this;
    }, t.prototype.commit = function() {
    ...
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this, n.Jr, e, r) || this).Zr = e, i.firestore = n, i.to = r, 
        i.ql = i.firestore.Ml(), i;
    }
    return e.__extends(n, t), n.Zl = function(t, e, r) {
        if (t.length % 2 != 0) throw new D(T.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.$() + " has " + t.length);
        ...
        get: function() {
            return new ji(this.Zr.path.g(), this.firestore, this.to);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (On("DocumentReference.collection", arguments, 1), xn("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new D(T.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = U.N(t);
        return new ji(this.Zr.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw Xn("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.Zr.isEqual(t.Zr) && this.to === t.to;
    }, n.prototype.set = function(t, e) {
        Cn("DocumentReference.set", arguments, 1, 2), e = Fi("DocumentReference.set", e);
        var n = Wi(this.to, t, e), r = Ir(this.firestore.Gl, "DocumentReference.set", this.Zr, n, null !== this.to, e);
        return this.ql.write(r.eo(this.Zr, Ne.je()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof rr ? (Mn("DocumentReference.update", arguments, 2), 
        n = Ar(this.firestore.Gl, "DocumentReference.update", this.Zr, t, e, r)) : (On("DocumentReference.update", arguments, 1), 
        n = Nr(this.firestore.Gl, "DocumentReference.update", this.Zr, t)), this.ql.write(n.eo(this.Zr, Ne.exists(!0)));
    }, n.prototype.delete = function() {
        return On("DocumentReference.delete", arguments, 0), this.ql.write([ new xe(this.Zr, Ne.je()) ]);
    }, n.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        Cn("DocumentReference.onSnapshot", arguments, 1, 4);
        var s = {
            includeMetadataChanges: !1
        }, u = 0;
        "object" != typeof i[u] || Ii(i[u]) || (Zn("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        Fn("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++);
        var a = {
        ...
        } else xn("DocumentReference.onSnapshot", "function", u, i[u]), qn("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        qn("DocumentReference.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](r.o_(t));
            },
        ...
        return ki(this.ql, this.Zr, a, c);
    }, n.prototype.get = function(t) {
        var e = this;
        return Cn("DocumentReference.get", arguments, 0, 1), Bi("DocumentReference.get", t), 
        t && "cache" === t.source ? this.firestore.Ml().yl(this.Zr).then((function(t) {
            return new Si(e.firestore, e.Zr, t, 
            /*fromCache=*/ !0, t instanceof ze && t.Ge, e.to);
        })) : 
        /**
    ...
    n.prototype.o_ = function(t) {
        ...
        return new Si(this.firestore, this.Zr, e, t.fromCache, t.hasPendingWrites, this.to);
    }, n;
}(gr);

/** Registers an internal snapshot listener for `ref`. */ function ki(t, e, n, r) {
    var i = function(t) {
...
var Ri = /** @class */ function() {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (Cn("DocumentSnapshot.data", arguments, 0, 1), t = Gi("DocumentSnapshot.data", t), 
        this.h_) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.to) {
                var n = new Oi(this.e_, this.Zr, this.h_, this.a_, this.u_, 
                /* converter= */ null);
                return this.to.fromFirestore(n, t);
            }
            return new Ni(this.e_.Jr, this.e_.t_(), t.serverTimestamps || "none", (function(t) {
                return new Ui(t, e.e_, /* converter= */ null);
            })).Cl(this.h_.Ze());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (Cn("DocumentSnapshot.get", arguments, 1, 2), e = Gi("DocumentSnapshot.get", e), 
        this.h_) {
            var r = this.h_.data().field(Ur("DocumentSnapshot.get", t, this.Zr));
            if (null !== r) return new Ni(this.e_.Jr, this.e_.t_(), e.serverTimestamps || "none", (function(t) {
                return new Ui(t, n.e_, n.to);
            })).Cl(r);
        }
        ...
        get: function() {
            return new Ui(this.Zr, this.e_, this.to);
        },
        enumerable: !1,
        configurable: !0
        ...
        get: function() {
            return new Ri(this.u_, this.a_);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Xn("isEqual", "DocumentSnapshot", 1, e);
...
/** The query class that is shared between the full, lite and legacy SDK. */ function Mi(t) {
    if (t.mn() && 0 === t.tn.length) throw new D(T.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}

var Ci = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this, n.Jr, n.Gl, e) || this).c_ = e, i.firestore = n, i.to = r, 
        i;
    }
    return e.__extends(n, t), n.prototype.where = function(t, e, r) {
        On("Query.where", arguments, 3), Hn("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = Bn("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), o = Ur("Query.where", t), s = this.l_(o, i, r);
        return new n(this.c_.un(s), this.firestore, this.to);
    }, n.prototype.orderBy = function(t, e) {
        var r;
        if (Cn("Query.orderBy", arguments, 1, 2), qn("Query.orderBy", "non-empty string", 2, e), 
        void 0 === e || "asc" === e) r = "asc" /* ASCENDING */; else {
            if ("desc" !== e) throw new D(T.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + e + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        var i = Ur("Query.orderBy", t), o = this.w_(i, r);
        return new n(this.c_.cn(o), this.firestore, this.to);
    }, n.prototype.limit = function(t) {
        return On("Query.limit", arguments, 1), xn("Query.limit", "number", 1, t), Yn("Query.limit", 1, t), 
        new n(this.c_.ln(t), this.firestore, this.to);
    }, n.prototype.limitToLast = function(t) {
        return On("Query.limitToLast", arguments, 1), xn("Query.limitToLast", "number", 1, t), 
        Yn("Query.limitToLast", 1, t), new n(this.c_._n(t), this.firestore, this.to);
        ...
        if (!(t instanceof n)) throw Xn("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && Ze(this.c_, t.c_) && this.to === t.to;
    }, n.prototype.withConverter = function(t) {
        return new n(this.c_, this.firestore, t);
    }, 
    /** Helper function to create a bound from a document or fields */ n.prototype.A_ = function(t, n, r, i) {
        if (Hn(t, 1, n), n instanceof Si) return On(t, e.__spreadArrays([ n ], r), 1), this.E_(t, n.h_, i);
        var o = [ n ].concat(r);
        return this.m_(t, o, i);
    }, n.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        Cn("Query.onSnapshot", arguments, 1, 4);
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Ii(i[u]) || (Zn("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        Fn("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++), Ii(i[u])) {
            var a = i[u];
        ...
        } else xn("Query.onSnapshot", "function", u, i[u]), qn("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        qn("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var h = {
            next: function(t) {
                i[u] && i[u](new qi(r.firestore, r.c_, t, r.to));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return Mi(this.c_), xi(this.firestore.Ml(), this.c_, s, h);
    }, n.prototype.get = function(t) {
        var e = this;
        Cn("Query.get", arguments, 0, 1), Bi("Query.get", t), Mi(this.c_);
        ...
        function(t, e, n) {
            var r = new wn, i = xi(t, e, {
                ...
                next: function(t) {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    i(), t.fromCache && n && "server" === n.source ? r.reject(new D(T.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : r.resolve(t);
                },
                error: function(t) {
                    return r.reject(t);
                }
            ...
            return new qi(e.firestore, e.c_, t, e.to);
        }));
    }, n;
}(/** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.l_ = function(t, e, n) {
        var r;
        if (t.L()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) throw new D(T.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + e + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === e) {
                this.__(n, e);
        ...
        r = Tr(this.Gl, "Query.where", n, "in" /* IN */ === e);
        var a = Ke.create(t, e, r);
        return this.d_(a), a;
    }, t.prototype.w_ = function(t, e) {
        if (null !== this.c_.startAt) throw new D(T.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.c_.endAt) throw new D(T.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var n = new cn(t, e);
        return this.T_(n), n;
    }, 
    /**
    ...
    t.prototype.E_ = function(t, e, n) {
        if (!e) throw new D(T.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
        ...
        for (var r = [], i = 0, o = this.c_.orderBy; i < o.length; i++) {
            var s = o[i];
            if (s.field.L()) r.push(St(this.Jr, e.key)); else {
                var u = e.field(s.field);
                if (Et(u)) throw new D(T.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === u) {
                    var a = s.field.$();
                    throw new D(T.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + a + "' (used as the orderBy) does not exist.");
                }
                r.push(u);
            }
        }
    ...
    t.prototype.m_ = function(t, e, n) {
        ...
        var r = this.c_.tn;
        if (e.length > r.length) throw new D(T.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.L()) {
                if ("string" != typeof s) throw new D(T.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.c_.Vn() && -1 !== s.indexOf("/")) throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.c_.path.child(U.N(s));
                if (!S.W(u)) throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new S(u);
                i.push(St(this.Jr, a));
            } else {
                var h = Tr(this.Gl, t, s);
                i.push(h);
            }
        }
        return new sn(i, n);
    ...
    t.prototype.f_ = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.c_.Vn() && -1 !== t.indexOf("/")) throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.c_.path.child(U.N(t));
            if (!S.W(e)) throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return St(this.Jr, new S(e));
        }
        if (t instanceof gr) return St(this.Jr, t.Zr);
        throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Wn(t) + ".");
    }, 
    /**
    ...
    t.prototype.__ = function(t, e) {
        ...
        if (t instanceof Ke) {
            ...
            if (t.In()) {
                var o = this.c_.hn();
                if (null !== o && !o.isEqual(t.field)) throw new D(T.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.c_.an();
                ...
                throw u === t.op ? new D(T.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new D(T.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new D(T.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}());
...
var qi = /** @class */ function() {
    function t(t, e, n, r) {
        ...
        this.metadata = new Ri(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        Cn("QuerySnapshot.forEach", arguments, 1, 2), xn("QuerySnapshot.forEach", "function", 1, t), 
        this.P_.docs.forEach((function(r) {
            t.call(e, n.p_(r, n.metadata.fromCache, n.P_.Mt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Ci(this.R_, this.e_, this.to);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (Zn("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Fn("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.P_.Bt) throw new D(T.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Xn("isEqual", "QuerySnapshot", 1, e);
        return this.e_ === e.e_ && Ze(this.R_, e.R_) && this.P_.isEqual(e.P_) && this.to === e.to;
    }, t.prototype.p_ = function(t, e, n) {
        return new Oi(this.e_, t.key, t, e, n, this.to);
    }, t;
}(), ji = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        if ((i = t.call(this, He.on(e), n, r) || this).g_ = e, e.length % 2 != 1) throw new D(T.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + e.$() + " has " + e.length);
        return i;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new Ui(new S(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        Cn("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = g.t()), xn("CollectionReference.doc", "non-empty string", 1, t);
        var e = U.N(t);
        return Ui.Zl(this.c_.path.child(e), this.firestore, this.to);
    }, n.prototype.add = function(t) {
        On("CollectionReference.add", arguments, 1), xn("CollectionReference.add", "object", 1, this.to ? this.to.toFirestore(t) : t);
        var e = this.doc();
...
function Fi(t, e) {
    ...
    if (Zn(t, e, [ "merge", "mergeFields" ]), Fn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + Wn(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new D(T.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + Wn(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof rr;
...
function Gi(t, e) {
    return void 0 === e ? {} : (Zn(t, e, [ "serverTimestamps" ]), Gn(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Bi(t, e) {
    qn(t, "object", 1, e), e && (Zn(t, e, [ "source" ]), Gn(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function zi(t, e, n) {
    ...
    throw Xn(t, "DocumentReference", 1, e);
}
...
var Hi = {
    ...
    DocumentSnapshot: Si,
    Query: Ci,
    QueryDocumentSnapshot: Oi,
    QuerySnapshot: qi,
    CollectionReference: ji,
    FieldPath: rr,
    FieldValue: lr,
    setLogLevel: Di.setLogLevel,
 ...
 */ function Zi(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new s.Component("firestore", (function(t) {
            return function(t, e) {
                return new Di(t, e, new _i);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Hi)));
    }(t), t.registerVersion("@firebase/firestore", "1.16.0");
}

Zi(n), exports.__PRIVATE_registerFirestore = Zi;
