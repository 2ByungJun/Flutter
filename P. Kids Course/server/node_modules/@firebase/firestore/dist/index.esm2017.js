...
/** Encodes TargetData into a DbTarget for storage locally. */ function ws(t, e) {
    ...
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Ys(e.targetId, Y(e.target), n, r, e.sequenceNumber, s, i);
}
...
class Ts {
    ...
    _s(t, e, n) {
        ...
        if (n.isEqual(L.min())) {
            ...
            /* open= */ !0), r.index = zs.collectionReadTimeIndex;
        }
    ...
    getMetadata(t) {
        return Es(t).get(Hs.key).next(t => (V(!!t), t));
    }
    Gs(t, e) {
        return Es(t).put(Hs.key, e);
    }
    /**
 ...
 */ class Ps {
    ...
    Ei(t) {
        return gs(t).get(Xs.key).next(t => (V(null !== t), t));
    }
    Ii(t, e) {
        return gs(t).put(Xs.key, e);
    }
    Vi(t, e) {
    ...
    Ci(t, e, n) {
        ...
        return e.forEach(e => {
            const r = Xn(e.path);
            s.push(i.put(new Js(n, r))), s.push(this.wi.Fi(t, n, e));
        }), Qn.Bn(s);
    }
    Ni(t, e, n) {
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
 ...
 */ class vs {
    ...
    u) {
        ...
        this.wi = new Cs(this, s), this.Yi = e + vs.Ji, this.serializer = new os(h), this.Xi = new Ps(this.wi, this.serializer), 
        this.ss = new is, this.es = new Ts(this.serializer, this.ss), this.window && this.window.localStorage ? this.Zi = this.window.localStorage : (this.Zi = null, 
    ...
    static js(t, e) {
        if (t instanceof bs) return si.js(t.Oi, e);
        throw P();
    }
    /**
     ...
     */    start() {
        return si.tr(this.Yi, Ls, new Bs(this.serializer)).then(t => (this.er = t, this.nr())).then(() => {
            if (!this.isPrimary && !this.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new M(x.FAILED_PRECONDITION, ps);
            return this.sr(), this.ir(), this.rr(), this.runTransaction("getHighestListenSequenceNumber", "readonly", t => this.Xi.Ai(t));
        }).then(t => {
            this.Ui = new Hn(t, this.Bi);
        }).then(() => {
            this.Qi = !0;
        }).catch(t => (this.er && this.er.close(), Promise.reject(t)));
    }
    /**
     ...
     * primary lease.
     */    nr() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", t => Ds(t).put(new ei(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next(() => {
            if (this.isPrimary) return this._r(t).next(t => {
                t || (this.isPrimary = !1, this.bs.dr(() => this.zi(!1)));
            });
        }).next(() => this.wr(t)).next(e => this.isPrimary && !e ? this.Tr(t).next(() => !1) : !!e && this.Er(t).next(() => !0))).catch(t => {
            if (oi(t)) 
            ...
            this.isPrimary !== t && this.bs.dr(() => this.zi(t)), this.isPrimary = t;
        });
    }
    _r(t) {
        return Ss(t).get(Us.key).next(t => Qn.resolve(this.Ir(t)));
    }
    mr(t) {
     ...
     * time of all clients.
     */    async Ar() {
        if (this.isPrimary && !this.Rr(this.Gi, 18e5)) {
            this.Gi = Date.now();
            const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", t => {
                const e = vs.js(t, ei.store);
                return e.Ws().next(t => {
                    const n = this.Pr(t, 18e5), s = t.filter(t => -1 === n.indexOf(t));
            ...
            // entries first to avoid potentially reviving a zombied client.
                        if (this.Zi) for (const e of t) this.Zi.removeItem(this.Vr(e.clientId));
        }
    }
    /**
     ...
     */    rr() {
        this.Ki = this.bs.Os("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, () => this.nr().then(() => this.Ar()).then(() => this.rr()));
    }
    /** Checks whether `client` is the local client. */    Ir(t) {
     ...
     */    wr(t) {
        ...
        return Ss(t).get(Us.key).next(e => {
            ...
            if (null !== e && this.Rr(e.leaseTimestampMs, 5e3) && !this.gr(e.ownerId)) {
                if (this.Ir(e) && this.networkEnabled) return !0;
                if (!this.Ir(e)) {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Ds(t).Ws().next(t => void 0 === this.Pr(t, 5e3).find(t => {
    ...
    async yr() {
        ...
        this.Qi = !1, this.pr(), this.Ki && (this.Ki.cancel(), this.Ki = null), this.br(), 
        this.vr(), await this.runTransaction("shutdown", "readwrite", t => this.Tr(t).next(() => this.mr(t))).catch(t => {
     ...
     * provided threshold.
     */    Pr(t, e) {
        return t.filter(t => this.Rr(t.updateTimeMs, e) && !this.gr(t.clientId));
    }
    /**
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Dr() {
        return this.runTransaction("getActiveClients", "readonly", t => Ds(t).Ws().next(t => this.Pr(t, 18e5).map(t => t.clientId)));
    }
    static async clearPersistence(t) {
        if (!vs.Hi()) return Promise.resolve();
        const e = t + vs.Ji;
        await si.delete(e);
    }
    get hr() {
    ...
    Cr(t) {
        return Ns.Fr(t, this.serializer, this.ss, this.wi);
    }
    Nr() {
        return this.Xi;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.er.runTransaction(s, ni, s => (i = new bs(s, this.Ui ? this.Ui.next() : Hn.ps), 
        "readwrite-primary" === e ? this._r(i).next(t => !!t || this.wr(i)).next(e => {
            if (!e) throw A(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, 
            this.bs.dr(() => this.zi(!1)), new M(x.FAILED_PRECONDITION, jn);
            return n(i);
        }).next(t => this.Er(i).next(() => t)) : this.xr(i).next(() => n(i)))).then(t => (i.ts(), 
        t));
    }
    /**
    ...
    // be turned off.
    xr(t) {
        return Ss(t).get(Us.key).next(t => {
            if (null !== t && this.Rr(t.leaseTimestampMs, 5e3) && !this.gr(t.ownerId) && !this.Ir(t) && !(this.qi || this.allowTabSynchronization && t.allowTabSynchronization)) throw new M(x.FAILED_PRECONDITION, ps);
        });
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    Tr(t) {
        const e = Ss(t);
        return e.get(Us.key).next(t => this.Ir(t) ? (m("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(Us.key)) : Qn.resolve());
    }
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */    Rr(t, e) {
        const n = Date.now();
    ...
    sr() {
        null !== this.document && "function" == typeof this.document.addEventListener && (this.ji = () => {
            this.bs.lr(() => (this.inForeground = "visible" === this.document.visibilityState, 
            this.nr()));
     ...
     */    gr(t) {
        var e;
        try {
            const n = null !== (null === (e = this.Zi) || void 0 === e ? void 0 : e.getItem(this.Vr(t)));
    ...
    /** Removes the zombied client entry if it exists. */    Sr() {
        if (this.Zi) try {
 ...
 */
function Ss(t) {
    return vs.js(t, Us.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Ds(t) {
    return vs.js(t, ei.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ vs.Ji = "main";
...
class Cs {
    ...
    Lr(t) {
        const e = this.Br(t);
        return this.db.Nr().Si(t).next(t => e.next(e => t + e));
    }
    Br(t) {
        let e = 0;
        return this.qr(t, t => {
     ...
     */    Wr(t, e) {
        ...
        return function(t, e) {
            let n = !1;
            return Os(t).jr(s => $s(t, s, e).next(t => (t && (n = !0), Qn.resolve(!t)))).next(() => n);
        }
        /**
 ...
 */ (t, e);
    ...
    Kr(t, e) {
        const n = this.db.$r().oi(), s = [];
        let i = 0;
        return this.Ur(t, (r, o) => {
            if (o <= e) {
                const e = this.Wr(t, r).next(e => {
                    if (!e) 
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ class Ns {
    constructor(
    /**
    ...
    Xr(t, e, n, s) {
        ...
        return r.add({}).next(o => {
            ...
            const h = new qn(o, e, n, s), a = function(t, e, n) {
                ...
                return new Ws(e, n.batchId, n.yn.toMillis(), s, i);
            }(this.serializer, this.userId, h), u = [];
            let c = new ct((t, e) => b(t.N(), e.N()));
            for (const t of s) {
                const e = js.key(this.userId, t.key.path, o);
                c = c.add(t.key.path.p()), u.push(r.put(a)), u.push(i.put(e, js.PLACEHOLDER));
            }
            return c.forEach(e => {
    ...
    Zr(t, e) {
        return xs(t).get(e).next(t => t ? (V(t.userId === this.userId), fs(this.serializer, t)) : null);
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    to(t, e) {
        return this.Hr[e] ? Qn.resolve(this.Hr[e]) : this.Zr(t, e).next(t => {
            if (t) {
                const n = t.keys();
                return this.Hr[e] = n, n;
            }
            return null;
        });
    }
    ...
    so(t) {
        ...
        return xs(t).Ws(Ws.userMutationsIndex, e).next(t => t.map(t => fs(this.serializer, t)));
    }
    os(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = js.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Ms(t).ei({
            range: s
        }, (n, s, r) => {
    ...
    ls(t, e) {
        ...
        const s = [];
        return e.forEach(e => {
            const i = js.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Ms(t).ei({
                range: r
            }, (t, s, i) => {
            ...
            s.push(o);
        }), Qn.Bn(s).next(() => this.io(t, n));
    }
    Es(t, e) {
        const n = e.path, s = n.length + 1, i = js.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    ro(t, e) {
        return ks(t.Oi, this.userId, e).next(n => (t.Zn(() => {
            this.oo(e.batchId);
    ...
    ho(t) {
        return this.Jr(t).next(e => {
            if (!e) return Qn.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(js.prefixForUser(this.userId)), s = [];
            return Ms(t).ei({
                range: n
            }, (t, e, n) => {
                if (t[0] === this.userId) {
    ...
    Mi(t, e) {
        return $s(t, this.userId, e);
    }
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    ao(t) {
        return Os(t).get(this.userId).next(t => t || new Qs(this.userId, -1, 
        /*lastStreamToken=*/ ""));
    }
}
 ...
 */ function $s(t, e, n) {
    const s = js.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Ms(t).ei({
        range: r,
        xi: !0
...
function ks(t, e, n) {
    const s = t.store(Ws.store), i = t.store(js.store), r = [], o = IDBKeyRange.only(n.batchId);
    let h = 0;
    const a = s.ei({
        range: o
    }, (t, e, n) => (h++, n.delete()));
    ...
    for (const t of n.mutations) {
        const s = js.key(e, t.key.path, n.batchId);
 ...
 */ (t));
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(Js.store), t.deleteObjectStore(Ys.store), t.deleteObjectStore(Xs.store);
        }(t), ti(t)), r = r.next(() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(Xs.store), n = new Xs(
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, L.min().A(), 
            /*targetCount=*/ 0);
            return e.put(Xs.key, n);
        }
        /**
 ...
 */ (i))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next(() => function(t, e) {
            return e.store(Ws.store).Ws().next(n => {
                t.deleteObjectStore(Ws.store), t.createObjectStore(Ws.store, {
                    keyPath: Ws.keyPath,
                    autoIncrement: !0
                }).createIndex(Ws.userMutationsIndex, Ws.userMutationsKeyPath, {
                    unique: !0
 ...
 */ (t), this.addDocumentGlobal(i)))), n < 7 && s >= 7 && (r = r.next(() => this.ensureSequenceNumbers(i))), 
        n < 8 && s >= 8 && (r = r.next(() => this.createCollectionParentIndex(t, i))), n < 9 && s >= 9 && (r = r.next(() => {
            ...
            !function(t) {
                ...
                const e = t.objectStore(zs.store);
                e.createIndex(zs.readTimeIndex, zs.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(zs.collectionReadTimeIndex, zs.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }
            /**
 ...
 */ (e);
    ...
    addDocumentGlobal(t) {
        let e = 0;
        return t.store(zs.store).ei((t, n) => {
            e += As(n);
        }).next(() => {
            const n = new Hs(e);
    ...
    removeAcknowledgedMutations(t) {
        const e = t.store(Qs.store), n = t.store(Ws.store);
        return e.Ws().next(e => Qn.forEach(e, e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Ws(Ws.userMutationsIndex, s).next(n => Qn.forEach(n, n => {
                V(n.userId === e.userId);
     ...
     */    ensureSequenceNumbers(t) {
        const e = t.store(Js.store), n = t.store(zs.store);
 ...
 */ (r);
                s.push(e.get(o).next(n => n ? Qn.resolve() : (n => e.put(new Js(0, Xn(n), t.highestListenSequenceNumber)))(r)));
            }).next(() => Qn.Bn(s));
        });
    }
    createCollectionParentIndex(t, e) {
        ...
        const n = e.store(Zs.store), s = new ss, i = t => {
            if (s.add(t)) {
                const e = t.S(), s = t.p();
                return n.put({
                    collectionId: e,
        ...
        return e.store(zs.store).ei({
            xi: !0
        }, (t, e) => {
            const n = new q(t);
            return i(n.p());
        }).next(() => e.store(js.store).ei({
            xi: !0
        }, ([t, e, n], s) => {
            const r = es(e);
            return i(r.p());
 ...
 */
zs.readTimeIndex = "readTimeIndex", zs.readTimeIndexPath = "readTime", 
/**
 ...
 */
zs.collectionReadTimeIndex = "collectionReadTimeIndex", zs.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
/** Name of the IndexedDb object store. */ function ti(t) {
    t.createObjectStore(Js.store, {
        keyPath: Js.keyPath
...
const ni = [ ...[ ...[ ...[ Qs.store, Ws.store, js.store, zs.store, Ys.store, Us.store, Xs.store, Js.store ], ei.store ], Hs.store ], Zs.store ];
...
class si {
    constructor(t) {
        ...
        // log on 12.2.
        12.2 === si.uo(s()) && A("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /**
     ...
     */    static tr(t, e, n) {
        return m("SimpleDb", "Opening database:", t), new Qn((s, i) => {
            ...
            r.onsuccess = t => {
                ...
                n.createOrUpgrade(s, r.transaction, e.oldVersion, Ls).next(() => {
                    m("SimpleDb", "Database upgrade to version " + Ls + " complete");
                });
            };
        }).On();
    }
    /** Deletes the specified database. */    static delete(t) {
        return m("SimpleDb", "Removing database:", t), ui(window.indexedDB.deleteDatabase(t)).On();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static Hi() {
        ...
        // Check the UA string to find out the browser.
                const t = s(), e = si.uo(t), n = 0 < e && e < 10, i = si.lo(t), r = 0 < i && i < 4.5;
        // IE 10
    ...
    async runTransaction(t, e, n) {
        ...
        for (;;) {
            ++i;
            const t = hi.open(this.db, s ? "readonly" : "readwrite", e);
            try {
                const e = n(t).catch(e => (
 ...
 */ class ii {
     ...
     */    delete() {
        return ui(this.do.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class ri extends M {
    constructor(t) {
        super(x.UNAVAILABLE, "IndexedDB transaction failed: " + t), this.name = "IndexedDbTransactionError";
    }
}

/** Verifies whether `e` is an IndexedDbTransactionError. */ function oi(t) {
 ...
 */ class hi {
    constructor(t) {
         ...
         */
        this.Io = new Yn, this.transaction.oncomplete = () => {
            this.Io.resolve();
        }, this.transaction.onabort = () => {
            t.error ? this.Io.reject(new ri(t.error)) : this.Io.resolve();
        }, this.transaction.onerror = t => {
            const e = li(t.target.error);
            this.Io.reject(new ri(e));
        };
    }
    static open(t, e, n) {
        return new hi(t.transaction(n, e));
    }
    get fo() {
        return this.Io.promise;
    }
    abort(t) {
        t && this.Io.reject(t), this.aborted || (m("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class ai {
     ...
     */    add(t) {
        return m("SimpleDb", "ADD", this.store.name, t, t), ui(this.store.add(t));
    }
    /**
     ...
     */    get(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        return ui(this.store.get(t)).next(e => (
        // Normalize nonexistence to null.
        void 0 === e && (e = null), m("SimpleDb", "GET", this.store.name, t, e), e));
    }
    delete(t) {
        return m("SimpleDb", "DELETE", this.store.name, t), ui(this.store.delete(t));
    }
    /**
     ...
     */    count() {
        return m("SimpleDb", "COUNT", this.store.name), ui(this.store.count());
    }
    Ws(t, e) {
        const n = this.cursor(this.options(t, e)), s = [];
        return this.mo(n, (t, e) => {
            s.push(e);
        }).next(() => s);
    }
    Ao(t, e) {
        ...
        return this.mo(s, (t, e, n) => n.delete());
    }
    ei(t, e) {
        let n;
        e ? n = t : (n = {}, e = t);
    ...
    mo(t, e) {
        ...
        return new Qn((s, i) => {
            t.onerror = t => {
                ...
                r.$n ? s() : null === r.Eo ? i.continue() : i.continue(r.Eo);
            };
        }).next(() => Qn.Bn(n));
    }
    options(t, e) {
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function _i() {
...
class fi {
    constructor(t, e, n, s, i) {
        this.Ro = t, this.vs = e, this.Po = n, this.op = s, this.Vo = i, this.yo = new Yn, 
        this.then = this.yo.promise.then.bind(this.yo.promise), 
        // It's normal for the deferred promise to be canceled (due to cancellation)
        // and so we attach a dummy catch callback to avoid
        // 'UnhandledPromiseRejectionWarning' log spam.
        this.yo.promise.catch(t => {});
    }
    /**
     ...
     */    static po(t, e, n, s, i) {
        const r = Date.now() + n, o = new fi(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
     ...
     */    cancel(t) {
        null !== this.bo && (this.clearTimeout(), this.yo.reject(new M(x.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    vo() {
        this.Ro.lr(() => null !== this.bo ? (this.clearTimeout(), this.op().then(t => this.yo.resolve(t))) : Promise.resolve());
    }
    clearTimeout() {
...
class di {
    constructor() {
        ...
        this.xo = new Jn(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Mo = () => this.xo.Ls();
        const t = _i();
        t && "function" == typeof t.addEventListener && t.addEventListener("visibilitychange", this.Mo);
    }
     ...
     */    async Qo(t) {
        if (this.Bo(), !this.Co) {
            this.Co = !0;
            const e = _i();
            e && e.removeEventListener("visibilitychange", this.Mo), await this.Uo(t);
        }
    }
    /**
     ...
     */    enqueue(t) {
        return this.Bo(), this.Co ? new Promise(t => {}) : this.qo(t);
    }
    /**
     ...
     */    dr(t) {
        this.Do.push(t), this.lr(() => this.Wo());
    }
    /**
     ...
     */    async Wo() {
        if (0 !== this.Do.length) {
            try {
                await this.Do[0](), this.Do.shift(), this.xo.reset();
            } catch (t) {
                if (!oi(t)) throw t;
 // Failure will be handled by AsyncQueue
    ...
    qo(t) {
        const e = this.So.then(() => (this.$o = !0, t().catch(t => {
            // Re-throw the error so that this.tail becomes a rejected Promise and
            // all further attempts to chain (via .then) will just short-circuit
            // and return the rejected Promise.
            throw this.No = t, this.$o = !1, A("INTERNAL UNHANDLED ERROR: ", 
            /**
 ...
 */ (t)), t;
     ...
     */    Os(t, e, n) {
        ...
        const s = fi.po(this, t, e, n, t => this.jo(t));
        return this.Fo.push(s), s;
    }
    Bo() {
        this.No && P();
    }
     ...
     * exists.
     */    zo(t) {
        for (const e of this.Fo) if (e.vs === t) return !0;
        return !1;
    }
    /**
     ...
     */    Ho(t) {
        ...
        return this.Go().then(() => {
            ...
            this.Fo.sort((t, e) => t.Po - e.Po);
            for (const e of this.Fo) if (e.Bs(), "all" /* All */ !== t && e.vs === t) break;
            return this.Go();
        });
    }
    /**
    ...
    /** Called once a DelayedOperation is run or canceled. */    jo(t) {
        // NOTE: indexOf / slice are O(n), but delayedOperations is expected to be small.
        const e = this.Fo.indexOf(t);
        this.Fo.splice(e, 1);
    }
}
 ...
 */ function wi(t, e) {
    if (A("AsyncQueue", `${e}: ${t}`), oi(t)) return new M(x.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Ei {
    constructor(t) {
        this.Jo = t, this.buffer = new ct(Ti), this.Xo = 0;
    }
    Zo() {
        return ++this.Xo;
    }
...
class mi {
    ...
    static ah(t) {
        return new mi(t, mi.uh, mi.lh);
    }
}

mi._h = -1, mi.fh = 1048576, mi.dh = 41943040, mi.uh = 10, mi.lh = 1e3, mi.wh = new mi(mi.dh, mi.uh, mi.lh), 
mi.Th = new mi(mi._h, 0, 0);
...
class Ai {
    ...
    start(t) {
        this.Or.params.rh !== mi._h && this.mh(t);
    }
    stop() {
    ...
    mh(t) {
        const e = this.Eh ? 3e5 : 6e4;
        m("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Ih = this.Ro.Os("lru_garbage_collection" /* LruGarbageCollection */ , e, async () => {
            this.Ih = null, this.Eh = !0;
            try {
                await t.Ah(this.Or);
            } catch (t) {
                oi(t) ? m("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await gi(t);
            }
            await this.mh(t);
        });
    }
...
/** Implements the steps for LRU garbage collection. */ class Ri {
    ...
    /** Given a percentile of target to collect, returns the number of targets to collect. */    Ph(t, e) {
        return this.Rh.Lr(t).next(t => Math.floor(e / 100 * t));
    }
    /** Returns the nth sequence number, counting in order from the smallest. */    Vh(t, e) {
        if (0 === e) return Qn.resolve(Hn.ps);
        const n = new Ei(e);
        return this.Rh.pe(t, t => n.th(t.sequenceNumber)).next(() => this.Rh.qr(t, t => n.th(t))).next(() => n.maxValue);
    }
    /**
    ...
    gh(t, e) {
        return this.params.rh === mi._h ? (m("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Qn.resolve(Ii)) : this.zr(t).next(n => n < this.params.rh ? (m("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} ` + `is lower than threshold ${this.params.rh}`), 
        Ii) : this.yh(t, e));
    }
    zr(t) {
        return this.Rh.zr(t);
    ...
    yh(t, e) {
        let s, i, r, o, h, a, u;
        const c = Date.now();
        return this.Ph(t, this.params.oh).next(e => (
        // Cap at the configured max
        e > this.params.hh ? (m("LruGarbageCollector", "Capping sequence numbers to collect down " + `to the maximum of ${this.params.hh} ` + `from ${e}`), 
        i = this.params.hh) : i = e, o = Date.now(), this.Vh(t, i))).next(n => (s = n, h = Date.now(), 
        this.vi(t, s, e))).next(e => (r = e, a = Date.now(), this.Kr(t, s))).next(t => {
...
class Pi {
    ...
    t, e, n) {
        ...
        this.vh = new k(t => Y(t), X), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.Sh = L.min(), this.ns = t.Cr(n), this.Dh = t.$r(), this.Xi = t.Nr(), this.Ch = new Gn(this.Dh, this.ns, this.persistence.kr()), 
        this.ph.Fh(this.Ch);
    }
    start() {
    ...
    async Nh(t) {
        let e = this.ns, n = this.Ch;
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            // Swap out the mutation queue, grabbing the pending mutation batches
            // before and after.
            let i;
            return this.ns.so(s).next(r => (i = r, e = this.persistence.Cr(t), 
            // Recreate our LocalDocumentsView using the new
            // MutationQueue.
            n = new Gn(this.Dh, e, this.persistence.kr()), e.so(s))).next(t => {
                const e = [], r = [];
        ...
        return this.ns = e, this.Ch = n, this.ph.Fh(this.Ch), s;
    }
    Mh(t) {
        const e = O.now(), n = t.reduce((t, e) => t.add(e.key), mt());
        let s;
        return this.persistence.runTransaction("Locally write mutations", "readwrite", i => this.Ch.us(i, n).next(n => {
            s = n;
    ...
    Oh(t) {
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", e => {
            const n = t.batch.keys(), s = this.Dh.oi({
                ai: !0
            });
            return this.Lh(e, t, s).next(() => s.apply(e)).next(() => this.ns.ho(e)).next(() => this.Ch.us(e, n));
        });
    }
    Bh(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let n;
            return this.ns.Zr(e, t).next(t => (V(null !== t), n = t.keys(), this.ns.ro(e, t))).next(() => this.ns.ho(e)).next(() => this.Ch.us(e, n));
        });
    }
    no() {
        return this.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", t => this.ns.no(t));
    }
    mi() {
        return this.persistence.runTransaction("Get last remote snapshot version", "readonly", t => this.Xi.mi(t));
    }
    qh(t) {
        const e = t.X;
        let n = this.bh;
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Qt.forEach((t, i) => {
                ...
                // the updated assignment.
                                r.push(this.Xi.Ni(s, t.Xt, i).next(() => this.Xi.Ci(s, t.Yt, i)));
                ...
                // Update the resume token if the change includes one.
                    ...
                    Pi.Uh(o, a, t) && r.push(this.Xi.yi(s, a));
                }
            });
            let o = ft(), h = mt();
            ...
            r.push(i.getEntries(s, h).next(n => {
                t.jt.forEach((h, a) => {
                    ...
                    t.Kt.has(h) && r.push(this.persistence.wi.Gr(s, h));
                });
            })), !e.isEqual(L.min())) {
                const t = this.Xi.mi(s).next(t => this.Xi.Ri(s, s.Li, e));
                r.push(t);
            }
            return Qn.Bn(r).next(() => i.apply(s)).next(() => this.Ch.cs(s, o));
        }).then(t => (this.bh = n, t));
    }
    /**
    ...
    async Wh(t) {
        ...
        for (const e of t) {
            const t = e.targetId;
            if (!e.fromCache) {
                const e = this.bh.get(t), n = e.X, s = e.et(n);
                // Advance the last limbo free snapshot version
                                this.bh = this.bh.nt(t, s);
            }
        }
    }
    jh(t) {
    ...
    Kh(t) {
        return this.persistence.runTransaction("read document", "readonly", e => this.Ch.rs(e, t));
    }
    Gh(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            let n;
            return this.Xi.Di(e, t).next(s => s ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            n = s, Qn.resolve(n)) : this.Xi.Ti(e).next(s => (n = new et(t, s, 0 /* Listen */ , e.Li), 
            this.Xi.Pi(e, n).next(() => n))));
        }).then(e => {
            // If Multi-Tab is enabled, the existing target data may be newer than
            // the in-memory data
            const n = this.bh.get(e.targetId);
            return (null === n || e.X.o(n.X) > 0) && (this.bh = this.bh.nt(e.targetId, e), this.vh.set(t, e.targetId)), 
            e;
        });
    }
    Di(t, e) {
        const n = this.vh.get(e);
        return void 0 !== n ? Qn.resolve(this.bh.get(n)) : this.Xi.Di(t, e);
    }
    zh(t, e) {
        const n = this.bh.get(t), s = e ? "readwrite" : "readwrite-primary";
        return this.persistence.runTransaction("Release target", s, t => e ? Qn.resolve() : this.persistence.wi.removeTarget(t, n)).then(() => {
            this.bh = this.bh.remove(t), this.vh.delete(n.target);
        });
    }
    Hh(t, e) {
        let n = L.min(), s = mt();
        return this.persistence.runTransaction("Execute query", "readonly", i => this.Di(i, t.We()).next(t => {
            if (t) return n = t.lastLimboFreeSnapshotVersion, this.Xi.ki(i, t.targetId).next(t => {
                s = t;
            });
        }).next(() => this.ph._s(i, t, e ? n : L.min(), e ? s : mt())).next(t => ({
            documents: t,
            Yh: s
        })));
    }
    Lh(t, e, n) {
        ...
        }), r.next(() => this.ns.ro(t, s));
    }
    Ah(t) {
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", e => t.gh(e, this.bh));
    }
}
...
class Vi extends Pi {
    constructor(t, e, n) {
        super(t, e, n), this.persistence = t, this.ns = t.Cr(n), this.Dh = t.$r(), this.Xi = t.Nr();
    }
    /** Starts the LocalStore. */    start() {
        return this.Jh();
    }
    Xh(t) {
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", e => this.ns.to(e, t).next(t => t ? this.Ch.us(e, t) : Qn.resolve(null)));
    }
    Zh(t) {
        this.ns.oo(t);
    }
    ...
    ta(t) {
        ...
        return e ? Promise.resolve(e.target) : this.persistence.runTransaction("Get target data", "readonly", e => this.Xi.Me(e, t).next(t => t ? t.target : null));
    }
    si() {
        return this.persistence.runTransaction("Get new document changes", "readonly", t => this.Dh.si(t, this.Sh)).then(({ii: t, readTime: e}) => (this.Sh = e, 
        t));
    }
    async Jh() {
        this.Sh = await this.persistence.runTransaction("Synchronize last document change read time", "readonly", t => this.Dh.ri(t));
    }
}
 ...
 */ class yi {
    constructor() {
        ...
        this.ea = new ct(pi.na), 
        // A set of outstanding references to a document sorted by target id.
        this.sa = new ct(pi.ia);
    }
    ...
    /** Add references to the given document keys for the given ID. */    ra(t, e) {
     ...
     * removed.
     */    aa(t) {
        const e = new W(new q([])), n = new pi(e, t), s = new pi(e, t + 1), i = [];
        return this.sa.vt([ n, s ], t => {
            this.oa(t), i.push(t.key);
        }), i;
    }
    ua() {
        this.ea.forEach(t => this.oa(t));
    }
    oa(t) {
        this.ea = this.ea.delete(t), this.sa = this.sa.delete(t);
    }
    ca(t) {
        const e = new W(new q([])), n = new pi(e, t), s = new pi(e, t + 1);
        let i = mt();
        return this.sa.vt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    Mi(t) {
        const e = new pi(t, 0), n = this.ea.Dt(e);
...
class pi {
    ...
    /** Compare by key then by ID */    static na(t, e) {
        return W.P(t.key, e.key) || b(t.la, e.la);
    }
    /** Compare by ID then by key */    static ia(t, e) {
        return b(t.la, e.la) || W.P(t.key, e.key);
    }
}
 ...
 */ function bi(t, e) {
    if (0 !== e.length) throw new M(x.INVALID_ARGUMENT, `Function ${t}() does not support arguments, ` + "but was called with " + Ki(e.length, "argument") + ".");
}
 ...
 */ function vi(t, e, n) {
    if (e.length !== n) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires ` + Ki(n, "argument") + ", but was called with " + Ki(e.length, "argument") + ".");
}
 ...
 */ function Si(t, e, n) {
    if (e.length < n) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires at least ` + Ki(n, "argument") + ", but was called with " + Ki(e.length, "argument") + ".");
}
 ...
 */ function Di(t, e, n, s) {
    if (e.length < n || e.length > s) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires between ${n} and ` + `${s} arguments, but was called with ` + Ki(e.length, "argument") + ".");
}
...
function ki(t, e, n, s, i) {
    void 0 !== s && function(t, e, n, s, i) {
        if (!(s instanceof Array)) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires its ${e} ` + `option to be an array, but it was: ${Bi(s)}`);
        for (let r = 0; r < s.length; ++r) if (!i(s[r])) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires all ${e} ` + `elements to be ${n}, but the value at index ${r} ` + `was: ${Bi(s[r])}`);
    }(t, e, n, s, i);
}
 ...
 */ function Mi(t, e, n, s) {
    if (!e.some(t => t === s)) throw new M(x.INVALID_ARGUMENT, `Invalid value ${Bi(s)} provided to function ` + `${t}() for its ${ji(n)} argument. Acceptable ` + `values: ${e.join(", ")}`);
    return s;
}

/** Helper to validate the type of a provided input. */ function Oi(t, e, n, s) {
    let i = !1;
    if (i = "object" === e ? Li(s) : "non-empty string" === e ? "string" == typeof s && "" !== s : typeof s === e, 
    !i) {
        const i = Bi(s);
...
/** Returns a string describing the type / value of the provided input. */ function Bi(t) {
...
function qi(t, e, n) {
    if (void 0 === n) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires a valid ${ji(e)} ` + "argument, but it was undefined.");
}
 ...
 */ function Qi(t, e, n, s) {
    const i = Bi(s);
    return new M(x.INVALID_ARGUMENT, `Function ${t}() requires its ${ji(n)} ` + `argument to be a ${e}, but it was: ${i}`);
}

function Wi(t, e, n) {
    if (n <= 0) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires its ${ji(e)} argument to be a positive number, but it was: ${n}.`);
}
 ...
 */ class Hi {
    ...
    static fromBase64String(t) {
        vi("Blob.fromBase64String", arguments, 1), Ci("Blob.fromBase64String", "string", 1, t), 
        zi();
        try {
            return new Hi(tt.fromBase64String(t));
        } catch (t) {
            throw new M(x.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }
    static fromUint8Array(t) {
        if (vi("Blob.fromUint8Array", arguments, 1), Gi(), !(t instanceof Uint8Array)) throw Qi("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new Hi(tt.fromUint8Array(t));
    }
    toBase64() {
        return vi("Blob.toBase64", arguments, 0), zi(), this._a.toBase64();
    }
    toUint8Array() {
        return vi("Blob.toUint8Array", arguments, 0), Gi(), this._a.toUint8Array();
    }
    toString() {
 ...
 */ class Yi {
    constructor(t) {
        !function(t, e, n, s) {
            if (!(e instanceof Array) || e.length < s) throw new M(x.INVALID_ARGUMENT, `Function ${t}() requires its ${n} argument to be an ` + "array with at least " + `${Ki(s, "element")}.`);
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (Ci("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new M(x.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.fa = new Q(t);
    }
}
 ...
 */ class Ji extends Yi {
    ...
    isEqual(t) {
        if (!(t instanceof Ji)) throw Qi("isEqual", "FieldPath", 1, t);
...
class sr extends Zi {
    constructor(t, e) {
        super(), this.wa = t, this.Ra = e;
    }
    Ta(t) {
        const e = er(this, t, 
        /*array=*/ !0), n = this.Ra.map(t => Rr(t, e)), s = new Be(n);
...
class ir extends Zi {
    ...
    Ta(t) {
        const e = er(this, t, 
        /*array=*/ !0), n = this.Ra.map(t => Rr(t, e)), s = new Ue(n);
        return new ze(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class rr extends Zi {
    constructor(t, e) {
        super(), this.wa = t, this.Pa = e;
    }
    Ta(t) {
        const e = new We(t.serializer, ie(t.serializer, this.Pa));
...
/** The public FieldValue class of the lite API. */ class or extends Zi {
    constructor() {
        super();
    }
    static delete() {
        return bi("FieldValue.delete", arguments), new hr(new tr("FieldValue.delete"));
    }
    static serverTimestamp() {
        return bi("FieldValue.serverTimestamp", arguments), new hr(new nr("FieldValue.serverTimestamp"));
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Si("FieldValue.arrayUnion", arguments, 1), new hr(new sr("FieldValue.arrayUnion", t));
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Si("FieldValue.arrayRemove", arguments, 1), new hr(new ir("FieldValue.arrayRemove", t));
    }
    static increment(t) {
        return Ci("FieldValue.increment", "number", 1, t), vi("FieldValue.increment", arguments, 1), 
        new hr(new rr("FieldValue.increment", t));
    }
}
 ...
 */ class hr extends or {
    constructor(t) {
        super(), this.da = t, this.wa = t.wa;
    }
    Ta(t) {
        return this.da.Ta(t);
    }
    isEqual(t) {
        return t instanceof hr && this.da.isEqual(t.da);
    }
}
 ...
 */ class ar {
    constructor(t, e) {
        if (vi("GeoPoint", arguments, 2), Ci("GeoPoint", "number", 1, t), Ci("GeoPoint", "number", 2, e), 
     ...
     * with an underscore.
     */    T(t) {
        return b(this.Va, t.Va) || b(this.ga, t.ga);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class _r {
    constructor(t, e, n) {
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class fr {
    constructor(t, e, n) {
        this.data = t, this.Le = e, this.fieldTransforms = n;
    }
    va(t, e) {
...
/** A "context" object passed around while parsing user data. */ class wr {
    ...
    constructor(t, e, n, s, i, r) {
        ...
        void 0 === i && this.Sa(), this.fieldTransforms = i || [], this.Le = r || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    Da(t) {
        return new wr(Object.assign(Object.assign({}, this.settings), t), this.s, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.Le);
    }
    Ca(t) {
        var e;
        const n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), s = this.Da({
            path: n,
            Aa: !1
        });
        return s.Fa(t), s;
    ...
    Ia(t) {
        return br(t, this.settings.methodName, this.settings.ka || !1, this.path, this.settings.ma);
    }
    ...
    Fa(t) {
        ...
        if (dr(this.Ea) && cr.test(t)) throw this.Ia('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Tr {
    ...
    /** Creates a new top-level parse context. */    xa(t, e, n, s = !1) {
        return new wr({
            Ea: t,
            methodName: e,
            ma: n,
...
/** Parse document data from a set() call. */ function Er(t, e, n, s, i, r = {}) {
    const o = t.xa(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    gr("Data must be an object, but it was:", o, s);
    const h = Pr(s, o);
    let a, u;
    if (r.merge) a = new Ge(o.Le), u = o.fieldTransforms; else if (r.mergeFields) {
        ...
        for (const s of r.mergeFields) {
            let i;
            if (s instanceof Yi) i = s.fa; else {
    ...
    return new _r(new dn(h), a, u);
}

/** Parse update data from an update() call. */ function Ir(t, e, n, s) {
    const i = t.xa(1 /* Update */ , e, n);
    gr("Data must be an object, but it was:", i, s);
    const r = [], o = new wn;
    N(s, (t, s) => {
        const h = pr(e, t, n), a = i.Na(h);
        if (s instanceof Zi && s.da instanceof tr) 
    ...
    const h = new Ge(r);
    return new fr(o.ze(), h, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function mr(t, e, n, s, i, r) {
    const o = t.xa(1 /* Update */ , e, n), h = [ yr(e, s, n) ], a = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) h.push(yr(e, r[t])), a.push(r[t + 1]);
    const u = [], c = new wn;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = h.length - 1; t >= 0; --t) if (!vr(u, h[t])) {
        const e = h[t], n = a[t], s = o.Na(e);
        if (n instanceof Zi && n.da instanceof tr) 
        // Add it to the field mask, but don't add anything to updateData.
        u.push(e); else {
            const t = Rr(n, s);
    ...
    const l = new Ge(u);
    return new fr(c.ze(), l, o.fieldTransforms);
}
 ...
 */ function Ar(t, e, n, s = !1) {
    return Rr(n, t.xa(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Rr(t, e) {
    if (Vr(t)) return gr("Unsupported field value:", e, t), Pr(t, e);
    if (t instanceof Zi) 
 ...
 */
    return function(t, e) {
        ...
        if (!dr(e.Ea)) throw e.Ia(`${t.wa}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof lr) {
            ...
            return {
                referenceValue: ue(t.ya || e.s, t.pa.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.Ia(`Unsupported field value: ${Bi(t)}`);
    }
    /**
...
function Vr(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof O || t instanceof ar || t instanceof Hi || t instanceof lr || t instanceof Zi);
}
 ...
 */ function yr(t, e, n) {
    if (e instanceof Yi) return e.fa;
    if ("string" == typeof e) return pr(t, e);
    throw br("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function pr(t, e, n) {
    try {
        return function(t) {
            if (t.search(Xi) >= 0) throw new M(x.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not contain ` + "'~', '*', '/', '[', or ']'");
            try {
                return new Ji(...t.split("."));
            } catch (e) {
                throw new M(x.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, ` + "begin with '.', end with '.', or contain '..'");
            }
        }(e).fa;
    } catch (e) {
        throw br((s = e) instanceof Error ? s.message : s.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
...
Sr.Oa = new Sr("google-credentials-uid"), Sr.La = new Sr("first-party-uid");
...
/** A CredentialsProvider that always yields an empty token. */ class Cr {
    constructor() {
        /**
...
class Fr {
    constructor(t) {
        ...
        this.currentUser = Sr.UNAUTHENTICATED, this.Ka = !1, 
        /**
        ...
        this.qa = null, this.forceRefresh = !1, this.ja = () => {
            this.Ga++, this.currentUser = this.za(), this.Ka = !0, this.qa && this.qa(this.currentUser);
        }, this.Ga = 0, this.auth = t.getImmediate({
            optional: !0
        }), this.auth ? this.auth.addAuthTokenListener(this.ja) : (
        // if auth is not available, invoke tokenListener once with null token
        this.ja(null), t.get().then(t => {
            this.auth = t, this.ja && 
            // tokenListener can be removed by removeChangeListener()
            this.auth.addAuthTokenListener(this.ja);
        }, () => {}));
    }
    getToken() {
        ...
        const t = this.Ga, e = this.forceRefresh;
        return this.forceRefresh = !1, this.auth ? this.auth.getToken(e).then(e => 
        // Cancel the request since the token changed while the request was
        // outstanding so the response is potentially for a previous user (which
        // user, we can't be sure).
        this.Ga !== t ? (m("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
        this.getToken()) : e ? (V("string" == typeof e.accessToken), new Dr(e.accessToken, this.currentUser)) : null) : Promise.resolve(null);
    }
    Ua() {
        this.forceRefresh = !0;
    }
    ...
    za() {
        ...
        return V(null === t || "string" == typeof t), new Sr(t);
    }
}
 ...
 */ class Nr {
    constructor(t, e) {
        this.Ha = t, this.Ya = e, this.type = "FirstParty", this.user = Sr.La;
    }
    get Ba() {
        const t = {
 ...
 */ class $r {
    ...
    getToken() {
        return Promise.resolve(new Nr(this.Ha, this.Ya));
    }
    Qa(t) {
...
class kr {
    constructor(t, e, n, s, i, r) {
        this.bs = t, this.Xa = n, this.Za = s, this.tu = i, this.listener = r, this.state = 0 /* Initial */ , 
        /**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */
        this.eu = 0, this.nu = null, this.stream = null, this.xo = new Jn(t, e);
    }
    /**
     ...
     */    async stop() {
        this.su() && await this.close(0 /* Initial */);
    }
    /**
     ...
     */    hu() {
        ...
        this.iu() && null === this.nu && (this.nu = this.bs.Os(this.Xa, 6e4, () => this.au()));
    }
    /** Sends a message to the underlying stream. */    uu(t) {
        this.cu(), this.stream.send(t);
    }
    /** Called by the idle timer when the stream should close due to inactivity. */    async au() {
        if (this.iu()) 
        // When timing out an idle stream there's no reason to force the stream into backoff when
        // it restarts so set the stream state to Initial instead of Error.
        return this.close(0 /* Initial */);
    }
    /** Marks the stream as active again. */    cu() {
    ...
    auth() {
        ...
        const t = this.fu(this.eu), e = this.eu;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.tu.getToken().then(t => {
    ...
    du(t) {
        const e = this.fu(this.eu);
        this.stream = this.Tu(t), this.stream.Eu(() => {
    ...
    ru() {
        this.state = 4 /* Backoff */ , this.xo.xs(async () => {
     ...
     */    fu(t) {
        return e => {
            this.bs.lr(() => this.eu === t ? e() : (m("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class xr extends kr {
     ...
     */    Ru(t) {
        const e = {};
        e.database = we(this.serializer), e.removeTarget = t, this.uu(e);
    }
}
 ...
 */ class Mr extends kr {
    ...
    onMessage(t) {
        ...
        V(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Pu) {
        ...
        return V(!t.writeResults || 0 === t.writeResults.length), this.Pu = !0, this.listener.pu();
    }
    /**
     ...
     */    bu() {
        ...
        const t = {};
        t.database = we(this.serializer), this.uu(t);
    }
    /** Sends a group of mutations to the Firestore backend to apply. */    gu(t) {
        const e = {
...
class Or extends class {
    ...
    constructor(t, e, n) {
        super(), this.Za = t, this.credentials = e, this.serializer = n, this.vu = !1;
    }
    Su() {
        if (this.vu) throw new M(x.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    Du(t, e) {
        return this.Su(), this.credentials.getToken().then(n => this.Za.Du(t, e, n)).catch(t => {
            throw t.code === x.UNAUTHENTICATED && this.credentials.Ua(), t;
        });
    }
    /** Gets an auth token and invokes the provided RPC with streamed results. */    Cu(t, e) {
        return this.Su(), this.credentials.getToken().then(n => this.Za.Cu(t, e, n)).catch(t => {
            throw t.code === x.UNAUTHENTICATED && this.credentials.Ua(), t;
        });
    }
}
...
class Lr {
    ...
    async Mu(t) {
        if (this.Ou(), this.mutations.length > 0) throw new M(x.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = g(t), s = {
                database: we(n.serializer),
                documents: e.map(t => le(n.serializer, t))
            }, i = await n.Cu("BatchGetDocuments", s), r = new Map;
            i.forEach(t => {
        ...
        return e.forEach(t => {
            t instanceof mn || t instanceof In ? this.Lu(t) : P();
        }), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new _n(t, this.Ue(t)) ]), this.xu.add(t);
    }
    async commit() {
        ...
        t.forEach((t, e) => {
            ...
            await n.Du("Commit", s);
        }(this.Fu, this.mutations), this.$u = !0;
    }
    Lu(t) {
        let e;
        ...
        const n = this.Nu.get(t.key.toString());
        if (n) {
            if (!e.isEqual(n)) 
     ...
     */    Ue(t) {
        const e = this.Nu.get(t.toString());
        return !this.xu.has(t) && e ? Je.updateTime(e) : Je.Qe();
    }
    /**
...
class Br {
     ...
     */    ju() {
        0 === this.Uu && (this.Ku("Unknown" /* Unknown */), this.Qu = this.Ro.Os("online_state_timeout" /* OnlineStateTimeout */ , 1e4, () => (this.Qu = null, 
        this.Gu("Backend didn't respond within 10 seconds."), this.Ku("Offline" /* Offline */), 
        Promise.resolve())));
    }
    /**
    ...
    Gu(t) {
        ...
        this.Wu ? (A(e), this.Wu = !1) : m("OnlineStateTracker", e);
    }
    Hu() {
...
class qr {
    ...
    e, n, s, i) {
         ...
         */
        this.tc = new Set, this.ec = i, this.ec.nc(t => {
            n.lr(async () => {
                this.sc() && (m("RemoteStore", "Restarting streams for network reachability change."), 
                await this.ic());
            });
        }), this.rc = new Br(n, s), 
        ...
        this.oc = function(t, e, n) {
            const s = g(t);
            return new xr(e, s.Za, s.credentials, s.serializer, n);
        }(this.Fu, n, {
            ...
            const s = g(t);
            return new Mr(e, s.Za, s.credentials, s.serializer, n);
        }(this.Fu, n, {
    ...
    async dc() {
        this.sc() && (this.wc() ? this.Tc() : this.rc.set("Unknown" /* Unknown */), 
     ...
     */    async disableNetwork() {
        this.tc.add(0 /* UserDisabled */), await this.Ic(), 
        // Set the OnlineState to Offline so get()s return from cache, etc.
        this.rc.set("Offline" /* Offline */);
    }
    async Ic() {
        await this.cc.stop(), await this.oc.stop(), this.Ju.length > 0 && (m("RemoteStore", `Stopping write stream with ${this.Ju.length} pending writes`), 
        this.Ju = []), this.mc();
    }
    async yr() {
        m("RemoteStore", "RemoteStore shutting down."), this.tc.add(5 /* Shutdown */), await this.Ic(), 
        this.ec.yr(), 
    ...
    Tc() {
        this.Zu = new Ct(this), this.oc.start(), this.rc.ju();
    }
    /**
    ...
    async uc(t, e) {
        ...
        this.rc.set("Online" /* Online */), t instanceof St && 2 /* Removed */ === t.state && t.cause) 
        ...
        try {
            ...
            await this.yc(e);
        } else if (t instanceof bt ? this.Zu.Pe(t) : t instanceof vt ? this.Zu.De(t) : this.Zu.ye(t), 
        !e.isEqual(L.min())) try {
            const t = await this.Yu.mi();
            e.o(t) >= 0 && 
            // We have received a target change with a global snapshot if the snapshot
            // version is not equal to SnapshotVersion.min().
            await this.pc(e);
        } catch (t) {
            m("RemoteStore", "Failed to raise snapshot:", t), await this.yc(t);
        }
    }
    /**
     ...
     */    async yc(t, e) {
        if (!oi(t)) throw t;
        this.tc.add(1 /* IndexedDbFailed */), 
        // Disable network and raise offline snapshots
        await this.Ic(), this.rc.set("Offline" /* Offline */), e || (
        ...
        this.Ro.dr(async () => {
            m("RemoteStore", "Retrying IndexedDB access"), await e(), this.tc.delete(1 /* IndexedDbFailed */), 
            await this.dc();
        });
    }
    /**
    ...
    /** Handles an error on a target */    async gc(t) {
        const e = t.cause;
        for (const n of t.targetIds) 
        // A watched target might have been removed already.
        this.Xu.has(n) && (await this.Vc.vc(n, e), this.Xu.delete(n), this.Zu.removeTarget(n));
    }
    /**
     ...
     */    async Ec() {
        let t = this.Ju.length > 0 ? this.Ju[this.Ju.length - 1].batchId : -1;
        for (;this.Sc(); ) try {
            const e = await this.Yu.jh(t);
            if (null === e) {
                0 === this.Ju.length && this.cc.hu();
                break;
            }
            t = e.batchId, this.Dc(e);
        } catch (t) {
            await this.yc(t);
        }
        this.Cc() && this.Fc();
    ...
    async fc() {
        ...
        for (const t of this.Ju) this.cc.gu(t.mutations);
    }
    async yu(t, e) {
        const n = this.Ju.shift(), s = Un.from(n, t, e);
        await this.bc(() => this.Vc.$c(s)), 
    ...
    async kc(t) {
        ...
        if (rt(e = t.code) && e !== x.ABORTED) {
            ...
            // restart.
                        this.cc.ou(), await this.bc(() => this.Vc.xc(e.batchId, t)), 
 ...
 */    }
    Mc() {
        return new Lr(this.Fu);
    }
    async ic() {
        this.tc.add(4 /* ConnectivityChange */), await this.Ic(), this.rc.set("Unknown" /* Unknown */), 
        this.tc.delete(4 /* ConnectivityChange */), await this.dc();
    }
    async Oc(t) {
        this.Ro.Ko(), 
        ...
        m("RemoteStore", "RemoteStore received new credentials"), this.tc.add(3 /* CredentialChange */), 
        await this.Ic(), this.rc.set("Unknown" /* Unknown */), await this.Vc.Oc(t), this.tc.delete(3 /* CredentialChange */), 
        await this.dc();
    }
    /**
     * Toggles the network state when the client gains or loses its primary lease.
     */    async Lc(t) {
        t ? (this.tc.delete(2 /* IsSecondary */), await this.dc()) : t || (this.tc.add(2 /* IsSecondary */), 
        await this.Ic(), this.rc.set("Unknown" /* Unknown */));
    }
}
...
class jr {
     ...
     */    static Bc(t, e, n) {
        ...
        i && (r = new M(s.error.code, s.error.message))), i ? new jr(t, e, s.state, r) : (A("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    qc() {
        const t = {
...
class Kr {
     ...
     */    static Bc(t, e) {
        ...
        s && (i = new M(n.error.code, n.error.message))), s ? new Kr(t, n.state, i) : (A("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    qc() {
        const t = {
 ...
 */ class Gr {
     ...
     */    static Bc(t, e) {
        ...
        return s ? new Gr(t, i) : (A("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class zr {
     ...
     */    static Bc(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new zr(e.clientId, e.onlineState) : (A("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Yr {
    constructor(t, e, n, s, i) {
        this.window = t, this.bs = e, this.persistenceKey = n, this.Wc = s, this.Vc = null, 
        this.qu = null, this.Ps = null, this.jc = this.Kc.bind(this), this.Gc = new ht(b), 
        this.hr = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Hc = Ur(this.persistenceKey, this.Wc), 
        this.Yc = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Gc = this.Gc.nt(this.Wc, new Hr), this.Jc = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
        this.Xc = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this.Zc = new RegExp(`^firestore_targets_${r}_(\\d+)$`), 
        this.tl = 
    ...
    async start() {
        ...
        // SharedClientState.
        const t = await this.Vc.Dr();
        for (const e of t) {
            if (e === this.Wc) continue;
            const t = this.getItem(Ur(this.persistenceKey, e));
            if (t) {
                const n = Gr.Bc(e, t);
                n && (this.Gc = this.Gc.nt(n.clientId, n));
            }
        }
        this.el();
        // Check if there is an existing online state and call the callback handler
        // if applicable.
        const e = this.storage.getItem(this.tl);
        if (e) {
            const t = this.nl(e);
            t && this.sl(t);
        }
        for (const t of this.zc) this.Kc(t);
        this.zc = [], 
        // Register a window unload hook to remove the client metadata entry from
        // WebStorage even if `shutdown()` was not called.
        this.window.addEventListener("unload", () => this.yr()), this.hr = !0;
    }
    ys(t) {
    ...
    Kc(t) {
        ...
        if (e.storageArea === this.storage) {
            if (m("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Hc) return void A("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.bs.dr(async () => {
                if (this.hr) {
                    if (null !== e.key) if (this.Jc.test(e.key)) {
                        if (null == e.newValue) {
                            const t = this.Al(e.key);
                            return this.Rl(t, null);
                        }
                        {
                            const t = this.Pl(e.key, e.newValue);
                            if (t) return this.Rl(t.clientId, t);
                        }
                    } else if (this.Xc.test(e.key)) {
                        if (null !== e.newValue) {
                            const t = this.Vl(e.key, e.newValue);
                            if (t) return this.gl(t);
                        }
                    } else if (this.Zc.test(e.key)) {
                        if (null !== e.newValue) {
                            const t = this.yl(e.key, e.newValue);
                            if (t) return this.pl(t);
                        }
                    } else if (e.key === this.tl) {
                        if (null !== e.newValue) {
                            const t = this.nl(e.newValue);
                            if (t) return this.sl(t);
                        }
                    } else if (e.key === this.Yc) {
                        const t = function(t) {
                            let e = Hn.ps;
                            if (null != t) try {
 ...
 */ (e.newValue);
    ...
    al(t, e, n) {
        const s = new jr(this.currentUser, t, e, n), i = Qr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.qc());
    }
    cl(t) {
        const e = Qr(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    }
    ml(t) {
        const e = {
    ...
    El(t, e, n) {
        const s = Wr(this.persistenceKey, t), i = new Kr(t, e, n);
        this.setItem(s, i.qc());
    }
    /**
     ...
     * could not be parsed.
     */    Vl(t, e) {
        const n = this.Xc.exec(t), s = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
        return jr.Bc(new Sr(i), s, e);
    }
    /**
     * Parses a query target state from WebStorage. Returns 'null' if the value
     * could not be parsed.
     */    yl(t, e) {
        const n = this.Zc.exec(t), s = Number(n[1]);
        return Kr.Bc(s, e);
    }
    /**
    ...
    async gl(t) {
        if (t.user.uid === this.currentUser.uid) return this.Vc.bl(t.batchId, t.state, t.error);
    ...
    Rl(t, e) {
        const n = e ? this.Gc.nt(t, e) : this.Gc.remove(t), s = this.rl(this.Gc), i = this.rl(n), r = [], o = [];
        return i.forEach(t => {
            s.has(t) || r.push(t);
        }), s.forEach(t => {
            i.has(t) || o.push(t);
...
class Jr {
    constructor() {
        this.Dl = new Hr, this.Cl = {}, this.Vc = null, this.qu = null, this.Ps = null;
    }
    hl(t) {
        // No op.
    }
    ...
    start() {
        return this.Dl = new Hr, Promise.resolve();
    }
    Nh(t, e, n) {
        // No op.
    }
 ...
 */ class to {
    ...
    e) {
        ...
        this.Lt = mt(), this.kl = pn(t), this.xl = new Pt(this.kl);
    }
    /**
     ...
     */    Ol(t, e) {
        const n = e ? e.Ll : new Vt, s = e ? e.xl : this.xl;
        ...
        if (t.ot((t, e) => {
            ...
            // Calculate change
                ...
                u.data().isEqual(c.data()) ? l !== _ && (n.track({
                    type: 3 /* Metadata */ ,
                    doc: c
                }), f = !0) : this.Bl(u, c) || (n.track({
                    type: 2 /* Modified */ ,
                    doc: c
                }), f = !0, (h && this.kl(c, h) > 0 || a && this.kl(c, a) < 0) && (
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (t.type, e.type) || this.kl(t.doc, e.doc)), this.Ul(n);
        const r = e ? this.Ql() : [], o = 0 === this.$l.size && this.Ht ? 1 /* Synced */ : 0 /* Local */ , h = o !== this.Nl;
        if (this.Nl = o, 0 !== i.length || h) {
            return {
                snapshot: new gt(this.query, t.xl, s, i, t.Lt, 0 /* Local */ === o, h, 
                /* excludesMetadataChanges= */ !1),
                Wl: r
            };
        }
     ...
     */    Ul(t) {
        t && (t.Yt.forEach(t => this.Fl = this.Fl.add(t)), t.Jt.forEach(t => {}), t.Xt.forEach(t => this.Fl = this.Fl.delete(t)), 
        this.Ht = t.Ht);
    }
    Ql() {
        ...
        // updating many documents.
                const t = this.$l;
        this.$l = mt(), this.xl.forEach(t => {
            this.Kl(t.key) && (this.$l = this.$l.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.$l.has(t) || e.push(new Zr(t));
        }), this.$l.forEach(n => {
            t.has(n) || e.push(new Xr(n));
        }), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Gl(t) {
        this.Fl = t.Yh, this.$l = mt();
        const e = this.Ol(t.documents);
    ...
    // PORTING NOTE: Multi-tab only.
    zl() {
        return gt.Ut(this.query, this.xl, this.Lt, 0 /* Local */ === this.Nl);
    }
}
...
class eo {
    constructor(t, e, n, s) {
        this.Ro = t, this.Fu = e, this.updateFunction = n, this.yo = s, this.Hl = 5, this.xo = new Jn(this.Ro, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Yl() {
        this.xo.xs(async () => {
            const t = new Lr(this.Fu), e = this.Jl(t);
            e && e.then(e => {
                this.Ro.lr(() => t.commit().then(() => {
                    this.yo.resolve(e);
                }).catch(t => {
                    this.Xl(t);
                }));
    ...
    Jl(t) {
        try {
            ...
            return !j(e) && e.catch && e.then ? e : (this.yo.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
    ...
    Xl(t) {
        this.Hl > 0 && this.Zl(t) ? (this.Hl -= 1, this.Ro.lr(() => (this.Yl(), Promise.resolve()))) : this.yo.reject(t);
    }
    Zl(t) {
 ...
 */ class io {
    ...
    s, i, r) {
        this.Yu = t, this.e_ = e, this.Fu = n, this.n_ = s, this.currentUser = i, this.s_ = r, 
        this.i_ = null, this.r_ = new k(t => Vn(t), Pn), this.o_ = new Map, 
        /**
         ...
         */
        this.u_ = new Map, this.c_ = new yi, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.l_ = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.__ = new Map, this.f_ = Rs.di(), this.onlineState = "Unknown" /* Unknown */;
    }
    get d_() {
        return !0;
    }
    ...
    async listen(t) {
        ...
        e = s.targetId, this.n_.ll(e), n = s.view.zl(); else {
            const s = await this.Yu.Gh(t.We()), i = this.n_.ll(s.targetId);
            e = s.targetId, n = await this.T_(t, e, "current" === i), this.d_ && this.e_.listen(s);
        }
        return n;
    }
    /**
     ...
     * snapshot.
     */    async T_(t, e, n) {
        const s = await this.Yu.Hh(t, 
        /* usePreviousResults= */ !0), i = new to(t, s.Yh), r = i.Ol(s.documents), o = pt.zt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Jn(r, 
        /* updateLimboDocuments= */ this.d_, o);
        this.E_(e, h.Wl);
        const a = new no(t, e, i);
        return this.r_.set(t, a), this.o_.has(e) ? this.o_.get(e).push(t) : this.o_.set(e, [ t ]), 
        h.snapshot;
    }
    async Rc(t) {
        this.w_("unlisten()");
        const e = this.r_.get(t), n = this.o_.get(e.targetId);
        // Only clean up the query view and target if this is the only query mapped
        // to the target.
                if (n.length > 1) return this.o_.set(e.targetId, n.filter(e => !Pn(e, t))), 
        void this.r_.delete(t);
        // No other queries are mapped to the target, clean up the query and the target.
                if (this.d_) {
            // We need to remove the local query target first to allow us to verify
            // whether any other client is still interested in this target.
            this.n_.fl(e.targetId), this.n_.ol(e.targetId) || await this.Yu.zh(e.targetId, /*keepPersistedTargetData=*/ !1).then(() => {
                this.n_.wl(e.targetId), this.e_.Rc(e.targetId), this.I_(e.targetId);
            }).catch(gi);
        } else this.I_(e.targetId), await this.Yu.zh(e.targetId, 
        /*keepPersistedTargetData=*/ !0);
    }
    async write(t, e) {
        this.w_("write()");
        try {
            const n = await this.Yu.Mh(t);
            this.n_.hl(n.batchId), this.m_(n.batchId, e), await this.A_(n.Un), await this.e_.Ec();
        } catch (t) {
            // If we can't persist the mutation, we reject the user callback and
            // don't send the mutation. The user can then retry the write.
            const n = wi(t, "Failed to persist write");
            e.reject(n);
        }
    }
    runTransaction(t, e, n) {
        new eo(t, this.Fu, e, n).run();
    }
    async qh(t) {
        this.w_("applyRemoteEvent()");
        try {
            const e = await this.Yu.qh(t);
            // Update `receivedDocument` as appropriate for any limbo targets.
                        t.Qt.forEach((t, e) => {
                const n = this.u_.get(e);
                n && (
                // Since this is a limbo resolution lookup, it's for a single document
                // and it could be added, modified, or removed, but not a combination.
                V(t.Yt.size + t.Jt.size + t.Xt.size <= 1), t.Yt.size > 0 ? n.t_ = !0 : t.Jt.size > 0 ? V(n.t_) : t.Xt.size > 0 && (V(n.t_), 
                n.t_ = !1));
            }), await this.A_(e, t);
        } catch (t) {
            await gi(t);
    ...
    async vc(t, e) {
        this.w_("rejectListens()"), 
        // PORTING NOTE: Multi-tab only.
        this.n_.Tl(t, "rejected", e);
        const n = this.u_.get(t), s = n && n.key;
        if (s) {
            ...
            this.a_ = this.a_.remove(s), this.u_.delete(t), this.P_();
        } else await this.Yu.zh(t, /* keepPersistedTargetData */ !1).then(() => this.I_(t, e)).catch(gi);
    }
    async $c(t) {
        this.w_("applySuccessfulWrite()");
        const e = t.batch.batchId;
        try {
            const n = await this.Yu.Oh(t);
            // The local store may or may not be able to apply the write result and
            // raise events immediately (depending on whether the watcher is caught
            // up), so we raise user callbacks first so that they consistently happen
            // before listen events.
                        this.V_(e, /*error=*/ null), this.g_(e), this.n_.ul(e, "acknowledged"), 
            await this.A_(n);
        } catch (t) {
            await gi(t);
        }
    ...
    async xc(t, e) {
        this.w_("rejectFailedWrite()");
        try {
            const n = await this.Yu.Bh(t);
            // The local store may or may not be able to apply the write result and
            // raise events immediately (depending on whether the watcher is caught up),
            // so we raise user callbacks first so that they consistently happen before
            // listen events.
                        this.V_(t, e), this.g_(t), this.n_.ul(t, "rejected", e), await this.A_(n);
        } catch (e) {
            await gi(e);
        }
    }
    async y_(t) {
        this.e_.sc() || m("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        try {
            const e = await this.Yu.no();
            if (-1 === e) 
            // Trigger the callback right away if there is no pending writes at the moment.
            return void t.resolve();
            const n = this.__.get(e) || [];
            n.push(t), this.__.set(e, n);
        } catch (e) {
            const n = wi(e, "Initialization of waitForPendingWrites() operation failed");
            t.reject(n);
        }
    }
    /**
     ...
     * if there are any.
     */    g_(t) {
        (this.__.get(t) || []).forEach(t => {
            t.resolve();
        }), this.__.delete(t);
    }
    /** Reject all outstanding callbacks waiting for pending writes to complete. */    p_(t) {
        this.__.forEach(e => {
            e.forEach(e => {
    ...
    m_(t, e) {
        let n = this.l_[this.currentUser.Ma()];
        n || (n = new ht(b)), n = n.nt(t, e), this.l_[this.currentUser.Ma()] = n;
    }
    /**
     ...
     */    V_(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (n) {
            const s = n.get(t);
            s && (e ? s.reject(e) : s.resolve(), n = n.remove(t)), this.l_[this.currentUser.Ma()] = n;
        }
    }
    I_(t, e = null) {
        this.n_.fl(t);
        for (const n of this.o_.get(t)) this.r_.delete(n), e && this.i_.b_(n, e);
        if (this.o_.delete(t), this.d_) {
            this.c_.aa(t).forEach(t => {
                this.c_.Mi(t) || 
    ...
    E_(t, e) {
        for (const n of e) if (n instanceof Xr) this.c_.Fi(n.key, t), this.S_(n); else if (n instanceof Zr) {
            m("SyncEngine", "Document no longer in limbo: " + n.key), this.c_.$i(n.key, t), 
            this.c_.Mi(n.key) || 
            // We removed the last reference for this key
            this.v_(n.key);
        } else P();
    ...
    S_(t) {
        const e = t.key;
        this.a_.get(e) || (m("SyncEngine", "New document in limbo: " + e), this.h_.push(e), 
        this.P_());
    }
    /**
     ...
     */    P_() {
        for (;this.h_.length > 0 && this.a_.size < this.s_; ) {
            const t = this.h_.shift(), e = this.f_.next();
            this.u_.set(e, new so(t)), this.a_ = this.a_.nt(t, e), this.e_.listen(new et(Rn.hn(t.path).We(), e, 2 /* LimboResolution */ , Hn.ps));
        }
    }
    // Visible for testing
    D_() {
    ...
    async A_(t, e) {
        ...
        this.r_.forEach((r, o) => {
            i.push(Promise.resolve().then(() => {
                const e = o.view.Ol(t);
                return e.ql ? this.Yu.Hh(o.query, /* usePreviousResults= */ !1).then(({documents: t}) => o.view.Ol(t, e)) : e;
                // The query has a limit and some docs were removed, so we need
                // to re-run the query against the local store to make sure we
                // didn't lose any good docs that had been past the limit.
                        }).then(t => {
                const i = e && e.Qt.get(o.targetId), r = o.view.Jn(t, 
                /* updateLimboDocuments= */ this.d_, i);
                if (this.E_(o.targetId, r.Wl), r.snapshot) {
                    this.d_ && this.n_.Tl(o.targetId, r.snapshot.fromCache ? "not-current" : "current"), 
                    n.push(r.snapshot);
                    const t = zn.Rs(o.targetId, r.snapshot);
                    s.push(t);
                }
            }));
        }), await Promise.all(i), this.i_.mu(n), await this.Yu.Wh(s);
    }
    w_(t) {}
    async Oc(t) {
        if (!this.currentUser.isEqual(t)) {
            m("SyncEngine", "User change. New user:", t.Ma());
            const e = await this.Yu.Nh(t);
            this.currentUser = t, 
            // Fails tasks waiting for pending writes requested by previous user.
            this.p_("'waitForPendingWrites' promise is rejected due to a user change."), 
            // TODO(b/114226417): Consider calling this only in the primary tab.
            this.n_.Nh(t, e.kh, e.xh), await this.A_(e.$h);
        }
    }
    enableNetwork() {
    ...
    xe(t) {
        const e = this.u_.get(t);
        if (e && e.t_) return mt().add(e.key);
        {
            let e = mt();
            const n = this.o_.get(t);
            if (!n) return e;
            for (const t of n) {
                const n = this.r_.get(t);
                e = e.Ct(n.view.Ml);
            }
            return e;
        }
...
class ro extends io {
    ...
    enableNetwork() {
        return this.Yu.cr(!0), super.enableNetwork();
    }
    disableNetwork() {
        return this.Yu.cr(!1), super.disableNetwork();
    }
    /**
     * Reconcile the list of synced documents in an existing view with those
     * from persistence.
     */    async N_(t) {
        const e = await this.Yu.Hh(t.query, 
        /* usePreviousResults= */ !0), n = t.view.Gl(e);
        return this.F_ && this.E_(t.targetId, n.Wl), n;
    }
    jl(t, e) {
        // If we are the primary client, the online state of all clients only
        // depends on the online state of the local RemoteStore.
        this.d_ && 0 /* RemoteStore */ === e && (super.jl(t, e), this.n_.Il(t)), 
        // If we are the secondary client, we explicitly ignore the remote store's
        // online state (the local client may go offline, even though the primary
        // tab remains online) and only apply the primary tab's online state from
        // SharedClientState.
        this.d_ || 1 /* SharedClientState */ !== e || super.jl(t, e);
    }
    async bl(t, e, n) {
        this.w_("applyBatchState()");
        const s = await this.Yu.Xh(t);
        null !== s ? ("pending" === e ? 
        // If we are the primary client, we need to send this write to the
        // backend. Secondary clients will ignore these writes since their remote
        // connection is disabled.
        await this.e_.Ec() : "acknowledged" === e || "rejected" === e ? (
        // NOTE: Both these methods are no-ops for batches that originated from
        // other clients.
        this.V_(t, n || null), this.Yu.Zh(t)) : P(), await this.A_(s)) : 
    ...
    async Lc(t) {
        if (!0 === t && !0 !== this.F_) {
            ...
            const t = this.n_.il(), e = await this.k_(t.F(), 
            /*transitionToPrimary=*/ !0);
            this.F_ = !0, await this.e_.Lc(!0);
            for (const t of e) this.e_.listen(t);
        } else if (!1 === t && !1 !== this.F_) {
            const t = [];
            let e = Promise.resolve();
            this.o_.forEach((n, s) => {
                this.n_.dl(s) ? t.push(s) : e = e.then(() => (this.I_(s), this.Yu.zh(s, 
                /*keepPersistedTargetData=*/ !0))), this.e_.Rc(s);
            }), await e, await this.k_(t, 
            /*transitionToPrimary=*/ !1), this.x_(), this.F_ = !1, await this.e_.Lc(!1);
        }
    }
    x_() {
        this.u_.forEach((t, e) => {
            this.e_.Rc(e);
        }), this.c_.ua(), this.u_ = new Map, this.a_ = new ht(W.P);
    }
    /**
     ...
     */    async k_(t, e) {
        ...
        for (const e of t) {
            let t;
            const i = this.o_.get(e);
            if (i && 0 !== i.length) {
                // For queries that have a local View, we fetch their current state
                // from LocalStore (as the resume token and the snapshot version
                // might have changed) and reconcile their views with the persisted
                // state (the list of syncedDocuments may have gotten out of sync).
                t = await this.Yu.Gh(i[0].We());
                for (const t of i) {
                    const e = this.r_.get(t), n = await this.N_(e);
                    n.snapshot && s.push(n.snapshot);
                }
            } else {
                // For queries that never executed on this client, we need to
                // allocate the target in LocalStore and initialize a new View.
                const n = await this.Yu.ta(e);
                t = await this.Yu.Gh(n), await this.T_(this.M_(n), e, 
                /*current=*/ !1);
            }
            n.push(t);
        }
        return this.i_.mu(s), n;
    }
    /**
    ...
    async vl(t, e, n) {
        ...
        m("SyncEngine", "Ignoring unexpected query state notification."); else if (this.o_.has(t)) switch (e) {
          case "current":
          case "not-current":
            {
                const n = await this.Yu.si(), s = yt.Gt(t, "current" === e);
                await this.A_(n, s);
                break;
            }
          ...
          case "rejected":
            await this.Yu.zh(t, 
            /* keepPersistedTargetData */ !0), this.I_(t, n);
            break;
    ...
    async Sl(t, e) {
        if (this.F_) {
            for (const e of t) {
                ...
                const t = await this.Yu.ta(e), n = await this.Yu.Gh(t);
                await this.T_(this.M_(t), n.targetId, 
                /*current=*/ !1), this.e_.listen(n);
            }
            for (const t of e) 
            ...
            await this.Yu.zh(t, /* keepPersistedTargetData */ !1).then(() => {
                this.e_.Rc(t), this.I_(t);
            }).catch(gi);
        }
    }
}
 ...
 */ class ho {
    constructor(t) {
        this.Vc = t, this.L_ = new k(t => Vn(t), Pn), this.onlineState = "Unknown" /* Unknown */ , 
        this.B_ = new Set, this.Vc.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let n = !1, s = this.L_.get(e);
        if (s || (n = !0, s = new oo), n) try {
            s.O_ = await this.Vc.listen(e);
        } catch (e) {
            const n = wi(e, `Initialization of query '${gn(t.query)}' failed`);
            return void t.onError(n);
        }
        this.L_.set(e, s), s.listeners.push(t);
        // Run global snapshot listeners if a consistent snapshot has been emitted.
        t.jl(this.onlineState);
        if (s.O_) {
            t.q_(s.O_) && this.U_();
        }
    }
    async Rc(t) {
        const e = t.query;
        let n = !1;
        const s = this.L_.get(e);
        if (s) {
            const e = s.listeners.indexOf(t);
            e >= 0 && (s.listeners.splice(e, 1), n = 0 === s.listeners.length);
        }
        if (n) return this.L_.delete(e), this.Vc.Rc(e);
    }
    mu(t) {
        let e = !1;
        for (const n of t) {
            const t = n.query, s = this.L_.get(t);
            if (s) {
                for (const t of s.listeners) t.q_(n) && (e = !0);
                s.O_ = n;
            }
        }
        e && this.U_();
 ...
 */ class ao {
     ...
     */    q_(t) {
        ...
        let e = !1;
        return this.K_ ? this.z_(t) && (this.j_.next(t), e = !0) : this.H_(t, this.onlineState) && (this.Y_(t), 
        e = !0), this.G_ = t, e;
    }
    onError(t) {
        this.j_.error(t);
    }
    /** Returns whether a snapshot was raised. */    jl(t) {
        this.onlineState = t;
        let e = !1;
    ...
    z_(t) {
        ...
        const e = this.G_ && this.G_.hasPendingWrites !== t.hasPendingWrites;
    ...
    Y_(t) {
        t = gt.Ut(t.query, t.docs, t.Lt, t.fromCache), this.K_ = !0, this.j_.next(t);
    }
}
 ...
 */ class uo {
    ...
    _s(t, e, s, i) {
        ...
        return e.En() || s.isEqual(L.min()) ? this.Z_(t, e) : this.X_.us(t, i).next(r => {
            const o = this.tf(e, r);
            return (e.In() || e.mn()) && this.ql(e.nn, o, i, s) ? this.Z_(t, e) : (I() <= n.DEBUG && m("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), gn(e)), 
            this.X_._s(t, e, s).next(t => (
    ...
    /** Applies the query filter and sorting to the provided documents.  */    tf(t, e) {
 ...
 */ class co {
    ...
    Xr(t, e, n, s) {
        const i = this.ef;
        if (this.ef++, this.ns.length > 0) {
            this.ns[this.ns.length - 1];
        }
        const r = new qn(i, e, n, s);
        this.ns.push(r);
        // Track references by document key and index collection parents.
        for (const e of s) this.nf = this.nf.add(new pi(e.key, i)), this.ss.Us(t, e.key.path.p());
        return Qn.resolve(r);
    }
    Zr(t, e) {
        return Qn.resolve(this.sf(e));
    }
    eo(t, e) {
        const n = e + 1, s = this.if(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Qn.resolve(this.ns.length > i ? this.ns[i] : null);
    }
    no() {
        return Qn.resolve(0 === this.ns.length ? -1 : this.ef - 1);
    }
    so(t) {
    ...
    os(t, e) {
        ...
        return this.nf.vt([ n, s ], t => {
            const e = this.sf(t.la);
            i.push(e);
        }), Qn.resolve(i);
    }
    ls(t, e) {
    ...
    Es(t, e) {
        ...
        return this.nf.St(t => {
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === s && (o = o.add(t.la)), !0);
        }, r), Qn.resolve(this.rf(o));
    }
    rf(t) {
    ...
    ro(t, e) {
        V(0 === this.hf(e.batchId, "removed")), this.ns.shift();
        let n = this.nf;
    ...
    Mi(t, e) {
        const n = new pi(e, 0), s = this.nf.Dt(n);
 ...
 */ class lo {
     ...
     */    jn(t, e, n) {
        const s = e.key, i = this.docs.get(s), r = i ? i.size : 0, o = this.af(e);
...
class _o {
    constructor(t) {
         ...
         * IDs.
         */
        this._f = new yi, this.targetCount = 0, this.ff = Rs.fi();
    }
    pe(t, e) {
        return this.cf.forEach((t, n) => e(n)), Qn.resolve();
    }
    mi(t) {
        return Qn.resolve(this.lastRemoteSnapshotVersion);
    }
    Ai(t) {
        return Qn.resolve(this.lf);
    }
    Ti(t) {
        return this.highestTargetId = this.ff.next(), Qn.resolve(this.highestTargetId);
    }
    Ri(t, e, n) {
    ...
    Vi(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.ff = new Rs(e), this.highestTargetId = e), t.sequenceNumber > this.lf && (this.lf = t.sequenceNumber);
    }
    Pi(t, e) {
    ...
    vi(t, e, n) {
        let s = 0;
        const i = [];
        return this.cf.forEach((r, o) => {
            o.sequenceNumber <= e && null === n.get(o.targetId) && (this.cf.delete(r), i.push(this.bi(t, o.targetId)), 
            s++);
        }), Qn.Bn(i).next(() => s);
    }
    Si(t) {
    ...
    Di(t, e) {
        const n = this.cf.get(e) || null;
        return Qn.resolve(n);
    }
    Ci(t, e, n) {
        return this._f.ra(e, n), Qn.resolve();
    }
    Ni(t, e, n) {
        this._f.ha(e, n);
    ...
    bi(t, e) {
        return this._f.aa(e), Qn.resolve();
    }
    ki(t, e) {
        const n = this._f.ca(e);
        return Qn.resolve(n);
    }
    Mi(t, e) {
        return Qn.resolve(this._f.Mi(e));
    }
}
...
class fo {
     ...
     */
    constructor(t) {
        this.df = {}, this.Ui = new Hn(0), this.Qi = !1, this.Qi = !0, this.wi = t(this), 
        this.Xi = new _o(this);
        this.ss = new ns, this.es = new lo(this.ss, t => this.wi.wf(t));
    }
    start() {
        return Promise.resolve();
    }
    ...
    Cr(t) {
        let e = this.df[t.Ma()];
        return e || (e = new co(this.ss, this.wi), this.df[t.Ma()] = e), e;
    }
    Nr() {
        return this.Xi;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new wo(this.Ui.next());
        return this.wi.Tf(), n(s).next(t => this.wi.Ef(s).next(() => t)).On().then(t => (s.ts(), 
        t));
    }
    If(t, e) {
        return Qn.qn(Object.values(this.df).map(n => () => n.Mi(t, e)));
    }
}
...
class To {
    ...
    Fi(t, e, n) {
        return this.mf.Fi(n, e), this.Pf.delete(n), Qn.resolve();
    }
    $i(t, e, n) {
        return this.mf.$i(n, e), this.Pf.add(n), Qn.resolve();
    }
    Qr(t, e) {
        return this.Pf.add(e), Qn.resolve();
    }
    removeTarget(t, e) {
        this.mf.aa(e.targetId).forEach(t => this.Pf.add(t));
        const n = this.persistence.Nr();
        return n.ki(t, e.targetId).next(t => {
            t.forEach(t => this.Pf.add(t));
        }).next(() => n.pi(t, e));
    }
    Tf() {
        this.Af = new Set;
    ...
    Ef(t) {
        ...
        const e = this.persistence.$r().oi();
        return Qn.forEach(this.Pf, n => this.Vf(t, n).next(t => {
            t || e.Gn(n);
        })).next(() => (this.Af = null, e.apply(t)));
    }
    Gr(t, e) {
        return this.Vf(t, e).next(t => {
            t ? this.Pf.delete(e) : this.Pf.add(e);
        });
    }
    wf(t) {
    ...
    Vf(t, e) {
        return Qn.qn([ () => Qn.resolve(this.mf.Mi(e)), () => this.persistence.Nr().Mi(t, e), () => this.persistence.If(t, e) ]);
    }
}
...
class Ao {
     ...
     */    Nf(t, e) {
        if (e) for (const n in e.Ba) e.Ba.hasOwnProperty(n) && (t[n] = e.Ba[n]);
        t["X-Goog-Api-Client"] = mo;
    }
    Du(t, e, n) {
        const s = this.$f(t);
        return new Promise((i, r) => {
            ...
            this.Nf(u, n), o.send(s, "POST", a, u, 15);
        });
    }
    Cu(t, e, n) {
    ...
    Iu(t, e) {
        const s = [ this.Ff, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], c = f(), l = {
        ...
        this.Nf(l.initMessageHeaders, e), 
        ...
        // enough the code is exception free.
            ...
            A || (A = !0, m("Connection", "WebChannel transport closed"), P.Df());
            ...
            }("Connection", "WebChannel transport errored:", t), P.Df(new M(x.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!A) {
                ...
                if (i) {
                    ...
                    A = !0, P.Df(new M(e, n)), w.close();
                } else m("Connection", "WebChannel received:", n), P.Cf(n);
            }
        }), setTimeout(() => {
...
class Ro {
    constructor() {
        this.kf = () => this.xf(), this.Mf = () => this.Of(), this.Lf = [], this.Bf();
    }
    nc(t) {
        this.Lf.push(t);
    }
    ...
    xf() {
        ...
        for (const t of this.Lf) t(0 /* AVAILABLE */);
    }
    Of() {
        m("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (const t of this.Lf) t(1 /* UNAVAILABLE */);
    }
 ...
 * limitations under the License.
 */
const Vo = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.";
 ...
 */ class go {
    async initialize(t) {
        this.n_ = this.qf(t), this.persistence = this.Uf(t), await this.persistence.start(), 
        this.Qf = this.Wf(t), this.Yu = this.jf(t), this.e_ = this.Kf(t), this.Vc = this.Gf(t), 
        this.zf = this.Hf(t), this.n_.qu = t => this.Vc.jl(t, 1 /* SharedClientState */), 
        this.e_.Vc = this.Vc, await this.Yu.start(), await this.n_.start(), await this.e_.start(), 
        await this.e_.Lc(this.Vc.d_);
    }
    Hf(t) {
        return new ho(this.Vc);
    }
    Wf(t) {
        return null;
    }
    jf(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new uo, s = t.Yf, new Pi(e, n, s);
        var e, n, s;
    }
    Uf(t) {
        if (t.Xf.Jf) throw new M(x.FAILED_PRECONDITION, Vo);
        return new fo(To.Rf);
    }
    Kf(t) {
        return new qr(this.Yu, t.Fu, t.Ro, t => this.Vc.jl(t, 0 /* RemoteStore */), Ro.Hi() ? new Ro : new Po);
    }
    qf(t) {
        return new Jr;
    }
    Gf(t) {
        return e = this.Yu, n = this.e_, s = t.Fu, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        i = this.n_, r = t.Yf, o = t.s_, new io(e, n, s, i, r, o);
        var e, n, s, i, r, o;
    }
    clearPersistence(t) {
        throw new M(x.FAILED_PRECONDITION, Vo);
    }
}
 ...
 */ class yo extends go {
    async initialize(t) {
        ...
        await this.persistence.or(async t => {
            await this.Vc.Lc(t), this.Qf && (t && !this.Qf.hr ? this.Qf.start(this.Yu) : t || this.Qf.stop());
        });
    }
    jf(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new uo, s = t.Yf, new Vi(e, n, s);
        var e, n, s;
    }
    Gf(t) {
        const e = (n = this.Yu, s = this.e_, i = t.Fu, r = this.n_, o = t.Yf, h = t.s_, 
        new ro(n, s, i, r, o, h));
        var n, s, i, r, o, h;
        return this.n_ instanceof Yr && (this.n_.Vc = e), e;
    }
    Wf(t) {
        const e = this.persistence.wi.Or;
        return new Ai(e, t.Ro);
    }
    Uf(t) {
        const e = vs.Mr(t.Zf), n = ur(t.Zf.s);
        return new vs(t.Xf.synchronizeTabs, e, t.clientId, mi.ah(t.Xf.cacheSizeBytes), t.Ro, _i(), "undefined" != typeof document ? document : null, n, this.n_, t.Xf.qi);
    }
    qf(t) {
        if (t.Xf.Jf && t.Xf.synchronizeTabs) {
            const e = _i();
            if (!Yr.Hi(e)) throw new M(x.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            const n = vs.Mr(t.Zf);
            return new Yr(e, t.Ro, n, t.clientId, t.Yf);
        }
        return new Jr;
    }
    clearPersistence(t) {
        const e = vs.Mr(t);
        return vs.clearPersistence(e);
    }
}
...
class po {
     ...
     */
    e) {
        this.credentials = t, this.Ro = e, this.clientId = p.t();
    }
    /**
     ...
     */    start(t, e, n) {
        ...
        return this.credentials.Qa(t => {
            if (!r) return r = !0, m("FirestoreClient", "Initializing. user=", t.uid), this.td(e, n, t, i).then(s.resolve, s.reject);
            this.Ro.dr(() => this.e_.Oc(t));
        }), 
        // Block the async queue until initialization is done
        this.Ro.lr(() => s.promise), i.promise;
    }
    /** Enables the network connection and requeues all pending operations. */    enableNetwork() {
        return this.Su(), this.Ro.enqueue(() => this.Vc.enableNetwork());
    }
    /**
     ...
     */    async td(t, e, n, s) {
        try {
            ...
            // provider).
            const r = await (i = this.Zf, Promise.resolve(new Ao(i))), o = ur(this.Zf.s), h = function(t, e, n) {
                return new Or(t, e, n);
            ...
            await t.initialize({
                ...
                s_: 100,
                Xf: e
            }), this.persistence = t.persistence, this.n_ = t.n_, this.Yu = t.Yu, this.e_ = t.e_, 
            this.Vc = t.Vc, this.Qf = t.Qf, this.ed = t.zf, 
            // When a user calls clearPersistence() in one client, all other clients
            // need to be terminated to allow the delete to succeed.
            this.persistence.ar(async () => {
     ...
     */    Su() {
        if (this.Ro.Oo) throw new M(x.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Disables the network connection. Pending operations will not complete. */    disableNetwork() {
        return this.Su(), this.Ro.enqueue(() => this.Vc.disableNetwork());
    }
    terminate() {
        return this.Ro.Qo(async () => {
            // PORTING NOTE: LocalStore does not need an explicit shutdown on web.
            this.Qf && this.Qf.stop(), await this.e_.yr(), await this.n_.yr(), await this.persistence.yr(), 
     ...
     */    waitForPendingWrites() {
        this.Su();
        const t = new Yn;
        return this.Ro.lr(() => this.Vc.y_(t)), t.promise;
    }
    listen(t, e, n) {
        this.Su();
        const s = new ao(t, e, n);
        return this.Ro.lr(() => this.ed.listen(s)), s;
    }
    Rc(t) {
        // Checks for termination but does not raise error, allowing unlisten after
        // termination to be a no-op.
        this.sd || this.Ro.lr(() => this.ed.Rc(t));
    }
    async rd(t) {
        this.Su();
        const e = new Yn;
        return await this.Ro.enqueue(async () => {
            try {
                const n = await this.Yu.Kh(t);
                ...
                const s = wi(n, `Failed to get document '${t} from cache`);
                e.reject(s);
            }
        }), e.promise;
    }
    async od(t) {
        ...
        return await this.Ro.enqueue(async () => {
            try {
                const n = await this.Yu.Hh(t, 
                /* usePreviousResults= */ !0), s = new to(t, n.Yh), i = s.Ol(n.documents), r = s.Jn(i, 
                /* updateLimboDocuments= */ !1);
                e.resolve(r.snapshot);
            } catch (n) {
                const s = wi(n, `Failed to execute query '${t} against cache`);
                e.reject(s);
            }
        }), e.promise;
    }
    write(t) {
        this.Su();
        const e = new Yn;
        return this.Ro.lr(() => this.Vc.write(t, e)), e.promise;
    }
    s() {
        return this.Zf.s;
    }
    Q_(t) {
        this.Su(), this.Ro.lr(() => (this.ed.Q_(t), Promise.resolve()));
    }
    W_(t) {
        // Checks for shutdown but does not raise error, allowing remove after
        // shutdown to be a no-op.
        this.sd || this.Ro.lr(() => (this.ed.W_(t), Promise.resolve()));
    }
    get sd() {
    ...
    transaction(t) {
        this.Su();
        const e = new Yn;
        return this.Ro.lr(() => (this.Vc.runTransaction(this.Ro, t, e), Promise.resolve())), 
        e.promise;
    }
}
...
class So {
    constructor(t, e, n, s) {
        this.s = t, this.timestampsInSnapshots = e, this.ud = n, this.ld = s;
    }
    _d(t) {
        switch (Mt(t)) {
          case 0 /* NullValue */ :
    ...
    Td(t) {
        return new ar(jt(t.latitude), jt(t.longitude));
    }
    Ed(t) {
        return (t.values || []).map(t => this._d(t));
    }
    dd(t) {
        switch (this.ud) {
          case "previous":
...
class Co {
    constructor(t) {
        ...
        } else Ni("settings", "non-empty string", "host", t.host), this.host = t.host, $i("settings", "boolean", "ssl", t.ssl), 
        ...
        $i("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        $i("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), $i("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        $i("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = mi.dh; else {
            if (t.cacheSizeBytes !== Do && t.cacheSizeBytes < mi.fh) throw new M(x.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${mi.fh}`);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        $i("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
 ...
 */ class Fo {
    ...
    constructor(t, e, n = new go) {
        if (this.md = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Ad = new di, this.INTERNAL = {
            delete: async () => {
                // The client must be initalized to ensure that all subsequent API usage
                // throws an exception.
                this.Rd(), await this.Pd.terminate();
            }
        }, "object" == typeof t.options) {
            // This is very likely a Firebase app object
            // TODO(b/34177605): Can we somehow use instanceof?
            const n = t;
            this.md = n, this.ya = Fo.Vd(n), this.gd = n.name, this.yd = new Fr(e);
        } else {
            const e = t;
            if (!e.projectId) throw new M(x.INVALID_ARGUMENT, "Must provide projectId");
            this.ya = new C(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.gd = "[DEFAULT]", this.yd = new Cr;
        }
        this.pd = n, this.bd = new Co({});
    }
    get vd() {
        return this.Sd || (
        // Lazy initialize UserDataReader once the settings are frozen
        this.Sd = new Tr(this.ya, this.bd.ignoreUndefinedProperties)), this.Sd;
    }
    settings(t) {
        vi("Firestore.settings", arguments, 1), Ci("Firestore.settings", "object", 1, t);
        const e = new Co(t);
        if (this.Pd && !this.bd.isEqual(e)) throw new M(x.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */ (e.credentials));
    ...
    enablePersistence(t) {
        var e, n;
        if (this.Pd) throw new M(x.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let s = !1, i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.Pd && !this.Pd.sd) throw new M(x.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const t = new Yn;
        return this.Ad.Lo(async () => {
            try {
                const e = this.Fd();
                await this.pd.clearPersistence(e), t.resolve();
            } catch (e) {
                t.reject(e);
            }
        }), t.promise;
    ...
    onSnapshotsInSync(t) {
        if (this.Rd(), vo(t)) return No(this.Pd, t);
        {
            Ci("Firestore.onSnapshotsInSync", "function", 1, t);
            const e = {
                next: t
            };
            return No(this.Pd, e);
    ...
    Fd() {
        return new D(this.ya, this.gd, this.bd.host, this.bd.ssl, this.bd.forceLongPolling);
    }
    Cd(t, e) {
        const n = this.Fd();
        return this.Pd = new po(this.yd, this.Ad), this.Pd.start(n, t, e);
    }
    static Vd(t) {
 ...
 */        const s = t.options.projectId;
    ...
    get app() {
        if (!this.md) throw new M(x.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.md;
    }
    collection(t) {
        return vi("Firestore.collection", arguments, 1), Ci("Firestore.collection", "non-empty string", 1, t), 
        this.Rd(), new jo(q.$(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return vi("Firestore.doc", arguments, 1), Ci("Firestore.doc", "non-empty string", 1, t), 
        this.Rd(), xo.$d(q.$(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
        if (vi("Firestore.collectionGroup", arguments, 1), Ci("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.Rd(), new Uo(new Rn(q.k(), t), this, 
        /* converter= */ null);
    }
    runTransaction(t) {
        return vi("Firestore.runTransaction", arguments, 1), Ci("Firestore.runTransaction", "function", 1, t), 
        this.Rd().transaction(e => t(new $o(this, e)));
    }
    batch() {
        return this.Rd(), new ko(this);
    }
    static get logLevel() {
        switch (I()) {
          case n.DEBUG:
    ...
    static setLogLevel(t) {
        var e;
        vi("Firestore.setLogLevel", arguments, 1), Mi("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, E.setLogLevel(e);
    }
...
/** Registers the listener for onSnapshotsInSync() */ function No(t, e) {
    const n = new bo({
        next: () => {
            e.next && e.next();
        },
 ...
 */ class $o {
    ...
    get(t) {
        vi("Transaction.get", arguments, 1);
        const e = Ho("Transaction.get", t, this.xd);
        return this.Md.Mu([ e.pa ]).then(t => {
            if (!t || 1 !== t.length) return P();
            const n = t[0];
            if (n instanceof mn) return new Lo(this.xd, e.pa, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.ba);
            if (n instanceof In) return new Lo(this.xd, e.pa, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.ba);
            throw P();
        });
    ...
    set(t, e, n) {
        ...
        const s = Ho("Transaction.set", t, this.xd);
        n = Ko("Transaction.set", n);
        const i = Jo(s.ba, e, n), r = Er(this.xd.vd, "Transaction.set", s.pa, i, null !== s.ba, n);
        return this.Md.set(s.pa, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof Ji ? (Si("Transaction.update", arguments, 3), 
        i = Ho("Transaction.update", t, this.xd), r = mr(this.xd.vd, "Transaction.update", i.pa, e, n, s)) : (vi("Transaction.update", arguments, 2), 
        i = Ho("Transaction.update", t, this.xd), r = Ir(this.xd.vd, "Transaction.update", i.pa, e)), 
        this.Md.update(i.pa, r), this;
    }
    delete(t) {
        vi("Transaction.delete", arguments, 1);
        const e = Ho("Transaction.delete", t, this.xd);
...
class ko {
    ...
    set(t, e, n) {
        Di("WriteBatch.set", arguments, 2, 3), this.Bd();
        const s = Ho("WriteBatch.set", t, this.xd);
        n = Ko("WriteBatch.set", n);
        const i = Jo(s.ba, e, n), r = Er(this.xd.vd, "WriteBatch.set", s.pa, i, null !== s.ba, n);
        return this.Od = this.Od.concat(r.va(s.pa, Je.Qe())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.Bd(), "string" == typeof e || e instanceof Ji ? (Si("WriteBatch.update", arguments, 3), 
        i = Ho("WriteBatch.update", t, this.xd), r = mr(this.xd.vd, "WriteBatch.update", i.pa, e, n, s)) : (vi("WriteBatch.update", arguments, 2), 
        i = Ho("WriteBatch.update", t, this.xd), r = Ir(this.xd.vd, "WriteBatch.update", i.pa, e)), 
        this.Od = this.Od.concat(r.va(i.pa, Je.exists(!0))), this;
    }
    delete(t) {
        vi("WriteBatch.delete", arguments, 1), this.Bd();
        const e = Ho("WriteBatch.delete", t, this.xd);
        return this.Od = this.Od.concat(new _n(e.pa, Je.Qe())), this;
    }
    commit() {
        return this.Bd(), this.Ld = !0, this.Od.length > 0 ? this.xd.Rd().write(this.Od) : Promise.resolve();
    }
    Bd() {
        if (this.Ld) throw new M(x.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class xo extends lr {
    constructor(t, e, n) {
        super(e.ya, t, n), this.pa = t, this.firestore = e, this.ba = n, this.Pd = this.firestore.Rd();
    }
    static $d(t, e, n) {
        ...
        return new xo(new W(t), e, n);
    }
    get id() {
        return this.pa.path.S();
    }
    get parent() {
        return new jo(this.pa.path.p(), this.firestore, this.ba);
    }
    get path() {
        return this.pa.path.N();
    }
    collection(t) {
        if (vi("DocumentReference.collection", arguments, 1), Ci("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new M(x.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        const e = q.$(t);
        return new jo(this.pa.path.child(e), this.firestore, 
        /* converter= */ null);
    }
    isEqual(t) {
        if (!(t instanceof xo)) throw Qi("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.pa.isEqual(t.pa) && this.ba === t.ba;
    }
    set(t, e) {
        Di("DocumentReference.set", arguments, 1, 2), e = Ko("DocumentReference.set", e);
        const n = Jo(this.ba, t, e), s = Er(this.firestore.vd, "DocumentReference.set", this.pa, n, null !== this.ba, e);
        return this.Pd.write(s.va(this.pa, Je.Qe()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof Ji ? (Si("DocumentReference.update", arguments, 2), 
        s = mr(this.firestore.vd, "DocumentReference.update", this.pa, t, e, n)) : (vi("DocumentReference.update", arguments, 1), 
        s = Ir(this.firestore.vd, "DocumentReference.update", this.pa, t)), this.Pd.write(s.va(this.pa, Je.exists(!0)));
    }
    delete() {
        return vi("DocumentReference.delete", arguments, 0), this.Pd.write([ new _n(this.pa, Je.Qe()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        ...
        "object" != typeof t[r] || vo(t[r]) || (i = t[r], Ui("DocumentReference.onSnapshot", i, [ "includeMetadataChanges" ]), 
        $i("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++);
        const o = {
        ...
        } else Ci("DocumentReference.onSnapshot", "function", r, t[r]), Fi("DocumentReference.onSnapshot", "function", r + 1, t[r + 1]), 
        Fi("DocumentReference.onSnapshot", "function", r + 2, t[r + 2]);
        const h = {
            next: e => {
                t[r] && t[r](this.qd(e));
            },
        ...
        return Mo(this.Pd, this.pa, o, h);
    }
    get(t) {
        return Di("DocumentReference.get", arguments, 0, 1), zo("DocumentReference.get", t), 
        t && "cache" === t.source ? this.firestore.Rd().rd(this.pa).then(t => new Lo(this.firestore, this.pa, t, 
        /*fromCache=*/ !0, t instanceof In && t.Ge, this.ba)) : 
        /**
 * Retrieves a latency-compensated document from the backend via a
 * SnapshotListener.
 */
        function(t, e, n) {
            const s = new Yn, i = Mo(t, e, {
            ...
            return s.promise;
        }(this.Pd, this.pa, t).then(t => this.qd(t));
    }
    withConverter(t) {
        return new xo(this.pa, this.firestore, t);
    }
    /**
     * Converts a ViewSnapshot that contains the current document to a
     * DocumentSnapshot.
     */    qd(t) {
        const e = t.docs.get(this.pa);
        return new Lo(this.firestore, this.pa, e, t.fromCache, t.hasPendingWrites, this.ba);
    }
}

/** Registers an internal snapshot listener for `ref`. */ function Mo(t, e, n, s) {
    let i = t => {
...
class Lo {
    constructor(t, e, n, s, i, r) {
        this.xd = t, this.pa = e, this.Ud = n, this.Qd = s, this.Wd = i, this.ba = r;
    }
    data(t) {
        if (Di("DocumentSnapshot.data", arguments, 0, 1), t = Go("DocumentSnapshot.data", t), 
        this.Ud) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.ba) {
                const e = new Bo(this.xd, this.pa, this.Ud, this.Qd, this.Wd, 
                /* converter= */ null);
                return this.ba.fromFirestore(e, t);
            }
            return new So(this.xd.ya, this.xd.kd(), t.serverTimestamps || "none", t => new xo(t, this.xd, /* converter= */ null))._d(this.Ud.tn());
        }
    }
    get(t, e) {
        if (Di("DocumentSnapshot.get", arguments, 1, 2), e = Go("DocumentSnapshot.get", e), 
        this.Ud) {
            const n = this.Ud.data().field(yr("DocumentSnapshot.get", t, this.pa));
            if (null !== n) {
                return new So(this.xd.ya, this.xd.kd(), e.serverTimestamps || "none", t => new xo(t, this.xd, this.ba))._d(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new xo(this.pa, this.xd, this.ba);
    }
    get exists() {
        return null !== this.Ud;
    }
    get metadata() {
        return new Oo(this.Wd, this.Qd);
    }
    isEqual(t) {
        if (!(t instanceof Lo)) throw Qi("isEqual", "DocumentSnapshot", 1, t);
        return this.xd === t.xd && this.Qd === t.Qd && this.pa.isEqual(t.pa) && (null === this.Ud ? null === t.Ud : this.Ud.isEqual(t.Ud)) && this.ba === t.ba;
    }
}
...
/** The query class that is shared between the full, lite and legacy SDK. */ function qo(t) {
...
class Uo extends class {
    ...
    Kd(t, e, n) {
        ...
        if (t.O()) {
            ...
            if ("in" /* IN */ === e) {
                this.Gd(n, e);
                const t = [];
                for (const e of n) t.push(this.zd(e));
                s = {
                    arrayValue: {
                        values: t
                    }
        ...
        s = Ar(this.vd, "Query.where", n, "in" /* IN */ === e);
        const i = bn.create(t, e, s);
        return this.Hd(i), i;
    }
    Yd(t, e) {
        if (null !== this.jd.startAt) throw new M(x.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.jd.endAt) throw new M(x.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        const n = new On(t, e);
        return this.Jd(n), n;
    }
    /**
     ...
     */    Xd(t, e, n) {
        ...
        // results.
                for (const t of this.jd.orderBy) if (t.field.O()) s.push(Gt(this.ya, e.key)); else {
     ...
     */    Zd(t, e, n) {
        ...
        for (let n = 0; n < e.length; n++) {
            ...
            if (s[n].field.O()) {
                ...
                if (!this.jd.Vn() && -1 !== r.indexOf("/")) throw new M(x.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), " + `the value passed to ${t}() must be a plain document ID, but ` + `'${r}' contains a slash.`);
                const e = this.jd.path.child(q.$(r));
     ...
     */    zd(t) {
        if ("string" == typeof t) {
            ...
            if (!this.jd.Vn() && -1 !== t.indexOf("/")) throw new M(x.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but " + `'${t}' contains a '/' character.`);
            const e = this.jd.path.child(q.$(t));
            ...
            return Gt(this.ya, new W(e));
        }
        if (t instanceof lr) return Gt(this.ya, t.pa);
        throw new M(x.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + `${Bi(t)}.`);
    }
    /**
    ...
    Hd(t) {
        if (t instanceof bn) {
            ...
            if (t.An()) {
                ...
                const n = this.jd.un();
                null !== n && this.tw(t.field, n);
            } else if (i || s) {
                // You can have at most 1 disjunctive filter and 1 array filter. Check if
                // the new filter conflicts with an existing one.
                let r = null;
                if (i && (r = this.jd.Rn(n)), null === r && s && (r = this.jd.Rn(e)), null !== r) 
    ...
    constructor(t, e, n) {
        super(e.ya, e.vd, t), this.jd = t, this.firestore = e, this.ba = n;
    }
    where(t, e, n) {
        vi("Query.where", arguments, 3), qi("Query.where", 3, n);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        const s = Mi("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), i = yr("Query.where", t), r = this.Kd(i, s, n);
        return new Uo(this.jd.cn(r), this.firestore, this.ba);
    }
    orderBy(t, e) {
        let n;
        if (Di("Query.orderBy", arguments, 1, 2), Fi("Query.orderBy", "non-empty string", 2, e), 
        ...
        const s = yr("Query.orderBy", t), i = this.Yd(s, n);
        return new Uo(this.jd.ln(i), this.firestore, this.ba);
    }
    limit(t) {
        return vi("Query.limit", arguments, 1), Ci("Query.limit", "number", 1, t), Wi("Query.limit", 1, t), 
        new Uo(this.jd._n(t), this.firestore, this.ba);
    }
    limitToLast(t) {
        return vi("Query.limitToLast", arguments, 1), Ci("Query.limitToLast", "number", 1, t), 
        Wi("Query.limitToLast", 1, t), new Uo(this.jd.fn(t), this.firestore, this.ba);
    }
    startAt(t, ...e) {
        Si("Query.startAt", arguments, 1);
        const n = this.ew("Query.startAt", t, e, 
        /*before=*/ !0);
        return new Uo(this.jd.dn(n), this.firestore, this.ba);
    }
    startAfter(t, ...e) {
        Si("Query.startAfter", arguments, 1);
        const n = this.ew("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new Uo(this.jd.dn(n), this.firestore, this.ba);
    }
    endBefore(t, ...e) {
        Si("Query.endBefore", arguments, 1);
        const n = this.ew("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new Uo(this.jd.wn(n), this.firestore, this.ba);
    }
    endAt(t, ...e) {
        Si("Query.endAt", arguments, 1);
        const n = this.ew("Query.endAt", t, e, 
        /*before=*/ !1);
        return new Uo(this.jd.wn(n), this.firestore, this.ba);
    }
    isEqual(t) {
        if (!(t instanceof Uo)) throw Qi("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && Pn(this.jd, t.jd) && this.ba === t.ba;
    }
    withConverter(t) {
        return new Uo(this.jd, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    ew(t, e, n, s) {
        if (qi(t, 1, e), e instanceof Lo) return vi(t, [ e, ...n ], 1), this.Xd(t, e.Ud, s);
        {
            const i = [ e ].concat(n);
            return this.Zd(t, i, s);
        }
    }
    onSnapshot(...t) {
        var e, n, s;
        ...
        let i = {}, r = 0;
        if ("object" != typeof t[r] || vo(t[r]) || (i = t[r], Ui("Query.onSnapshot", i, [ "includeMetadataChanges" ]), 
        $i("Query.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++), vo(t[r])) {
            const i = t[r];
            t[r] = null === (e = i.next) || void 0 === e ? void 0 : e.bind(i), t[r + 1] = null === (n = i.error) || void 0 === n ? void 0 : n.bind(i), 
            t[r + 2] = null === (s = i.complete) || void 0 === s ? void 0 : s.bind(i);
        } else Ci("Query.onSnapshot", "function", r, t[r]), Fi("Query.onSnapshot", "function", r + 1, t[r + 1]), 
        Fi("Query.onSnapshot", "function", r + 2, t[r + 2]);
        const o = {
            next: e => {
                t[r] && t[r](new Wo(this.firestore, this.jd, e, this.ba));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
        return qo(this.jd), Qo(this.firestore.Rd(), this.jd, i, o);
    }
    get(t) {
        Di("Query.get", arguments, 0, 1), zo("Query.get", t), qo(this.jd);
        const e = this.firestore.Rd();
        return (t && "cache" === t.source ? e.od(this.jd) : 
        /**
 ...
 */
        ...
        /** Registers an internal snapshot listener for `query`. */ (e, this.jd, t)).then(t => new Wo(this.firestore, this.jd, t, this.ba));
    }
}
...
class Wo {
    constructor(t, e, n, s) {
        this.xd = t, this.nw = e, this.sw = n, this.ba = s, this.iw = null, this.rw = null, 
        this.metadata = new Oo(n.hasPendingWrites, n.fromCache);
    }
    get docs() {
        const t = [];
    ...
    forEach(t, e) {
        Di("QuerySnapshot.forEach", arguments, 1, 2), Ci("QuerySnapshot.forEach", "function", 1, t), 
        this.sw.docs.forEach(n => {
            t.call(e, this.ow(n, this.metadata.fromCache, this.sw.Lt.has(n.key)));
        });
    }
    get query() {
        return new Uo(this.nw, this.xd, this.ba);
    }
    docChanges(t) {
        t && (Ui("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), $i("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        const e = !(!t || !t.includeMetadataChanges);
        if (e && this.sw.qt) throw new M(x.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof Wo)) throw Qi("isEqual", "QuerySnapshot", 1, t);
        return this.xd === t.xd && Pn(this.nw, t.nw) && this.sw.isEqual(t.sw) && this.ba === t.ba;
    }
    ow(t, e, n) {
        return new Bo(this.xd, t.key, t, e, n, this.ba);
    }
}

class jo extends Uo {
    constructor(t, e, n) {
        if (super(Rn.hn(t), e, n), this.hw = t, t.length % 2 != 1) throw new M(x.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + `${t.N()} has ${t.length}`);
    }
    get id() {
        return this.jd.path.S();
    }
    get parent() {
        const t = this.jd.path.p();
        return t._() ? null : new xo(new W(t), this.firestore, 
        /* converter= */ null);
    }
    get path() {
    ...
    doc(t) {
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = p.t()), Ci("CollectionReference.doc", "non-empty string", 1, t);
        const e = q.$(t);
        return xo.$d(this.jd.path.child(e), this.firestore, this.ba);
    }
    add(t) {
        vi("CollectionReference.add", arguments, 1), Ci("CollectionReference.add", "object", 1, this.ba ? this.ba.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new jo(this.hw, this.firestore, t);
    }
}
...
function Ko(t, e) {
    ...
    if (Ui(t, e, [ "merge", "mergeFields" ]), $i(t, "boolean", "merge", e.merge), ki(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof Ji), 
...
function Go(t, e) {
    return void 0 === e ? {} : (Ui(t, e, [ "serverTimestamps" ]), xi(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function zo(t, e) {
    Fi(t, "object", 1, e), e && (Ui(t, e, [ "source" ]), xi(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
const Xo = {
    ...
    Transaction: $o,
    WriteBatch: ko,
    DocumentReference: xo,
    DocumentSnapshot: Lo,
    Query: Uo,
    QueryDocumentSnapshot: Bo,
    QuerySnapshot: Wo,
    CollectionReference: jo,
    FieldPath: Ji,
    FieldValue: or,
    setLogLevel: Fo.setLogLevel,
    CACHE_SIZE_UNLIMITED: Do
};
...
function Zo(t) {
    ...
    }(t, (t, e) => new Fo(t, e, new yo)), t.registerVersion("@firebase/firestore", "1.16.0");
}
