...
/** A dot-separated path for navigating sub-objects within a document. */ class U extends M {
    V(t, e, n) {
        return new U(t, e, n);
    }
    /**
...
function z(t) {
    ...
    if (null === e.G) {
        ...
        t += pn(e.startAt)), e.endAt && (t += "|ub:", t += pn(e.endAt)), e.G = t;
    }
    return e.G;
}
...
function H(t) {
    ...
    W(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map(t => {
        return `${(e = t).field.$()} (${e.dir})`;
        var e;
    }).join(", ")}]`), t.startAt && (e += ", startAt: " + pn(t.startAt)), t.endAt && (e += ", endAt: " + pn(t.endAt)), 
    `Target(${e})`;
}
...
function Y(t, e) {
    ...
    for (let n = 0; n < t.orderBy.length; n++) if (!Cn(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (let i = 0; i < t.filters.length; i++) if (n = t.filters[i], s = e.filters[i], 
    !(n instanceof En && s instanceof En && n.op === s.op && n.field.isEqual(s.field) && Ot(n.value, s.value))) return !1;
    var n, s;
...
function rt(t) {
    ...
    return A("GRPC error has no .code"), k.UNKNOWN;
    switch (t) {
      case nt.OK:
        return k.OK;
 ...
 */ class Rt {
    ...
    constructor(t) {
        ...
        this.$t = wt(), this.Nt = new ot(this.P);
    }
    /**
...
class Vt {
    ...
    isEqual(t) {
        if (!(this.fromCache === t.fromCache && this.qt === t.qt && this.Mt.isEqual(t.Mt) && _n(this.query, t.query) && this.docs.isEqual(t.docs) && this.Lt.isEqual(t.Lt))) return !1;
 ...
 */ class yt {
    ...
    static Kt(t, e) {
        const n = new Map;
        return n.set(t, pt.zt(t, e)), new yt(L.min(), n, At(), _t(), mt());
    }
}
...
class Ct {
     ...
     */    $e(t) {
        ...
        this.me.forEach((n, s) => {
            ...
            if (i) {
                if (n.Ht && X(i.target)) {
                    ...
                    null !== this.Ie.get(e) || this.Ne(s, e) || this.ye(s, e, new un(e, t));
                }
        ...
        const s = new yt(t, e, this.Re, this.Ie, n);
        return this.Ie = _t(), this.Ae = Dt(), this.Re = new ut(v), s;
    }
    /**
    ...
    ke(t) {
        let e = this.Ae.get(t);
        return e || (e = new ut(v), this.Ae = this.Ae.nt(t, e)), e;
    }
    /**
     ...
     * from all documents).
     */    Se(t) {
        this.me.set(t, new St), this.Ee.xe(t).forEach(e => {
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ot(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return b(t.arrayValue.values || [], e.arrayValue.values || [], Ot);
...
function Mt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = v(Wt(t.latitude), Wt(e.latitude));
            if (0 !== n) return n;
            return v(Wt(t.longitude), Wt(e.longitude));
...
function qt(t, e) {
    ...
    const n = Qt(t), s = Qt(e), i = v(n.seconds, s.seconds);
...
function ce(t, e) {
    ...
    new Q((V((s = n).length > 4 && "documents" === s.get(4)), s.p(5)));
    var s;
...
function _e(t) {
    return new q([ "projects", t.s.projectId, "databases", t.s.database ]).$();
}
...
function we(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.Le ? (V(void 0 === e || "string" == typeof e), Z.fromBase64String(e || "")) : (V(void 0 === e || e instanceof Uint8Array), 
...
function Ie(t, e) {
    ...
    const i = function(t) {
        ...
        const e = t.map(t => t instanceof En ? 
        // visible for testing
        function(t) {
            if ("==" /* EQUAL */ === t.op) {
 ...
 */ (n, e) : t instanceof Ce ? De(t, e) : t instanceof Fe ? $e(t, e) : function(t, e) {
 ...
 */ function ve(t, e, n) {
    ...
    // applications.
    return t instanceof Ce ? De(t, e) : t instanceof Fe ? $e(t, e) : n;
}
 ...
 */ function be(t, e) {
    return t instanceof Ne ? Kt(n = e) || function(t) {
...
function Me(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Ce && e instanceof Ce || t instanceof Fe && e instanceof Fe ? b(t.elements, e.elements, Ot) : t instanceof Ne && e instanceof Ne ? Ot(t.qe, e.qe) : t instanceof Se && e instanceof Se;
 ...
 */ function We(t, e, n) {
    return t instanceof He ? function(t, e, n) {
        ...
        if (V(null != n.transformResults), !Ue(t.Ue, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
...
function Ke(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.Ue.isEqual(e.Ue) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Me.isEqual(e.Me) : 2 /* Transform */ !== t.type || b(t.fieldTransforms, t.fieldTransforms, (t, e) => Me(t, e)))));
}
...
/** A mutation that deletes the document at the given key. */ class en extends Qe {
    constructor(t, e) {
 ...
 */ class ln {
    ...
    get orderBy() {
        if (null === this.nn) {
            ...
            t.L() || this.nn.push(new bn(t)), this.nn.push(new bn(U.M(), "asc" /* ASCENDING */)); else {
                let t = !1;
    ...
    un(t) {
        ...
        return new ln(this.path, this.collectionGroup, this.tn.slice(), e, this.limit, this.en, this.startAt, this.endAt);
    }
    cn(t) {
        // TODO(dimond): validate that orderBy does not list the same key twice.
        const e = this.tn.concat([ t ]);
        return new ln(this.path, this.collectionGroup, e, this.filters.slice(), this.limit, this.en, this.startAt, this.endAt);
    }
    ln(t) {
        return new ln(this.path, this.collectionGroup, this.tn.slice(), this.filters.slice(), t, "F" /* First */ , this.startAt, this.endAt);
    }
    _n(t) {
        return new ln(this.path, this.collectionGroup, this.tn.slice(), this.filters.slice(), t, "L" /* Last */ , this.startAt, this.endAt);
    }
    fn(t) {
        return new ln(this.path, this.collectionGroup, this.tn.slice(), this.filters.slice(), this.limit, this.en, t, this.endAt);
    }
    dn(t) {
        return new ln(this.path, this.collectionGroup, this.tn.slice(), this.filters.slice(), this.limit, this.en, this.startAt, t);
    }
    /**
    ...
    hn() {
        for (const t of this.filters) if (t instanceof En && t.In()) return t.field;
        return null;
    }
    // Checks if any of the provided Operators are included in the query and
    // returns the first one that is, or null if none are.
    An(t) {
        for (const e of this.filters) if (e instanceof En && t.indexOf(e.op) >= 0) return e.op;
        return null;
    }
    Rn() {
        return X(this.Pn());
     ...
     * representation.
     */    Pn() {
        if (!this.sn) if ("F" /* First */ === this.en) this.sn = K(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            // Flip the orderBy directions since we want the last results
            const t = [];
            for (const e of this.orderBy) {
                const n = "desc" /* DESCENDING */ === e.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
                t.push(new bn(e.field, n));
            }
            // We need to swap the cursors to match the now-flipped query ordering.
                        const e = this.endAt ? new yn(this.endAt.position, !this.endAt.before) : null, n = this.startAt ? new yn(this.startAt.position, !this.startAt.before) : null;
            // Now return as a LimitType.First query.
            this.sn = K(this.path, this.collectionGroup, t, this.filters, this.limit, e, n);
        }
        return this.sn;
    }
    rn(t) {}
...
function fn(t) {
    return `${z(t.Pn())}|lt:${t.en}`;
}

function dn(t) {
    return `Query(target=${H(t.Pn())}; limitType=${t.en})`;
}

/** Returns whether `doc` matches the constraints of `query`. */ function wn(t, e) {
    return function(t, e) {
        const n = e.key.path;
        return null !== t.collectionGroup ? e.key.U(t.collectionGroup) && t.path.C(n) : Q.W(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }
    /**
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !gn(t.startAt, t.orderBy, e)) return !1;
        if (t.endAt && gn(t.endAt, t.orderBy, e)) return !1;
        return !0;
    }
    /**
...
class En extends class {} {
     ...
     */    static create(t, e, n) {
        if (t.L()) return "in" /* IN */ === e ? new An(t, n) : new In(t, e, n);
        if (Ht(n)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Rn(t, n) : "in" /* IN */ === e ? new Pn(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Vn(t, n) : new En(t, e, n);
    }
    matches(t) {
        const e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && xt(this.value) === xt(e) && this.yn(Mt(e, this.value));
    }
    yn(t) {
        switch (this.op) {
          case "<" /* LESS_THAN */ :
...
/** Filter that matches on key fields within an array. */ class An extends En {
    constructor(t, e) {
...
/** A Filter that implements the array-contains operator. */ class Rn extends En {
    constructor(t, e) {
...
/** A Filter that implements the IN operator. */ class Pn extends En {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the array-contains-any operator. */ class Vn extends En {
    constructor(t, e) {
 ...
 */ function gn(t, e, n) {
    ...
    for (let i = 0; i < t.position.length; i++) {
        ...
        if (r.field.L()) s = Q.P(Q.B(o.referenceValue), n.key); else {
...
function Sn(t, e, n) {
    const s = t.field.L() ? Q.P(e.key, n.key) : function(t, e, n) {
...
class Dn {
     ...
     */    bn(t, e) {
        ...
        for (const n of this.baseMutations) n.key.isEqual(t) && (e = je(n, e, e, this.pn));
        const n = e;
        // Second, apply all user-provided mutations.
                for (const s of this.mutations) s.key.isEqual(t) && (e = je(s, e, n, this.pn));
        return e;
    }
    /**
...
/** The result of applying a mutation batch to the backend. */ class Fn {
    constructor(t, e, n, 
    /**
 ...
 */ class $n {
    ...
    next(t, e) {
        return this.kn && P(), this.kn = !0, this.Nn ? this.error ? this.xn(e, this.error) : this.On(t, this.result) : new $n((n, s) => {
            this.Fn = e => {
    ...
    On(t, e) {
        return t ? this.Mn(() => t(e)) : $n.resolve(e);
    }
    xn(t, e) {
        return t ? this.Mn(() => t(e)) : $n.reject(e);
    }
    static resolve(t) {
        return new $n((e, n) => {
            e(t);
     ...
     */    static Bn(t) {
        let e = $n.resolve(!1);
        for (const n of t) e = e.next(t => t ? $n.resolve(t) : n());
        return e;
    }
    static forEach(t, e) {
        const n = [];
...
class Nn {
    ...
    ts(t, e) {
        ...
        return this.jn(t, new Q(e)).next(t => {
            let e = wt();
    ...
    es(t, e, n) {
        ...
        let i = wt();
        return this.Wn.ss(t, s).next(r => $n.forEach(r, r => {
    ...
    ns(t, e, n) {
        ...
        this.os(t, i, s).next(t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                const n = e.key, i = s.get(n), r = je(e, i, i, t.pn);
 ...
 */ class kn {
 ...
 // do nothing
        ...
        return new kn(t, e.fromCache, n, s);
    }
}
...
class Ln {
     ...
     */    ys(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && I("ExponentialBackoff", `Backing off for ${s} ms ` + `(base delay: ${this.As} ms, ` + `delay with jitter: ${e} ms, ` + `last attempt: ${n} ms ago)`), 
 ...
 */ class Mn {
    ...
    Cs(t, e) {
        return this.Ss.add(e), $n.resolve();
    }
    ss(t, e) {
        return $n.resolve(this.Ss.getEntries(e));
    }
}
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function Qn() {
...
class Wn {
    constructor(t, e, n, s, i) {
        this.Ns = t, this.Ts = e, this.ks = n, this.op = s, this.xs = i, this.Os = new On, 
     ...
     */    static Ls(t, e, n, s, i) {
        const r = Date.now() + n, o = new Wn(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
     ...
     */    cancel(t) {
        null !== this.Ms && (this.clearTimeout(), this.Os.reject(new x(k.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    qs() {
...
class jn {
    constructor() {
        ...
        this.Hs = new Ln(this, "async_queue_retry" /* AsyncQueueRetry */), 
 ...
 // Failure will be handled by AsyncQueue
    ...
    ti(t) {
        const e = this.Us.then(() => (this.Ks = !0, t().catch(t => {
            ...
            throw this.Gs = t, this.Ks = !1, A("INTERNAL UNHANDLED ERROR: ", 
            /**
 ...
 */ (t)), t;
     ...
     */    gs(t, e, n) {
        ...
        const s = Wn.Ls(this, t, e, n, t => this.ri(t));
 ...
 */ function Gn(t, e) {
    if (A("AsyncQueue", `${e}: ${t}`), Un(t)) return new x(k.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
...
class Kn {
    ...
    static di(t) {
        return new Kn(t, Kn.wi, Kn.Ti);
    }
}

Kn.Ei = -1, Kn.mi = 1048576, Kn.Ii = 41943040, Kn.wi = 10, Kn.Ti = 1e3, Kn.Ai = new Kn(Kn.Ii, Kn.wi, Kn.Ti), 
Kn.Ri = new Kn(Kn.Ei, 0, 0);
...
class zn {
    ...
    t, e, n) {
        ...
        this.yi = new N(t => z(t), Y), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.pi = L.min(), this.Qn = t.gi(n), this.vi = t.bi(), this.Si = t.Ci(), this.Di = new Nn(this.vi, this.Qn, this.persistence.Fi()), 
        this.Pi.$i(this.Di);
    }
    start() {
    ...
    async Ni(t) {
        ...
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            ...
            // MutationQueue.
            n = new Nn(this.vi, e, this.persistence.Fi()), e.ki(s))).next(t => {
                const e = [], r = [];
    ...
    Mi(t) {
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", i => this.Di.Yn(i, n).next(n => {
            ...
            for (const e of t) {
                ...
                // exists=true
                r.push(new Ye(e.key, t, on(t.proto.mapValue), Be.exists(!0)));
            }
    ...
    Ki(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let n;
            return this.Qn.zi(e, t).next(t => (V(null !== t), n = t.keys(), this.Qn.Hi(e, t))).next(() => this.Qn.Gi(e)).next(() => this.Di.Yn(e, n));
        });
    }
    Yi() {
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Qt.forEach((t, i) => {
                ...
                // Update the resume token if the change includes one.
                    ...
                    zn.nr(o, a, t) && r.push(this.Si.sr(s, a));
                }
            });
            let o = _t(), h = mt();
            ...
            r.push(i.getEntries(s, h).next(n => {
                t.jt.forEach((h, a) => {
                    ...
                    // cache.
                                        a instanceof un && a.version.isEqual(L.min()) ? (
            ...
            return $n.qn(r).next(() => i.apply(s)).next(() => this.Di.Xn(s, o));
        }).then(t => (this.Vi = n, t));
    }
    /**
    ...
    async cr(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => $n.forEach(t, t => $n.forEach(t.hs, n => this.persistence.hr.lr(e, t.targetId, n)).next(() => $n.forEach(t.as, n => this.persistence.hr._r(e, t.targetId, n)))));
        } catch (t) {
            if (!Un(t)) throw t;
    ...
    Er(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            ...
            n = s, $n.resolve(n)) : this.Si.Ir(e).next(s => (n = new tt(t, s, 0 /* Listen */ , e.er), 
    ...
    mr(t, e) {
        ...
        return void 0 !== n ? $n.resolve(this.Vi.get(n)) : this.Si.mr(t, e);
    }
    Rr(t, e) {
        const n = this.Vi.get(t), s = e ? "readwrite" : "readwrite-primary";
        return this.persistence.runTransaction("Release target", s, t => e ? $n.resolve() : this.persistence.hr.removeTarget(t, n)).then(() => {
    ...
    Pr(t, e) {
        ...
        }).next(() => this.Pi.Zn(i, t, e ? n : L.min(), e ? s : mt())).next(t => ({
            documents: t,
            yr: s
        })));
    }
    ji(t, e, n) {
        ...
        return i.forEach(i => {
            r = r.next(() => n.zn(t, i)).next(t => {
                let r = t;
                const o = e.Dn.get(i);
                V(null !== o), (!r || r.version.o(o) < 0) && (r = s.gn(i, r, e), r && 
...
class Yn {
    constructor() {
        ...
        this.vr = new ut(Xn.br), 
        // A set of outstanding references to a document sorted by target id.
        this.Sr = new ut(Xn.Cr);
    }
     ...
     * removed.
     */    Nr(t) {
        const e = new Q(new q([])), n = new Xn(e, t), s = new Xn(e, t + 1), i = [];
    ...
    xr(t) {
        const e = new Q(new q([])), n = new Xn(e, t), s = new Xn(e, t + 1);
        let i = mt();
        return this.Sr.bt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    Or(t) {
        const e = new Xn(t, 0), n = this.vr.Ct(e);
...
class Xn {
    ...
    /** Compare by key then by ID */    static br(t, e) {
        return Q.P(t.key, e.key) || v(t.Lr, e.Lr);
    }
    /** Compare by ID then by key */    static Cr(t, e) {
        return v(t.Lr, e.Lr) || Q.P(t.key, e.key);
    }
}
 ...
 */ function Jn(t, e) {
    if (0 !== e.length) throw new x(k.INVALID_ARGUMENT, `Function ${t}() does not support arguments, ` + "but was called with " + Es(e.length, "argument") + ".");
}
 ...
 */ function Zn(t, e, n) {
    if (e.length !== n) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires ` + Es(n, "argument") + ", but was called with " + Es(e.length, "argument") + ".");
}
 ...
 */ function ts(t, e, n) {
    if (e.length < n) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires at least ` + Es(n, "argument") + ", but was called with " + Es(e.length, "argument") + ".");
}
 ...
 */ function es(t, e, n, s) {
    if (e.length < n || e.length > s) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires between ${n} and ` + `${s} arguments, but was called with ` + Es(e.length, "argument") + ".");
}
...
function os(t, e, n, s, i) {
    void 0 !== s && function(t, e, n, s, i) {
        if (!(s instanceof Array)) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${e} ` + `option to be an array, but it was: ${ls(s)}`);
        for (let r = 0; r < s.length; ++r) if (!i(s[r])) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires all ${e} ` + `elements to be ${n}, but the value at index ${r} ` + `was: ${ls(s[r])}`);
    }(t, e, n, s, i);
}
 ...
 */ function as(t, e, n, s) {
    if (!e.some(t => t === s)) throw new x(k.INVALID_ARGUMENT, `Invalid value ${ls(s)} provided to function ` + `${t}() for its ${Ts(n)} argument. Acceptable ` + `values: ${e.join(", ")}`);
    return s;
}

/** Helper to validate the type of a provided input. */ function us(t, e, n, s) {
    let i = !1;
    if (i = "object" === e ? cs(s) : "non-empty string" === e ? "string" == typeof s && "" !== s : typeof s === e, 
    !i) {
        const i = ls(s);
...
function _s(t, e, n) {
    if (void 0 === n) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires a valid ${Ts(e)} ` + "argument, but it was undefined.");
}
 ...
 */ function ds(t, e, n, s) {
    const i = ls(s);
    return new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${Ts(n)} ` + `argument to be a ${e}, but it was: ${i}`);
}

function ws(t, e, n) {
    if (n <= 0) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${Ts(e)} argument to be a positive number, but it was: ${n}.`);
}
 ...
 */ class Is {
    ...
    static fromBase64String(t) {
        Zn("Blob.fromBase64String", arguments, 1), ns("Blob.fromBase64String", "string", 1, t);
        try {
            return new Is(Z.fromBase64String(t));
        } catch (t) {
            throw new x(k.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }
    static fromUint8Array(t) {
        if (Zn("Blob.fromUint8Array", arguments, 1), ms(), !(t instanceof Uint8Array)) throw ds("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new Is(Z.fromUint8Array(t));
    }
    toBase64() {
        return Zn("Blob.toBase64", arguments, 0), this.Mr.toBase64();
    }
    toUint8Array() {
        return Zn("Blob.toUint8Array", arguments, 0), ms(), this.Mr.toUint8Array();
    }
    toString() {
 ...
 */ class As {
    constructor(t) {
        !function(t, e, n, s) {
            if (!(e instanceof Array) || e.length < s) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${n} argument to be an ` + "array with at least " + `${Es(s, "element")}.`);
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (ns("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new x(k.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.qr = new U(t);
    }
}
 ...
 */ class Rs extends As {
    ...
    isEqual(t) {
        if (!(t instanceof Rs)) throw ds("isEqual", "FieldPath", 1, t);
...
class vs extends Vs {
    ...
    Qr(t) {
        const e = ps(this, t, 
        /*array=*/ !0), n = this.zr.map(t => js(t, e)), s = new Ce(n);
...
class bs extends Vs {
    ...
    Qr(t) {
        const e = ps(this, t, 
        /*array=*/ !0), n = this.zr.map(t => js(t, e)), s = new Fe(n);
        return new Le(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Ss extends Vs {
    ...
    Qr(t) {
        const e = new Ne(t.serializer, se(t.serializer, this.Hr));
...
/** The public FieldValue class of the lite API. */ class Cs extends Vs {
    constructor() {
        super();
    }
    static delete() {
        return Jn("FieldValue.delete", arguments), new Ds(new ys("FieldValue.delete"));
    }
    static serverTimestamp() {
        return Jn("FieldValue.serverTimestamp", arguments), new Ds(new gs("FieldValue.serverTimestamp"));
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return ts("FieldValue.arrayUnion", arguments, 1), new Ds(new vs("FieldValue.arrayUnion", t));
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return ts("FieldValue.arrayRemove", arguments, 1), new Ds(new bs("FieldValue.arrayRemove", t));
    }
    static increment(t) {
        return ns("FieldValue.increment", "number", 1, t), Zn("FieldValue.increment", arguments, 1), 
 ...
 */ class Ds extends Cs {
    ...
    isEqual(t) {
        return t instanceof Ds && this.Br.isEqual(t.Br);
    }
}
 ...
 */ class Fs {
    constructor(t, e) {
        if (Zn("GeoPoint", arguments, 2), ns("GeoPoint", "number", 1, t), ns("GeoPoint", "number", 2, e), 
     ...
     * with an underscore.
     */    T(t) {
        return v(this.Yr, t.Yr) || v(this.Xr, t.Xr);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class xs {
    constructor(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ class Ms {
    ...
    /** Returns a new context with the specified settings overwritten. */    so(t) {
        return new Ms(Object.assign(Object.assign({}, this.settings), t), this.s, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.Me);
    }
    io(t) {
        var e;
    ...
    jr(t) {
        return Xs(t, this.settings.methodName, this.settings.ao || !1, this.path, this.settings.Gr);
    }
    ...
    ro(t) {
        ...
        if (Ls(this.Wr) && Ns.test(t)) throw this.jr('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class qs {
    constructor(t, e, n) {
        this.s = t, this.ignoreUndefinedProperties = e, this.serializer = n || $s(t);
    }
...
/** Parse document data from a set() call. */ function Bs(t, e, n, s, i, r = {}) {
    const o = t.uo(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    zs("Data must be an object, but it was:", o, s);
    const h = Gs(s, o);
    let a, u;
    if (r.merge) a = new Oe(o.Me), u = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        for (const s of r.mergeFields) {
            let i;
            if (s instanceof As) i = s.qr; else {
        ...
        a = new Oe(t), u = o.fieldTransforms.filter(t => a.We(t.field));
    } else a = null, u = o.fieldTransforms;
    return new xs(new sn(h), a, u);
}

/** Parse update data from an update() call. */ function Us(t, e, n, s) {
    const i = t.uo(1 /* Update */ , e, n);
    zs("Data must be an object, but it was:", i, s);
    const r = [], o = new rn;
    F(s, (t, s) => {
        const h = Ys(e, t, n), a = i.oo(h);
        if (s instanceof Vs && s.Br instanceof ys) 
    ...
    const h = new Oe(r);
    return new Os(o.Ke(), h, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Qs(t, e, n, s, i, r) {
    const o = t.uo(1 /* Update */ , e, n), h = [ Hs(e, s, n) ], a = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) h.push(Hs(e, r[t])), a.push(r[t + 1]);
    const u = [], c = new rn;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = h.length - 1; t >= 0; --t) if (!Js(u, h[t])) {
        const e = h[t], n = a[t], s = o.oo(e);
        if (n instanceof Vs && n.Br instanceof ys) 
        // Add it to the field mask, but don't add anything to updateData.
        u.push(e); else {
            const t = js(n, s);
    ...
    const l = new Oe(u);
    return new Os(c.Ke(), l, o.fieldTransforms);
}
 ...
 */ function Ws(t, e, n, s = !1) {
    return js(n, t.uo(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function js(t, e) {
    if (Ks(t)) return zs("Unsupported field value:", e, t), Gs(t, e);
    if (t instanceof Vs) 
 ...
 */
    return function(t, e) {
        ...
        if (!Ls(e.Wr)) throw e.jr(`${t.Ur}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.jr(`Unsupported field value: ${ls(t)}`);
    }
    /**
...
function Ks(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof O || t instanceof Fs || t instanceof Is || t instanceof ks || t instanceof Vs);
}
 ...
 */ function Hs(t, e, n) {
    if (e instanceof As) return e.qr;
    if ("string" == typeof e) return Ys(t, e);
    throw Xs("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function Ys(t, e, n) {
    try {
        return function(t) {
            if (t.search(Ps) >= 0) throw new x(k.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not contain ` + "'~', '*', '/', '[', or ']'");
            try {
        ...
        throw Xs((s = e) instanceof Error ? s.message : s.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
...
Zs._o = new Zs("google-credentials-uid"), Zs.fo = new Zs("first-party-uid");
...
class ni {
    constructor(t) {
        ...
        this.currentUser = Zs.UNAUTHENTICATED, this.Ao = !1, 
        /**
 ...
 */ class si {
    constructor(t, e) {
        this.Vo = t, this.yo = e, this.type = "FirstParty", this.user = Zs.fo;
    }
    get do() {
        const t = {
 ...
 */ class ii {
    ...
    getToken() {
        return Promise.resolve(new si(this.Vo, this.yo));
    }
    Eo(t) {
...
class ri {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.Co = 0, this.Do = null, this.stream = null, this.Hs = new Ln(t, e);
    }
    /**
     ...
     */    Uo(t) {
        return e => {
            this.ws.Bs(() => this.Co === t ? e() : (I("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class hi extends ri {
    ...
    onMessage(t) {
        ...
        V(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Xo) {
        ...
        return V(!t.writeResults || 0 === t.writeResults.length), this.Xo = !0, this.listener.eh();
    }
    /**
...
class ai extends class {
    ...
    ih() {
        if (this.sh) throw new x(k.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    rh(t, e) {
        return this.ih(), this.credentials.getToken().then(n => this.bo.rh(t, e, n)).catch(t => {
            throw t.code === k.UNAUTHENTICATED && this.credentials.To(), t;
        });
    }
...
class ui {
    ...
    async fh(t) {
        if (this.dh(), this.mutations.length > 0) throw new x(k.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = y(t), s = {
                database: _e(n.serializer),
        ...
        return e.forEach(t => {
            t instanceof un || t instanceof an ? this.wh(t) : P();
        }), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new en(t, this.Ue(t)) ]), this._h.add(t);
    }
    async commit() {
        ...
        t.forEach((t, e) => {
            const n = new Q(q.N(e));
            this.mutations.push(new nn(n, this.Ue(n)));
     ...
     */    Ue(t) {
        ...
        return !this._h.has(t) && e ? Be.updateTime(e) : Be.je();
    }
    /**
...
class ci {
    ...
    Vh(t) {
        ...
        this.Ah ? (A(e), this.Ah = !1) : I("OnlineStateTracker", e);
    }
    ph() {
...
class li {
    ...
    e, n, s, i) {
        ...
        this.Ch = new Set, this.Dh = i, this.Dh.Fh(t => {
            n.Bs(async () => {
                this.$h() && (I("RemoteStore", "Restarting streams for network reachability change."), 
                await this.Nh());
            });
        }), this.kh = new ci(n, s), 
        ...
        this.xh = function(t, e, n) {
            ...
            const s = y(t);
            return new hi(e, s.bo, s.credentials, s.serializer, n);
        }(this.hh, n, {
    ...
    async zh() {
        await this.qh.stop(), await this.xh.stop(), this.vh.length > 0 && (I("RemoteStore", `Stopping write stream with ${this.vh.length} pending writes`), 
        this.vh = []), this.Hh();
    }
    async Yh() {
        I("RemoteStore", "RemoteStore shutting down."), this.Ch.add(5 /* Shutdown */), await this.zh(), 
        this.Dh.Yh(), 
    ...
    Gh() {
        this.Sh = new Ct(this), this.xh.start(), this.kh.Rh();
    }
    /**
    ...
    async Mh(t, e) {
        ...
        this.kh.set("Online" /* Online */), t instanceof bt && 2 /* Removed */ === t.state && t.cause) 
        ...
        try {
            ...
            await this.na(e);
        } else if (t instanceof gt ? this.Sh.Pe(t) : t instanceof vt ? this.Sh.Ce(t) : this.Sh.pe(t), 
        !e.isEqual(L.min())) try {
            ...
            I("RemoteStore", "Failed to raise snapshot:", t), await this.na(t);
        }
    }
    /**
     ...
     */    async na(t, e) {
        ...
        this.Ns.si(async () => {
            I("RemoteStore", "Retrying IndexedDB access"), await e(), this.Ch.delete(1 /* IndexedDbFailed */), 
            await this.Wh();
        });
    }
    /**
    ...
    async th(t, e) {
        const n = this.vh.shift(), s = Fn.from(n, t, e);
 ...
 */ class fi {
    constructor() {
        this.Aa = new _i, this.Ra = {}, this.ta = null, this.Eh = null, this.cs = null;
    }
    Pa(t) {
        // No op.
    }
    ...
    start() {
        return this.Aa = new _i, Promise.resolve();
    }
    Ni(t, e, n) {
        // No op.
    }
 ...
 */ class Ti {
    ...
    e) {
        ...
        this.Mt = mt(), this.ka = Tn(t), this.xa = new Rt(this.ka);
    }
    /**
     ...
     */    La(t, e) {
        const n = e ? e.Ma : new Pt, s = e ? e.xa : this.xa;
 ...
 */ (t.type, e.type) || this.ka(t.doc, e.doc)), this.Qa(n);
        ...
        if (this.$a = o, 0 !== i.length || h) {
            return {
                snapshot: new Vt(this.query, t.xa, s, i, t.Mt, 0 /* Local */ === o, h, 
                /* excludesMetadataChanges= */ !1),
                ja: r
            };
        }
    ...
    Wa() {
        ...
        // updating many documents.
                const t = this.Na;
        this.Na = mt(), this.xa.forEach(t => {
            this.Ka(t.key) && (this.Na = this.Na.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.Na.has(t) || e.push(new wi(t));
        }), this.Na.forEach(n => {
            t.has(n) || e.push(new di(n));
        }), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Ha() {
        return Vt.Ut(this.query, this.xa, this.Mt, 0 /* Local */ === this.$a);
    }
}
...
class Ei {
    constructor(t, e, n, s) {
        this.Ns = t, this.hh = e, this.updateFunction = n, this.Os = s, this.Ya = 5, this.Hs = new Ln(this.Ns, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Xa() {
        this.Hs.ys(async () => {
            const t = new ui(this.hh), e = this.Ja(t);
            e && e.then(e => {
    ...
    Ja(t) {
        try {
            ...
            return !W(e) && e.catch && e.then ? e : (this.Os.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
/** Tracks a limbo resolution. */ class Ii {
    constructor(t) {
        this.key = t, 
        /**
 ...
 */ class Ai {
    ...
    s, i, r) {
        ...
        this.ru = null, this.ou = new N(t => fn(t), _n), this.hu = new Map, 
        /**
         ...
         */
        this.cu = new Map, this.lu = new Yn, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this._u = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.fu = new Map, this.du = Bn.$s(), this.onlineState = "Unknown" /* Unknown */;
    }
    get wu() {
        return !0;
    }
     ...
     */    async Eu(t, e, n) {
        ...
        /* usePreviousResults= */ !0), i = new Ti(t, s.yr), r = i.La(s.documents), o = pt.zt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Ua(r, 
        /* updateLimboDocuments= */ this.wu, o);
        this.mu(e, h.ja);
        const a = new mi(t, e, i);
    ...
    async Jh(t) {
        ...
        // to the target.
                if (n.length > 1) return this.hu.set(e.targetId, n.filter(e => !_n(e, t))), 
    ...
    async write(t, e) {
        ...
        try {
            ...
            const n = Gn(t, "Failed to persist write");
            e.reject(n);
        }
    }
    runTransaction(t, e, n) {
        new Ei(t, this.hh, e, n).run();
    }
    async Ji(t) {
        ...
        try {
            ...
            // Update `receivedDocument` as appropriate for any limbo targets.
                ...
                V(t.Yt.size + t.Xt.size + t.Jt.size <= 1), t.Yt.size > 0 ? n.eu = !0 : t.Xt.size > 0 ? V(n.eu) : t.Jt.size > 0 && (V(n.eu), 
                n.eu = !1));
            }), await this.Ru(e, t);
        } catch (t) {
            await Hn(t);
    ...
    async ra(t, e) {
        ...
        } else await this.gh.Rr(t, /* keepPersistedTargetData */ !1).then(() => this.Iu(t, e)).catch(Hn);
    }
    async la(t) {
    ...
    async gu(t) {
        ...
        try {
            ...
            const n = Gn(e, "Initialization of waitForPendingWrites() operation failed");
            t.reject(n);
        }
    }
    /**
    ...
    Au(t, e) {
        ...
        n || (n = new ot(v)), n = n.nt(t, e), this._u[this.currentUser.lo()] = n;
    }
    /**
    ...
    mu(t, e) {
        for (const n of e) if (n instanceof di) this.lu.lr(n.key, t), this.Cu(n); else if (n instanceof wi) {
            I("SyncEngine", "Document no longer in limbo: " + n.key), this.lu._r(n.key, t), 
            this.lu.Or(n.key) || 
            // We removed the last reference for this key
            this.Su(n.key);
        } else P();
     ...
     */    Vu() {
        for (;this.au.length > 0 && this.uu.size < this.iu; ) {
            ...
            this.cu.set(e, new Ii(t)), this.uu = this.uu.nt(t, e), this.nu.listen(new tt(ln.on(t.path).Pn(), e, 2 /* LimboResolution */ , xn.ds));
        }
    }
    // Visible for testing
    Du() {
        ...
        this.ou.forEach((r, o) => {
            i.push(Promise.resolve().then(() => {
                ...
                if (this.mu(o.targetId, r.ja), r.snapshot) {
                    ...
                    n.push(r.snapshot);
                    const t = kn.us(o.targetId, r.snapshot);
                    s.push(t);
                }
            }));
    ...
    async wa(t) {
        if (!this.currentUser.isEqual(t)) {
            I("SyncEngine", "User change. New user:", t.lo());
 ...
 */ class Pi {
    constructor(t) {
        this.ta = t, this.Nu = new N(t => fn(t), _n), this.onlineState = "Unknown" /* Unknown */ , 
        this.ku = new Set, this.ta.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let n = !1, s = this.Nu.get(e);
        if (s || (n = !0, s = new Ri), n) try {
            s.$u = await this.ta.listen(e);
        } catch (e) {
            const n = Gn(e, `Initialization of query '${dn(t.query)}' failed`);
 ...
 */ class Vi {
     ...
     */    xu(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Vt(t.query, t.docs, t.Lt, e, t.Mt, t.fromCache, t.qt, 
    ...
    ju(t) {
        t = Vt.Ut(t.query, t.docs, t.Mt, t.fromCache), this.Bu = !0, this.qu.next(t);
    }
}
 ...
 */ class yi {
    ...
    Zn(t, e, s, i) {
        ...
        return e.Tn() || s.isEqual(L.min()) ? this.zu(t, e) : this.Ku.Yn(t, i).next(r => {
            const o = this.Hu(e, r);
            return (e.En() || e.mn()) && this.Ba(e.en, o, i, s) ? this.zu(t, e) : (m() <= n.DEBUG && I("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), dn(e)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */    Hu(t, e) {
        ...
        let n = new ut(Tn(t));
        return e.forEach((e, s) => {
            s instanceof an && wn(t, s) && (n = n.add(s));
        }), n;
    }
    /**
    ...
    zu(t, e) {
        return m() <= n.DEBUG && I("IndexFreeQueryEngine", "Using full collection scan to execute query:", dn(e)), 
        this.Ku.Zn(t, e, L.min());
    }
}
 ...
 */ class pi {
    constructor(t, e) {
        ...
        this.Xu = new ut(Xn.br);
    }
    Ju(t) {
        return $n.resolve(0 === this.Qn.length);
    }
    qi(t, e, n, s) {
        const i = this.Yu;
        ...
        const r = new Dn(i, e, n, s);
        this.Qn.push(r);
        // Track references by document key and index collection parents.
        for (const e of s) this.Xu = this.Xu.add(new Xn(e.key, i)), this.Wn.Cs(t, e.key.path.g());
        return $n.resolve(r);
    }
    zi(t, e) {
        return $n.resolve(this.Zu(e));
    }
    wr(t, e) {
        const n = e + 1, s = this.tc(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return $n.resolve(this.Qn.length > i ? this.Qn[i] : null);
    }
    Yi() {
        return $n.resolve(0 === this.Qn.length ? -1 : this.Yu - 1);
    }
    ki(t) {
        return $n.resolve(this.Qn.slice());
    }
    Gn(t, e) {
        const n = new Xn(e, 0), s = new Xn(e, Number.POSITIVE_INFINITY), i = [];
    ...
    Jn(t, e) {
        let n = new ut(v);
        return e.forEach(t => {
            const e = new Xn(t, 0), s = new Xn(t, Number.POSITIVE_INFINITY);
            this.Xu.bt([ e, s ], t => {
                n = n.add(t.Lr);
            });
        }), $n.resolve(this.ec(n));
    ...
    Hi(t, e) {
        V(0 === this.nc(e.batchId, "removed")), this.Qn.shift();
        let n = this.Xu;
        return $n.forEach(e.mutations, s => {
            const i = new Xn(s.key, e.batchId);
    ...
    Or(t, e) {
        const n = new Xn(e, 0), s = this.Xu.Ct(n);
        return $n.resolve(e.isEqual(s && s.key));
    }
    Gi(t) {
        return this.Qn.length, $n.resolve();
    }
    /**
 ...
 */ class gi {
    ...
    Zn(t, e, n) {
        ...
        for (;r.wt(); ) {
            ...
            o.o(n) <= 0 || i instanceof an && wn(e, i) && (s = s.nt(i.key, i));
        }
        return $n.resolve(s);
    }
    hc(t, e) {
        return $n.forEach(this.docs, t => e(t));
    }
    Qi(t) {
 ...
 */ gi.ac = class extends class {
    constructor() {
        // A mapping of document key to the new cache entry that should be written (or null if any
        // existing cache entry should be removed).
        this.Bi = new N(t => t.toString(), (t, e) => t.isEqual(e)), this.cc = !1;
    }
    set readTime(t) {
        this.lc = t;
    }
     ...
     */    zn(t, e) {
        ...
        return void 0 !== n ? $n.resolve(n) : this.fc(t, e);
    }
    /**
...
class vi {
    constructor(t) {
         ...
         * IDs.
         */
        this.mc = new Yn, this.targetCount = 0, this.Ic = Bn.Fs();
    }
    ge(t, e) {
        return this.Tc.forEach((t, n) => e(n)), $n.resolve();
    }
    Xi(t) {
        return $n.resolve(this.lastRemoteSnapshotVersion);
    }
    Ac(t) {
        return $n.resolve(this.Ec);
    }
    Ir(t) {
        return this.highestTargetId = this.Ic.next(), $n.resolve(this.highestTargetId);
    }
    ar(t, e, n) {
    ...
    Rc(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.Ic = new Bn(e), this.highestTargetId = e), t.sequenceNumber > this.Ec && (this.Ec = t.sequenceNumber);
    }
    Ar(t, e) {
        return this.Rc(e), this.targetCount += 1, $n.resolve();
    }
    sr(t, e) {
        return this.Rc(e), $n.resolve();
    }
    Pc(t, e) {
    ...
    tr(t, e, n) {
        return this.mc.Dr(e, n), $n.resolve();
    }
    Zi(t, e, n) {
        this.mc.$r(e, n);
...
class bi {
     ...
     */
    constructor(t) {
        this.gc = {}, this.vc = new xn(0), this.bc = !1, this.bc = !0, this.hr = t(this), 
        this.Si = new vi(this);
        this.Wn = new Mn, this.Un = new gi(this.Wn, t => this.hr.Sc(t));
    }
    start() {
        return Promise.resolve();
    }
    ...
    gi(t) {
        let e = this.gc[t.lo()];
        return e || (e = new pi(this.Wn, this.hr), this.gc[t.lo()] = e), e;
    }
    Ci() {
        return this.Si;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new Si(this.vc.next());
        return this.hr.Fc(), n(s).next(t => this.hr.$c(s).next(() => t)).Ln().then(t => (s.Nc(), 
        t));
    }
    kc(t, e) {
        return $n.Bn(Object.values(this.gc).map(n => () => n.Or(t, e)));
    }
}
...
class Ci {
    ...
    lr(t, e, n) {
        return this.Lc.lr(n, e), this.Bc.delete(n), $n.resolve();
    }
    _r(t, e, n) {
        return this.Lc._r(n, e), this.Bc.add(n), $n.resolve();
    }
    sc(t, e) {
        return this.Bc.add(e), $n.resolve();
    }
    removeTarget(t, e) {
    ...
    $c(t) {
        ...
        return $n.forEach(this.Bc, n => this.Uc(t, n).next(t => {
            t || e.ir(n);
    ...
    Uc(t, e) {
        return $n.Bn([ () => $n.resolve(this.Lc.Or(e)), () => this.persistence.Ci().Or(t, e), () => this.persistence.kc(t, e) ]);
    }
}
...
class Ni {
    ...
    rh(t, e, n) {
        ...
        return new Promise((i, r) => {
            ...
            o.listenOnce(l.COMPLETE, () => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case _.TIMEOUT:
                        I("Connection", 'RPC "' + t + '" timed out'), r(new x(k.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case _.HTTP_ERROR:
                        ...
                        I("Connection", 'RPC "' + t + '" failed'), r(new x(k.UNAVAILABLE, "Connection failed."));
                        break;
            ...
            this.Jc(u, n), o.send(s, "POST", a, u, 15);
        });
    }
    oh(t, e, n) {
    ...
    Ko(t, e) {
        const s = [ this.Xc, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], c = f(), l = {
        ...
        const _ = s.join("");
        I("Connection", "Creating WebChannel: " + _ + " " + l);
        ...
        // on a closed stream
                const P = new Di({
            Qc: t => {
                A ? I("Connection", "Not sending because WebChannel is closed:", t) : (m || (I("Connection", "Opening WebChannel transport."), 
                w.open(), m = !0), I("Connection", "WebChannel sending:", t), w.send(t));
            },
            Wc: () => w.close()
        }), y = (t, e) => {
        ...
        // enough the code is exception free.
                return y(d.EventType.OPEN, () => {
            A || I("Connection", "WebChannel transport opened.");
        }), y(d.EventType.CLOSE, () => {
            A || (A = !0, I("Connection", "WebChannel transport closed"), P.Hc());
        }), y(d.EventType.ERROR, t => {
            A || (A = !0, function(t, ...e) {
                if (E.logLevel <= n.WARN) {
                    const n = e.map(R);
                    E.warn(`Firestore (${T}): ${t}`, ...n);
                }
            }("Connection", "WebChannel transport errored:", t), P.Hc(new x(k.UNAVAILABLE, "The operation could not be completed")));
        }), y(d.EventType.MESSAGE, t => {
            var e;
            if (!A) {
                const n = t.data[0];
                V(!!n);
                ...
                if (i) {
                    ...
                    A = !0, P.Hc(new x(e, n)), w.close();
                } else I("Connection", "WebChannel received:", n), P.Yc(n);
            }
        }), setTimeout(() => {
 ...
 * limitations under the License.
 */
const Oi = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.";
 ...
 */ class Li {
    ...
    ll(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new yi, s = t.Tl, new zn(e, n, s);
        var e, n, s;
    }
    al(t) {
        if (t.ml.El) throw new x(k.FAILED_PRECONDITION, Oi);
        return new bi(Ci.qc);
    }
    _l(t) {
        return new li(this.gh, t.hh, t.Ns, t => this.ta.Ga(t, 0 /* RemoteStore */), ki.ol() ? new ki : new xi);
    }
    hl(t) {
        return new fi;
    }
    fl(t) {
        ...
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        i = this.su, r = t.Tl, o = t.iu, new Ai(e, n, s, i, r, o);
        var e, n, s, i, r, o;
    }
    clearPersistence(t) {
        throw new x(k.FAILED_PRECONDITION, Oi);
    }
}
...
class Mi {
     ...
     */    start(t, e, n) {
        ...
        return this.credentials.Eo(t => {
            if (!r) return r = !0, I("FirestoreClient", "Initializing. user=", t.uid), this.Al(e, n, t, i).then(s.resolve, s.reject);
     ...
     */    async Al(t, e, n, s) {
        try {
            ...
            // provider).
            const r = await (i = this.Il, Promise.resolve(new Ni(i))), o = $s(this.Il.s), h = function(t, e, n) {
                return new ai(t, e, n);
     ...
     */    ih() {
        if (this.Ns.Xs) throw new x(k.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    ...
    async yl(t) {
        ...
        return await this.Ns.enqueue(async () => {
            try {
                ...
                n instanceof an ? e.resolve(n) : n instanceof un ? e.resolve(null) : e.reject(new x(k.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
            } catch (n) {
                const s = Gn(n, `Failed to get document '${t} from cache`);
                e.reject(s);
            }
        }), e.promise;
    }
    async pl(t) {
        ...
        return await this.Ns.enqueue(async () => {
            try {
                ...
                /* usePreviousResults= */ !0), s = new Ti(t, n.yr), i = s.La(n.documents), r = s.Ua(i, 
                /* updateLimboDocuments= */ !1);
                e.resolve(r.snapshot);
            } catch (n) {
                const s = Gn(n, `Failed to execute query '${t} against cache`);
                e.reject(s);
            }
        }), e.promise;
    }
...
class Ui {
    ...
    Nl(t) {
        return new Fs(Wt(t.latitude), Wt(t.longitude));
    }
    kl(t) {
    ...
    $l(t) {
        const e = q.N(t);
        V(ye(e));
        const n = new C(e.get(1), e.get(3)), s = new Q(e.p(5));
...
class Wi {
    constructor(t) {
        ...
        } else is("settings", "non-empty string", "host", t.host), this.host = t.host, rs("settings", "boolean", "ssl", t.ssl), 
        ...
        rs("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Kn.Ii; else {
            if (t.cacheSizeBytes !== Qi && t.cacheSizeBytes < Kn.mi) throw new x(k.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${Kn.mi}`);
 ...
 */ class ji {
    ...
    constructor(t, e, n = new Li) {
        if (this.Ol = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Ll = new jn, this.INTERNAL = {
            delete: async () => {
            ...
            const n = t;
            this.Ol = n, this.Jr = ji.Bl(n), this.Ul = n.name, this.Ql = new ni(e);
        } else {
            const e = t;
            if (!e.projectId) throw new x(k.INVALID_ARGUMENT, "Must provide projectId");
            this.Jr = new C(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Ul = "[DEFAULT]", this.Ql = new ei;
        }
        this.Wl = n, this.jl = new Wi({});
    }
    get Gl() {
        return this.Kl || (
        // Lazy initialize UserDataReader once the settings are frozen
        this.Kl = new qs(this.Jr, this.jl.ignoreUndefinedProperties)), this.Kl;
    }
    settings(t) {
        Zn("Firestore.settings", arguments, 1), ns("Firestore.settings", "object", 1, t);
        const e = new Wi(t);
        if (this.ql && !this.jl.isEqual(e)) throw new x(k.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */ (e.credentials));
    ...
    enablePersistence(t) {
        var e, n;
        if (this.ql) throw new x(k.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let s = !1, i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.ql && !this.ql.Vl) throw new x(k.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const t = new On;
        return this.Ll.Js(async () => {
            try {
                const e = this.Xl();
                await this.Wl.clearPersistence(e), t.resolve();
            } catch (e) {
                t.reject(e);
            }
        }), t.promise;
    ...
    onSnapshotsInSync(t) {
        if (this.Ml(), Bi(t)) return Gi(this.ql, t);
        {
    ...
    Hl(t, e) {
        const n = this.Xl();
        return this.ql = new Mi(this.Ql, this.Ll), this.ql.start(n, t, e);
    }
    static Bl(t) {
 ...
 */        const s = t.options.projectId;
    ...
    collection(t) {
        return Zn("Firestore.collection", arguments, 1), ns("Firestore.collection", "non-empty string", 1, t), 
        this.Ml(), new ir(q.N(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return Zn("Firestore.doc", arguments, 1), ns("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), Hi.Zl(q.N(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
        if (Zn("Firestore.collectionGroup", arguments, 1), ns("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.Ml(), new er(new ln(q.k(), t), this, 
        /* converter= */ null);
    }
    runTransaction(t) {
        return Zn("Firestore.runTransaction", arguments, 1), ns("Firestore.runTransaction", "function", 1, t), 
        this.Ml().transaction(e => t(new Ki(this, e)));
    }
    batch() {
        return this.Ml(), new zi(this);
    }
    static get logLevel() {
        switch (m()) {
          case n.DEBUG:
    ...
    static setLogLevel(t) {
        var e;
        Zn("Firestore.setLogLevel", arguments, 1), as("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, E.setLogLevel(e);
    }
...
/** Registers the listener for onSnapshotsInSync() */ function Gi(t, e) {
    const n = new qi({
        next: () => {
            e.next && e.next();
        },
 ...
 */ class Ki {
    ...
    get(t) {
        Zn("Transaction.get", arguments, 1);
        const e = ar("Transaction.get", t, this.e_);
        return this.n_.fh([ e.Zr ]).then(t => {
            if (!t || 1 !== t.length) return P();
            const n = t[0];
            if (n instanceof un) return new Ji(this.e_, e.Zr, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.to);
            if (n instanceof an) return new Ji(this.e_, e.Zr, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.to);
            throw P();
        });
    ...
    set(t, e, n) {
        ...
        n = rr("Transaction.set", n);
        const i = cr(s.to, e, n), r = Bs(this.e_.Gl, "Transaction.set", s.Zr, i, null !== s.to, n);
        return this.n_.set(s.Zr, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof Rs ? (ts("Transaction.update", arguments, 3), 
        i = ar("Transaction.update", t, this.e_), r = Qs(this.e_.Gl, "Transaction.update", i.Zr, e, n, s)) : (Zn("Transaction.update", arguments, 2), 
        i = ar("Transaction.update", t, this.e_), r = Us(this.e_.Gl, "Transaction.update", i.Zr, e)), 
        this.n_.update(i.Zr, r), this;
    }
    delete(t) {
        Zn("Transaction.delete", arguments, 1);
...
class zi {
    ...
    set(t, e, n) {
        es("WriteBatch.set", arguments, 2, 3), this.r_();
        const s = ar("WriteBatch.set", t, this.e_);
        n = rr("WriteBatch.set", n);
        const i = cr(s.to, e, n), r = Bs(this.e_.Gl, "WriteBatch.set", s.Zr, i, null !== s.to, n);
        return this.s_ = this.s_.concat(r.eo(s.Zr, Be.je())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.r_(), "string" == typeof e || e instanceof Rs ? (ts("WriteBatch.update", arguments, 3), 
        i = ar("WriteBatch.update", t, this.e_), r = Qs(this.e_.Gl, "WriteBatch.update", i.Zr, e, n, s)) : (Zn("WriteBatch.update", arguments, 2), 
        i = ar("WriteBatch.update", t, this.e_), r = Us(this.e_.Gl, "WriteBatch.update", i.Zr, e)), 
        this.s_ = this.s_.concat(r.eo(i.Zr, Be.exists(!0))), this;
    }
    delete(t) {
        Zn("WriteBatch.delete", arguments, 1), this.r_();
        const e = ar("WriteBatch.delete", t, this.e_);
        return this.s_ = this.s_.concat(new en(e.Zr, Be.je())), this;
    }
    commit() {
 ...
 */ class Hi extends ks {
    ...
    static Zl(t, e, n) {
        if (t.length % 2 != 0) throw new x(k.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + `${t.$()} has ${t.length}`);
        return new Hi(new Q(t), e, n);
    }
    get id() {
        return this.Zr.path.S();
    }
    get parent() {
        return new ir(this.Zr.path.g(), this.firestore, this.to);
    }
    get path() {
        return this.Zr.path.$();
    }
    collection(t) {
        if (Zn("DocumentReference.collection", arguments, 1), ns("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new x(k.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        const e = q.N(t);
        return new ir(this.Zr.path.child(e), this.firestore, 
        /* converter= */ null);
    }
    isEqual(t) {
        if (!(t instanceof Hi)) throw ds("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.Zr.isEqual(t.Zr) && this.to === t.to;
    }
    set(t, e) {
        es("DocumentReference.set", arguments, 1, 2), e = rr("DocumentReference.set", e);
        const n = cr(this.to, t, e), s = Bs(this.firestore.Gl, "DocumentReference.set", this.Zr, n, null !== this.to, e);
        return this.ql.write(s.eo(this.Zr, Be.je()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof Rs ? (ts("DocumentReference.update", arguments, 2), 
        s = Qs(this.firestore.Gl, "DocumentReference.update", this.Zr, t, e, n)) : (Zn("DocumentReference.update", arguments, 1), 
        s = Us(this.firestore.Gl, "DocumentReference.update", this.Zr, t)), this.ql.write(s.eo(this.Zr, Be.exists(!0)));
    }
    delete() {
        return Zn("DocumentReference.delete", arguments, 0), this.ql.write([ new en(this.Zr, Be.je()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        ...
        "object" != typeof t[r] || Bi(t[r]) || (i = t[r], fs("DocumentReference.onSnapshot", i, [ "includeMetadataChanges" ]), 
        rs("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++);
        const o = {
        ...
        } else ns("DocumentReference.onSnapshot", "function", r, t[r]), ss("DocumentReference.onSnapshot", "function", r + 1, t[r + 1]), 
        ss("DocumentReference.onSnapshot", "function", r + 2, t[r + 2]);
        const h = {
            next: e => {
                t[r] && t[r](this.o_(e));
            },
        ...
        return Yi(this.ql, this.Zr, o, h);
    }
    get(t) {
        return es("DocumentReference.get", arguments, 0, 1), hr("DocumentReference.get", t), 
        t && "cache" === t.source ? this.firestore.Ml().yl(this.Zr).then(t => new Ji(this.firestore, this.Zr, t, 
        /*fromCache=*/ !0, t instanceof an && t.Ge, this.to)) : 
        /**
 * Retrieves a latency-compensated document from the backend via a
 * SnapshotListener.
 */
        function(t, e, n) {
            const s = new On, i = Yi(t, e, {
    ...
    withConverter(t) {
        return new Hi(this.Zr, this.firestore, t);
    }
    /**
     ...
     */    o_(t) {
        ...
        return new Ji(this.firestore, this.Zr, e, t.fromCache, t.hasPendingWrites, this.to);
    }
}

/** Registers an internal snapshot listener for `ref`. */ function Yi(t, e, n, s) {
    let i = t => {
...
class Ji {
    ...
    data(t) {
        if (es("DocumentSnapshot.data", arguments, 0, 1), t = or("DocumentSnapshot.data", t), 
        this.h_) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.to) {
                const e = new Zi(this.e_, this.Zr, this.h_, this.a_, this.u_, 
                /* converter= */ null);
                return this.to.fromFirestore(e, t);
            }
            return new Ui(this.e_.Jr, this.e_.t_(), t.serverTimestamps || "none", t => new Hi(t, this.e_, /* converter= */ null)).Cl(this.h_.Ze());
        }
    }
    get(t, e) {
        if (es("DocumentSnapshot.get", arguments, 1, 2), e = or("DocumentSnapshot.get", e), 
        this.h_) {
            const n = this.h_.data().field(Hs("DocumentSnapshot.get", t, this.Zr));
            if (null !== n) {
                return new Ui(this.e_.Jr, this.e_.t_(), e.serverTimestamps || "none", t => new Hi(t, this.e_, this.to)).Cl(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new Hi(this.Zr, this.e_, this.to);
    }
    get exists() {
        return null !== this.h_;
    }
    get metadata() {
        return new Xi(this.u_, this.a_);
    }
    isEqual(t) {
        if (!(t instanceof Ji)) throw ds("isEqual", "DocumentSnapshot", 1, t);
...
/** The query class that is shared between the full, lite and legacy SDK. */ function tr(t) {
    if (t.mn() && 0 === t.tn.length) throw new x(k.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class er extends class {
    ...
    l_(t, e, n) {
        let s;
        if (t.L()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) throw new x(k.INVALID_ARGUMENT, `Invalid Query. You can't perform '${e}' ` + "queries on FieldPath.documentId().");
            if ("in" /* IN */ === e) {
                this.__(n, e);
                const t = [];
        ...
        s = Ws(this.Gl, "Query.where", n, "in" /* IN */ === e);
        const i = En.create(t, e, s);
        return this.d_(i), i;
    }
    w_(t, e) {
        if (null !== this.c_.startAt) throw new x(k.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.c_.endAt) throw new x(k.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        const n = new bn(t, e);
        return this.T_(n), n;
    }
    /**
     ...
     * server timestamp.
     */    E_(t, e, n) {
        if (!e) throw new x(k.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + `${t}().`);
        const s = [];
        ...
        // results.
                for (const t of this.c_.orderBy) if (t.field.L()) s.push(Gt(this.Jr, e.key)); else {
            const n = e.field(t.field);
            if ($t(n)) throw new x(k.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + t.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === n) {
                const e = t.field.$();
                throw new x(k.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a " + `document for which the field '${e}' (used as the ` + "orderBy) does not exist.");
            }
            s.push(n);
        }
        return new yn(s, n);
     ...
     */    m_(t, e, n) {
        ...
        const s = this.c_.tn;
        if (e.length > s.length) throw new x(k.INVALID_ARGUMENT, `Too many arguments provided to ${t}(). ` + "The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        const i = [];
        for (let n = 0; n < e.length; n++) {
            const r = e[n];
            if (s[n].field.L()) {
                if ("string" != typeof r) throw new x(k.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + `${t}(), but got a ${typeof r}`);
                if (!this.c_.Vn() && -1 !== r.indexOf("/")) throw new x(k.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), " + `the value passed to ${t}() must be a plain document ID, but ` + `'${r}' contains a slash.`);
                const e = this.c_.path.child(q.N(r));
                if (!Q.W(e)) throw new x(k.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by " + `FieldPath.documentId(), the value passed to ${t}() must result in a ` + `valid document path, but '${e}' is not because it contains an odd number ` + "of segments.");
                const n = new Q(e);
                i.push(Gt(this.Jr, n));
            } else {
                const e = Ws(this.Gl, t, r);
                i.push(e);
            }
        }
        return new yn(i, n);
     ...
     */    f_(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new x(k.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.c_.Vn() && -1 !== t.indexOf("/")) throw new x(k.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but " + `'${t}' contains a '/' character.`);
            const e = this.c_.path.child(q.N(t));
            if (!Q.W(e)) throw new x(k.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, " + `but '${e}' is not because it has an odd number of segments (${e.length}).`);
            return Gt(this.Jr, new Q(e));
        }
        if (t instanceof ks) return Gt(this.Jr, t.Zr);
        throw new x(k.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + `${ls(t)}.`);
    }
    /**
    ...
    d_(t) {
        if (t instanceof En) {
            ...
            if (t.In()) {
                const e = this.c_.hn();
                if (null !== e && !e.isEqual(t.field)) throw new x(k.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have" + ` inequality filters on '${e.toString()}'` + ` and '${t.field.toString()}'`);
                const n = this.c_.an();
                ...
                throw r === t.op ? new x(k.INVALID_ARGUMENT, "Invalid query. You cannot use more than one " + `'${t.op.toString()}' filter.`) : new x(k.INVALID_ARGUMENT, `Invalid query. You cannot use '${t.op.toString()}' filters ` + `with '${r.toString()}' filters.`);
            }
        }
    }
    T_(t) {
    ...
    I_(t, e) {
        if (!e.isEqual(t)) throw new x(k.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality " + `(<, <=, >, or >=) on field '${t.toString()}' ` + `and so you must also use '${t.toString()}' ` + "as your first Query.orderBy(), but your first Query.orderBy() " + `is on field '${e.toString()}' instead.`);
    }
} {
    constructor(t, e, n) {
    ...
    where(t, e, n) {
        Zn("Query.where", arguments, 3), _s("Query.where", 3, n);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        const s = as("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), i = Hs("Query.where", t), r = this.l_(i, s, n);
        return new er(this.c_.un(r), this.firestore, this.to);
    }
    orderBy(t, e) {
        let n;
        if (es("Query.orderBy", arguments, 1, 2), ss("Query.orderBy", "non-empty string", 2, e), 
        ...
        const s = Hs("Query.orderBy", t), i = this.w_(s, n);
        return new er(this.c_.cn(i), this.firestore, this.to);
    }
    limit(t) {
        return Zn("Query.limit", arguments, 1), ns("Query.limit", "number", 1, t), ws("Query.limit", 1, t), 
        new er(this.c_.ln(t), this.firestore, this.to);
    }
    limitToLast(t) {
        return Zn("Query.limitToLast", arguments, 1), ns("Query.limitToLast", "number", 1, t), 
        ws("Query.limitToLast", 1, t), new er(this.c_._n(t), this.firestore, this.to);
    }
    startAt(t, ...e) {
        ts("Query.startAt", arguments, 1);
        const n = this.A_("Query.startAt", t, e, 
        /*before=*/ !0);
        return new er(this.c_.fn(n), this.firestore, this.to);
    }
    startAfter(t, ...e) {
    ...
    endBefore(t, ...e) {
        ...
        /*before=*/ !0);
        return new er(this.c_.dn(n), this.firestore, this.to);
    }
    endAt(t, ...e) {
    ...
    isEqual(t) {
        if (!(t instanceof er)) throw ds("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && _n(this.c_, t.c_) && this.to === t.to;
    }
    withConverter(t) {
        return new er(this.c_, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    A_(t, e, n, s) {
        if (_s(t, 1, e), e instanceof Ji) return Zn(t, [ e, ...n ], 1), this.E_(t, e.h_, s);
        {
            const i = [ e ].concat(n);
    ...
    onSnapshot(...t) {
        ...
        let i = {}, r = 0;
        if ("object" != typeof t[r] || Bi(t[r]) || (i = t[r], fs("Query.onSnapshot", i, [ "includeMetadataChanges" ]), 
        rs("Query.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++), Bi(t[r])) {
            const i = t[r];
            t[r] = null === (e = i.next) || void 0 === e ? void 0 : e.bind(i), t[r + 1] = null === (n = i.error) || void 0 === n ? void 0 : n.bind(i), 
            t[r + 2] = null === (s = i.complete) || void 0 === s ? void 0 : s.bind(i);
        } else ns("Query.onSnapshot", "function", r, t[r]), ss("Query.onSnapshot", "function", r + 1, t[r + 1]), 
        ss("Query.onSnapshot", "function", r + 2, t[r + 2]);
        const o = {
            next: e => {
                t[r] && t[r](new sr(this.firestore, this.c_, e, this.to));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
        return tr(this.c_), nr(this.firestore.Ml(), this.c_, i, o);
    }
    get(t) {
        es("Query.get", arguments, 0, 1), hr("Query.get", t), tr(this.c_);
        ...
        function(t, e, n) {
            const s = new On, i = nr(t, e, {
                ...
                next: t => {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    i(), t.fromCache && n && "server" === n.source ? s.reject(new x(k.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : s.resolve(t);
                },
                error: t => s.reject(t)
            });
            return s.promise;
        }
        /** Registers an internal snapshot listener for `query`. */ (e, this.c_, t)).then(t => new sr(this.firestore, this.c_, t, this.to));
    }
}
...
class sr {
    constructor(t, e, n, s) {
        ...
        this.metadata = new Xi(n.hasPendingWrites, n.fromCache);
    }
    get docs() {
        const t = [];
    ...
    forEach(t, e) {
        es("QuerySnapshot.forEach", arguments, 1, 2), ns("QuerySnapshot.forEach", "function", 1, t), 
        this.P_.docs.forEach(n => {
            t.call(e, this.p_(n, this.metadata.fromCache, this.P_.Mt.has(n.key)));
        });
    }
    get query() {
        return new er(this.R_, this.e_, this.to);
    }
    docChanges(t) {
        ...
        if (e && this.P_.Bt) throw new x(k.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof sr)) throw ds("isEqual", "QuerySnapshot", 1, t);
        return this.e_ === t.e_ && _n(this.R_, t.R_) && this.P_.isEqual(t.P_) && this.to === t.to;
    }
    p_(t, e, n) {
        return new Zi(this.e_, t.key, t, e, n, this.to);
    }
}

class ir extends er {
    constructor(t, e, n) {
        if (super(ln.on(t), e, n), this.g_ = t, t.length % 2 != 1) throw new x(k.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + `${t.$()} has ${t.length}`);
    }
    get id() {
    ...
    get parent() {
        ...
        return t._() ? null : new Hi(new Q(t), this.firestore, 
        /* converter= */ null);
    }
    get path() {
        return this.c_.path.$();
    ...
    doc(t) {
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = g.t()), ns("CollectionReference.doc", "non-empty string", 1, t);
        const e = q.N(t);
        return Hi.Zl(this.c_.path.child(e), this.firestore, this.to);
    }
    add(t) {
        Zn("CollectionReference.add", arguments, 1), ns("CollectionReference.add", "object", 1, this.to ? this.to.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new ir(this.g_, this.firestore, t);
    }
}
...
function rr(t, e) {
    ...
    if (fs(t, e, [ "merge", "mergeFields" ]), rs(t, "boolean", "merge", e.merge), os(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof Rs), 
...
function or(t, e) {
    return void 0 === e ? {} : (fs(t, e, [ "serverTimestamps" ]), hs(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function hr(t, e) {
    ss(t, "object", 1, e), e && (fs(t, e, [ "source" ]), hs(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function _r(t) {
    !function(t, e) {
        ...
        }, "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, lr)));
    }(t, (t, e) => new ji(t, e, new Li)), t.registerVersion("@firebase/firestore", "1.16.0", "rn");
}

_r(t);

export { _r as __PRIVATE_registerFirestore };
