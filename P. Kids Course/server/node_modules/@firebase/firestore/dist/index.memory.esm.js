...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "i", {
        ...
        return U(this.projectId, t.projectId) || U(this.database, t.database);
    }, t;
}();
 ...
 */ var C = /** @class */ function() {
    ...
    return t.now = function() {
        ...
        return this.seconds === t.seconds ? U(this.nanoseconds, t.nanoseconds) : U(this.seconds, t.seconds);
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.$e = function(t) {
        ...
        return this.Ie = pt(), this.Ae = St(), this.Re = new ct(U), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.Ae.get(t);
        return e || (e = new ct(U), this.Ae = this.Ae.nt(t, e)), e;
    }, 
    /**
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function qt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return k(t.arrayValue.values || [], e.arrayValue.values || [], qt);
...
function jt(t, e) {
    ...
    switch (n) {
      ...
      case 1 /* BooleanValue */ :
        return U(t.booleanValue, e.booleanValue);
      ...
      case 5 /* StringValue */ :
        return U(t.stringValue, e.stringValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = U(zt(t.latitude), zt(e.latitude));
            return 0 !== n ? n : U(zt(t.longitude), zt(e.longitude));
...
function Ft(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return U(t, e);
    var n = Bt(t), r = Bt(e), i = U(n.seconds, r.seconds);
...
function Ge(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Ue.isEqual(e.Ue) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Me.isEqual(e.Me) : 2 /* Transform */ !== t.type || k(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof _e && e instanceof _e || t instanceof Pe && e instanceof Pe ? k(t.elements, e.elements, qt) : t instanceof Ue && e instanceof Ue ? qt(t.qe, e.qe) : t instanceof Te && e instanceof Te;
...
var zn = /** @class */ function() {
    ...
    return t.br = function(t, e) {
        return W.P(t.key, e.key) || U(t.Lr, e.Lr);
    }, 
    /** Compare by ID then by key */ t.Cr = function(t, e) {
        return U(t.Lr, e.Lr) || W.P(t.key, e.key);
    }, t;
}();
...
var br = /** @class */ function(e) {
     ...
     */
    t.prototype.T = function(t) {
        return U(this.Yr, t.Yr) || U(this.Xr, t.Xr);
    }, t;
}();
...
n) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    /* targetMismatches= */ new ct(U), o, s), [ 4 /*yield*/ , this.Ji(u) ]) : [ 3 /*break*/ , 2 ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.vu = function(t) {
        ...
        n || (n = new ut(U)), n = n.nt(t, e), this._u[this.currentUser.lo()] = n;
    }, 
    /**
    ...
    return t.prototype.Ju = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                W.W(i) || (i = i.child(""));
        var o = new Qn(new W(i), 0), s = new ct(U);
...
var Ei = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t.ml.El) throw new x(q.FAILED_PRECONDITION, ki);
        return new Ii(Ai.qc);
        ...
        throw new x(q.FAILED_PRECONDITION, ki);
    }, t;
}(), Li = /** @class */ function() {
    function t(t, 
    /**
